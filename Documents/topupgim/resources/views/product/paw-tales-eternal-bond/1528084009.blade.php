...
@section('title', 'Top Up Paw Tales Eternal Bond Murah | Ruby Paw Tales Eternal Bond | Topupgim - TopUpGim')
            ...
            <div class="row g-0 flex-md-grow-1 ps-xl-5 pe-xl-4 pb-4">
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <!-- Description Content -->
                        <h1 class="mb-2">Top Up Paw Tales Eternal Bond</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p>Top Up Paw Tales Eternal Bond resmi dengan <strong>harga termurah</strong> se-Indonesia di Topupgim.com</p><p><strong>Kenapa Top Up di Topupgim.com?</strong></p><div class="raw-html-embed">
...
Top Up Paw Tales Eternal Bond murah dan aman di Topupgim, dijamin harga termurah dan pengiriman instan. 
</p>
</div></div>
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            ...
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://play.google.com/store/apps/details?id=com.eyougame.qjen" target="_blank">
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="PjAMYcsX-6S3AKdiKdh2vtjs2hesxD1kG2eg">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <select data-property-type="options" id="property-zone_id" name="property-zone_id" class="form-select text-body-color" required>
                                                        <option value="12001">S1-Paw</option>
                                                        <option value="12002">S2-Bond</option>
                                                        <option value="12003">S3-Fluffy</option>
                                                        <option value="12004">S4-Mochiton</option>
                                                        <option value="12005">S5-Nekora</option>
                                                        <option value="12006">S6-Cozyden</option>
                                                        <option value="12007">S7-Cuporia</option>
                                                        <option value="12008">S8-Sunniva</option>
                                                        <option value="12009">S9-Cloverly</option>
                                                        <option value="12010">S10-Berryvale</option>
                                                        <option value="12011">S11-Peachora</option>
                                                        <option value="12012">S12-Momoria</option>
                                                        <option value="12013">S13-Chocora</option>
                                                        <option value="12014">S14-Twinklea</option>
                                                        <option value="12015">S15-Dewmere</option>
                                                        <option value="12016">S16-Dandara</option>
                                                        <option value="12017">S17-Maporia</option>
                                                        <option value="12018">S18-Jellira</option>
                                                        <option value="12019">S19-Puffara</option>
                                                        <option value="12020">S20-Daisora</option>
                                                        <option value="12021">S21-Poppina</option>
                                                        <option value="12022">S22-Honeyra</option>
                                                        <option value="12023">S23-Lulula</option>
                                                        <option value="12024">S24-Snowina</option>
                                                        <option value="12025">S25-Bunnira</option>
                                                        <option value="12026">S26-Roselyn</option>
                                                        <option value="12027">S27-Candora</option>
                                                        <option value="12028">S28-Sparkira</option>
                                                        <option value="12029">S29-Cloudira</option>
                                                        <option value="12030">S30-Petoria</option>
                                                        <option value="12031">S31-Blossira</option>
                                                        <option value="12032">S32-Crystalin</option>
                                                        <option value="12033">S33-Pearlia</option>
                                                        <option value="12034">S34-Amoria</option>
                                                        <option value="12035">S35-Starwyn</option>
                                                        <option value="13001">NA1-Tales</option>
                                                        <option value="13002">NA2-Apollo</option>
                                                        <option value="13003">NA3-Athena</option>
                                                        <option value="13004">NA4-Hera</option>
                                                        <option value="13005">NA5-Zeus</option>
                                                        <option value="13006">NA6-Ares</option>
                                                        <option value="13007">NA7-Hades</option>
                                                        <option value="13008">NA8-Hermes</option>
                                                        <option value="13009">NA9-Poseidon</option>
                                                        <option value="13010">NA10-Artemis</option>
                                                        <option value="13011">NA11-Dionysus</option>
                                                        <option value="13012">NA12-Demeter</option>
                                                        <option value="13013">NA13-Perseus</option>
                                                        <option value="13014">NA14-Theseus</option>
                                                        <option value="13015">NA15-Achilles</option>
                                                        <option value="14001">EU1-Eternal</option>
                                                        <option value="14002">EU2-Era</option>
                                                        <option value="14003">EU3-Batman</option>
                                                        <option value="14004">EU4-Wonder</option>
                                                        <option value="14005">EU5-Aquaman</option>
                                                        <option value="14006">EU6-Flash</option>
                                                        <option value="14007">EU7-Cyborg</option>
                                                        <option value="14008">EU8-Lantern</option>
                                                        <option value="14009">EU9-Hargeon</option>
                                                        <option value="14010">EU10-Robin</option>
                                                        <option value="14011">EU11-IronMan</option>
                                                        <option value="14012">EU12-Captain</option>
                                                        <option value="14013">EU13-Thor</option>
                                                        <option value="14014">EU14-Loki</option>
                                                        <option value="14015">EU15-Hulk</option>
                                                        <option value="14016">EU16-Hawkeye</option>
                                                        <option value="14017">EU17-Widow</option>
                                                        <option value="14018">EU18-Scarlet</option>
                                                        <option value="14019">EU19-Vision</option>
                                                        <option value="14020">EU20-Strange</option>
                                                        <option value="14021">EU21-Wolverine</option>
                                                        <option value="14022">EU22-Deadpool</option>
                                                        <option value="14023">EU23-Phoenix</option>
                                                        <option value="14024">EU24-Fiore</option>
                                                        <option value="14025">EU25-Bosco</option>
                                                        <option value="14026">EU26-Odin</option>
                                                        <option value="14027">EU27-Freya</option>
                                                        <option value="39999">S1</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-username_id">Username <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity" id="property-username_id" name="property-username_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Username.." value="" required>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_JU464P0I" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JU464P0I" name="productDenomination" value="JU464P0I" data-price-preview="17400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JU464P0I">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_JU464P0I" class="fs-sm fw-semibold">1 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp17.400</p>
                                                ...
                                                <div id="pDRoot_OF890EKW" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_OF890EKW" name="productDenomination" value="OF890EKW" data-price-preview="86600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_OF890EKW">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_OF890EKW" class="fs-sm fw-semibold">5 Ruby + 1 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp86.600</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_GR698SGK" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_GR698SGK" name="productDenomination" value="GR698SGK" data-price-preview="173200" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_GR698SGK">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_GR698SGK" class="fs-sm fw-semibold">10 Ruby + 2 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp173.200</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_JX672DXH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JX672DXH" name="productDenomination" value="JX672DXH" data-price-preview="259400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JX672DXH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_JX672DXH" class="fs-sm fw-semibold">15 Ruby + 3 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp259.400</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_TA141GSX" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_TA141GSX" name="productDenomination" value="TA141GSX" data-price-preview="345400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_TA141GSX">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_TA141GSX" class="fs-sm fw-semibold">20 Ruby + 4 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp345.400</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_ED107WAZ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ED107WAZ" name="productDenomination" value="ED107WAZ" data-price-preview="517300" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ED107WAZ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_ED107WAZ" class="fs-sm fw-semibold">30 Ruby + 6 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp517.300</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_OR8093QQ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_OR8093QQ" name="productDenomination" value="OR8093QQ" data-price-preview="861200" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_OR8093QQ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_OR8093QQ" class="fs-sm fw-semibold">50 Ruby + 10 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp861.200</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_MF666NOD" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MF666NOD" name="productDenomination" value="MF666NOD" data-price-preview="1721000" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MF666NOD">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_MF666NOD" class="fs-sm fw-semibold">100 Ruby + 20 Ruby</span>
                                                                <p class="fs-sm mt-1">Rp1.721.000</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpaw-tales-eternal-bond%2F1528084009%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/paw-tales-eternal-bond/1528084009?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page"><p>Cara Menemukan User ID di <strong>Paw Tales Eternal Bond:</strong></p><ol><li><strong data-start="60" data-end="83">Masuk ke dalam game</strong> menggunakan akun Anda.</li><li><strong data-start="112" data-end="135">Ketuk ikon "Avatar"</strong> di pojok kiri atas layar utama.</li><li><strong data-start="173" data-end="226">User ID </strong><strong>Paw Tales Eternal Bond</strong><strong data-start="173" data-end="226"> Anda akan ditampilkan</strong> di sana.</li></ol></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/fa4d72af-89a0-43d4-805e-6301057dabe4ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Paw Tales Eternal Bond</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Username</p>
                                                <p id="purchase-property-username_id-text" class="fs-sm fw-normal h6 mb-0"></p>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Metode Pembayaran</p>
