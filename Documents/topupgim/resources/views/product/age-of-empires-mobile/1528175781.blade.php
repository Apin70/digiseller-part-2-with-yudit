...
@section('title', 'Beli Coins Age of Empires Mobile | Top Up Age of Empires Mobile Murah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/8b79bae4-47fb-465e-8d83-187b1f4a5fd7.jpg" alt="Top Up Age of Empires Mobile">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up Age of Empires Mobile</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Age of Empires Mobile</strong> lebih murah dengan kode promo, diskon hingga 39%.</p><div class="raw-html-embed">
    <h2 style="font-size: 16px;">
        Top Up Age of Empires Mobile di Topupgim
    </h2>
...
<li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.
                        ...
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            <span class="text-dark fs-sm fw-semibold mb-2 me-3">
                                <i class="fa fa-cart-shopping opacity-75 me-1"></i> Terjual: <span class="text-primary">2</span>
                            </span>
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="rImFdlhn-IcCfjiRllXP3TXaMdzalDiv7Aqc">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity_alphanumeric" id="property-user_id" name="property-user_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Player Id.." value="" data-rule-isAlphanumeric="true" required>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <select data-property-type="options" id="property-zone_id" name="property-zone_id" class="form-select text-body-color" required>
                                                        <option value="5000">Realm002</option>
                                                        <option value="5001">Realm001</option>
                                                        <option value="5002">Kingdom001</option>
                                                        <option value="5003">Kingdom002</option>
                                                        <option value="5004">Kingdom003</option>
                                                        <option value="5005">Kingdom004</option>
                                                        <option value="5006">Kingdom005</option>
                                                        <option value="5007">Kingdom006</option>
                                                        <option value="5008">Kingdom007</option>
                                                        <option value="5009">Kingdom008</option>
                                                        <option value="5010">Kingdom009</option>
                                                        <option value="5011">Kingdom010</option>
                                                        <option value="5012">Empire #001</option>
                                                        <option value="5013">Empire #002</option>
                                                        <option value="5014">Empire #003</option>
                                                        <option value="5015">Empire #004</option>
                                                        <option value="5016">Empire #005</option>
                                                        <option value="5017">Empire #006</option>
                                                        <option value="5018">Empire #007</option>
                                                        <option value="5019">Empire #008</option>
                                                        <option value="5020">Empire #009</option>
                                                        <option value="5021">Empire #010</option>
                                                        <option value="5022">Empire #011</option>
                                                        <option value="5023">Empire #012</option>
                                                        <option value="5024">Empire #013</option>
                                                        <option value="5025">Empire #014</option>
                                                        <option value="5026">Empire #015</option>
                                                        <option value="5027">Empire #016</option>
                                                        <option value="5028">Empire #017</option>
                                                        <option value="5029">Empire #018</option>
                                                        <option value="5030">Empire #019</option>
                                                        <option value="5031">Empire #020</option>
                                                        <option value="5032">Empire #021</option>
                                                        <option value="5033">Empire #022</option>
                                                        <option value="5034">Empire #023</option>
                                                        <option value="5035">Empire #024</option>
                                                        <option value="5036">Empire #025</option>
                                                        <option value="5037">Empire #026</option>
                                                        <option value="5038">Empire #027</option>
                                                        <option value="5039">Empire #028</option>
                                                        <option value="5040">Empire #029</option>
                                                        <option value="5041">Empire #030</option>
                                                        <option value="5042">Empire #031</option>
                                                        <option value="5043">Empire #032</option>
                                                        <option value="5044">Empire #033</option>
                                                        <option value="5045">Empire #034</option>
                                                        <option value="5046">Empire #035</option>
                                                        <option value="5047">Empire #036</option>
                                                        <option value="5048">Empire #037</option>
                                                        <option value="5049">Empire #038</option>
                                                        <option value="5050">Empire #039</option>
                                                        <option value="5051">Empire #040</option>
                                                        <option value="5052">Empire #041</option>
                                                        <option value="5053">Empire #042</option>
                                                        <option value="5054">Empire #043</option>
                                                        <option value="5055">Empire #044</option>
                                                        <option value="5056">Empire #045</option>
                                                        <option value="5057">Empire #046</option>
                                                        <option value="5058">Empire #047</option>
                                                        <option value="5059">Empire #048</option>
                                                        <option value="5060">Empire #049</option>
                                                        <option value="5061">Empire #050</option>
                                                        <option value="5062">Empire #051</option>
                                                        <option value="5063">Empire #052</option>
                                                        <option value="5064">Empire #053</option>
                                                        <option value="5065">Empire #054</option>
                                                        <option value="5066">Empire #055</option>
                                                        <option value="5067">Empire #056</option>
                                                        <option value="5068">Empire #057</option>
                                                        <option value="5069">Empire #058</option>
                                                        <option value="5070">Empire #059</option>
                                                        <option value="5071">Empire #060</option>
                                                        <option value="5072">Empire #061</option>
                                                        <option value="5073">Empire #062</option>
                                                        <option value="5074">Empire #063</option>
                                                        <option value="5075">Empire #064</option>
                                                        <option value="5076">Empire #065</option>
                                                        <option value="5077">Empire #066</option>
                                                        <option value="5078">Empire #067</option>
                                                        <option value="5079">Empire #068</option>
                                                        <option value="5080">Empire #069</option>
                                                        <option value="5081">Empire #070</option>
                                                        <option value="5082">Empire #071</option>
                                                        <option value="5083">Empire #072</option>
                                                        <option value="5084">Empire #073</option>
                                                        <option value="5085">Empire #074</option>
                                                        <option value="5086">Empire #075</option>
                                                        <option value="5087">Empire #076</option>
                                                        <option value="5088">Empire #077</option>
                                                        <option value="5089">Empire #078</option>
                                                        <option value="5090">Empire #079</option>
                                                        <option value="5091">Empire #080</option>
                                                        <option value="5092">Empire #081</option>
                                                        <option value="5093">Empire #082</option>
                                                        <option value="5094">Empire #083</option>
                                                        <option value="5095">Empire #084</option>
                                                        <option value="5096">Empire #085</option>
                                                        <option value="5097">Empire #086</option>
                                                        <option value="5098">Empire #087</option>
                                                        <option value="5099">Empire #088</option>
                                                        <option value="5100">Empire #089</option>
                                                        <option value="5101">Empire #090</option>
                                                        <option value="5102">Empire #091</option>
                                                        <option value="5103">Empire #092</option>
                                                        <option value="5104">Empire #093</option>
                                                        <option value="5105">Empire #094</option>
                                                        <option value="5106">Empire #095</option>
                                                        <option value="5107">Empire #096</option>
                                                        <option value="5108">Empire #097</option>
                                                        <option value="5109">Empire #098</option>
                                                        <option value="5110">Empire #099</option>
                                                        <option value="5111">Empire #100</option>
                                                        <option value="5112">Empire #101</option>
                                                        <option value="5113">Empire #102</option>
                                                        <option value="5114">Empire #103</option>
                                                        <option value="5115">Empire #104</option>
                                                        <option value="5116">Empire #105</option>
                                                        <option value="5117">Empire #106</option>
                                                        <option value="5118">Empire #107</option>
                                                        <option value="5119">Empire #108</option>
                                                        <option value="5120">Empire #109</option>
                                                        <option value="5121">Empire #110</option>
                                                        <option value="5122">Empire #111</option>
                                                        <option value="5123">Empire #112</option>
                                                        <option value="5124">Empire #113</option>
                                                        <option value="5125">Empire #114</option>
                                                        <option value="5126">Empire #115</option>
                                                        <option value="5127">Empire #116</option>
                                                        <option value="5128">Empire #117</option>
                                                        <option value="5129">Empire #118</option>
                                                        <option value="5130">Empire #119</option>
                                                        <option value="5131">Empire #120</option>
                                                        <option value="5132">Empire #121</option>
                                                        <option value="5133">Empire #122</option>
                                                        <option value="5134">Empire #123</option>
                                                        <option value="5135">Empire #124</option>
                                                        <option value="5136">Empire #125</option>
                                                        <option value="5137">Empire #126</option>
                                                        <option value="5138">Empire #127</option>
                                                        <option value="5139">Empire #128</option>
                                                        <option value="5140">Empire #129</option>
                                                        <option value="5141">Empire #130</option>
                                                        <option value="5142">Empire #131</option>
                                                        <option value="5143">Empire #132</option>
                                                        <option value="5144">Empire #133</option>
                                                        <option value="5145">Empire #134</option>
                                                        <option value="5146">Empire #135</option>
                                                        <option value="5147">Empire #136</option>
                                                        <option value="5148">Empire #137</option>
                                                        <option value="5149">Empire #138</option>
                                                        <option value="5150">Empire #139</option>
                                                        <option value="5151">Empire #140</option>
                                                        <option value="5152">Empire #141</option>
                                                        <option value="5153">Empire #142</option>
                                                        <option value="5154">Empire #143</option>
                                                        <option value="5155">Empire #144</option>
                                                        <option value="5156">Empire #145</option>
                                                        <option value="5157">Empire #146</option>
                                                        <option value="5158">Empire #147</option>
                                                        <option value="5159">Empire #148</option>
                                                        <option value="5160">Empire #149</option>
                                                        <option value="5161">Empire #150</option>
                                                        <option value="5162">Empire #151</option>
                                                        <option value="5163">Empire #152</option>
                                                        <option value="5164">Empire #153</option>
                                                        <option value="5165">Empire #154</option>
                                                        <option value="5166">Empire #155</option>
                                                        <option value="5167">Empire #156</option>
                                                        <option value="5168">Empire #157</option>
                                                        <option value="5169">Empire #158</option>
                                                        <option value="5170">Empire #159</option>
                                                        <option value="5171">Empire #160</option>
                                                        <option value="5172">Empire #161</option>
                                                        <option value="5173">Empire #162</option>
                                                        <option value="5174">Empire #163</option>
                                                        <option value="5175">Empire #164</option>
                                                        <option value="5176">Empire #165</option>
                                                        <option value="5177">Empire #166</option>
                                                        <option value="5178">Empire #167</option>
                                                        <option value="5179">Empire #168</option>
                                                        <option value="5180">Empire #169</option>
                                                        <option value="5181">Empire #170</option>
                                                        <option value="5182">Empire #171</option>
                                                        <option value="5183">Empire #172</option>
                                                        <option value="5184">Empire #173</option>
                                                        <option value="5185">Empire #174</option>
                                                        <option value="5186">Empire #175</option>
                                                        <option value="5187">Empire #176</option>
                                                        <option value="5188">Empire #177</option>
                                                        <option value="5189">Empire #178</option>
                                                        <option value="5190">Empire #179</option>
                                                        <option value="5191">Empire #180</option>
                                                        <option value="5192">Empire #181</option>
                                                        <option value="5193">Empire #182</option>
                                                        <option value="5194">Empire #183</option>
                                                        <option value="5195">Empire #184</option>
                                                        <option value="5196">Empire #185</option>
                                                        <option value="5197">Empire #186</option>
                                                        <option value="5198">Empire #187</option>
                                                        <option value="5199">Empire #188</option>
                                                        <option value="5200">Empire #189</option>
                                                        <option value="5201">Empire #190</option>
                                                        <option value="5202">Empire #191</option>
                                                        <option value="5203">Empire #192</option>
                                                        <option value="5204">Empire #193</option>
                                                        <option value="5205">Empire #194</option>
                                                        <option value="5206">Empire #195</option>
                                                        <option value="5207">Empire #196</option>
                                                        <option value="5208">Empire #197</option>
                                                        <option value="5209">Empire #198</option>
                                                        <option value="5210">Empire #199</option>
                                                        <option value="5211">Empire #200</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_PZ515A41" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_PZ515A41" name="productDenomination" value="PZ515A41" data-price-preview="13200" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_PZ515A41">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_PZ515A41" class="fs-sm fw-semibold">400 Empire Coins</span>
                                                ...
                                                <div id="pDRoot_DB466TGS" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_DB466TGS" name="productDenomination" value="DB466TGS" data-price-preview="62700" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_DB466TGS">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_DB466TGS" class="fs-sm fw-semibold">2100 Empire Coins</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp62.700</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp81.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp18.300</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YA527V1G" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YA527V1G" name="productDenomination" value="YA527V1G" data-price-preview="130800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YA527V1G">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_YA527V1G" class="fs-sm fw-semibold">4400 Empire Coins</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp130.800</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp0</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_FR335O31" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_FR335O31" name="productDenomination" value="FR335O31" data-price-preview="261900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_FR335O31">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_FR335O31" class="fs-sm fw-semibold">9200 Empire Coins</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp261.900</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp324.300</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp62.400</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_WK689459" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_WK689459" name="productDenomination" value="WK689459" data-price-preview="646400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_WK689459">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_WK689459" class="fs-sm fw-semibold">24000 Empire Coins</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp646.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp811.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp164.600</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_SU6143HZ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_SU6143HZ" name="productDenomination" value="SU6143HZ" data-price-preview="1299500" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_SU6143HZ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_SU6143HZ" class="fs-sm fw-semibold">50000 Empire Coins</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp1.299.500</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.662.200</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp362.700</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fage-of-empires-mobile%2F1528175781%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/age-of-empires-mobile/1528175781?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page"><p><strong>Cara Menemukan ID Pemain dan Nama Karakter Age of Empires Mobile:</strong></p><ol><li>Masuk ke dalam game menggunakan akun Anda.</li><li>Ketuk ikon "Avatar" di pojok kiri atas layar utama.</li><li>ID Pemain dan Nama Karakter Age of Empires Mobile Anda akan ditampilkan.</li></ol></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                        ...
                        <div class="modal fade" id="modal-how-to-order" tabindex="-1" role="dialog" aria-labelledby="modal-how-to-order" aria-describedby="modal-how-to-order" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page" style="min-height: 380px;"><p><strong>Video Youtube </strong>Tutorial Pembelian Tanpa perlu Login.</p><figure class="media"><div data-oembed-url="https://www.youtube.com/embed/7_g48wHaA-Y"><div style="position: relative; padding-bottom: 100%; height: 0; padding-bottom: 56.2493%;"><iframe src="https://www.youtube.com/embed/7_g48wHaA-Y" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe></div></div></figure></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/fbdb2d12-8da2-43ba-a0c2-2788138393d2ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Age of Empires Mobile</span>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotionsae0f.html?code=1528175781';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/age-of-empires-mobile-panduan-lengkap-dari-pemula-hingga-pro-untuk-dominasi-strategi-global.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/00d89efb-bebb-4588-a951-6ca00cc024f5.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Age of Empires Mobile: Panduan Lengkap dari Pemula hingga Pro untuk Dominasi Strategi Global
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Taklukkan dunia strategi dalam genggaman! Bangun kerajaanmu, pimpin hero legendaris, dan menangkan perang epik di Age of Empires Mobile.
                                </p>
                            </div>
                        </a>
                    </div>
