...
@section('title', 'Top Up HAGO Murah | Topupgim - TopUpGim')
        ...
        <main id="main-container">
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/0579c540-3dbb-423c-9a2d-75a28f965efc.jpg" alt="Top Up HAGO">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up Hago Murah</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Hago</strong> murah &amp; proses instan. Beli Diamonds Hago bayar via Dana, Gopay dan QRIS. Top Up Hago di TopUpGim.com cashback 10% &amp; promo diskon hingga 15%!</p><div class="raw-html-embed"><h2 style="font-size: 14px;">Cara Top Up Hago Murah di TopUpGim</h2></div><ol><li>Masukkan User ID.</li><li>Pilih produk Diamonds (DM) dan metode pembayaran.</li><li>Gunakan kode promo dan login untuk mendapatkan cashback agar <strong>lebih murah</strong>.</li><li>Selesaikan pembayaran dan Diamonds (DM) Hago akan dikirim hitungan detik.</li></ol></div>
                            ...
                            <div id="content-ranking" class="mt-5">
                                ...
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        ...
                                        <span class="text-muted fs-sm">Rp. 48.910.590</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">6285336*****1</span>
                                        <span class="text-muted fs-sm">Rp. 4.820.640</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">0853366*****</span>
                                        <span class="text-muted fs-sm">Rp. 4.519.370</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">0822849*****</span>
                                        <span class="text-muted fs-sm">Rp. 3.443.220</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">tatto</span>
                                        <span class="text-muted fs-sm">Rp. 2.565.480</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>Hago</h2>
                                <div class="static-page w-100"><p>Hago adalah aplikasi yang menggabungkan elemen sosial dan permainan, dirancang untuk memberikan pengalaman hiburan yang interaktif. Berikut penjelasan lebih rinci mengenai game Hago:</p><p>1. <strong>Beragam Jenis Permainan</strong></p><ul><li><strong>Mini Games</strong>: Hago menawarkan berbagai mini games yang sederhana namun adiktif. Beberapa contohnya adalah <strong>Knife Hit</strong> (melempar pisau ke arah target), <strong>Sheep Fight</strong> (pertempuran domba untuk merebut wilayah), dan <strong>Ludo</strong> (versi digital dari permainan papan klasik).</li><li><strong>Game Multiplayer</strong>: Banyak game di Hago dapat dimainkan dalam mode multiplayer, baik dengan teman atau pemain acak dari seluruh dunia. Ini menciptakan elemen kompetitif dan sosial yang membuat permainan lebih menarik.</li><li><strong>Game Kasual dan Real-Time</strong>: Permainan di Hago cenderung kasual dan bisa dimainkan dalam waktu singkat, sehingga cocok untuk mengisi waktu luang. Beberapa permainan juga berjalan secara real-time, memungkinkan pemain untuk merasakan pengalaman bermain yang lebih dinamis.</li></ul><p>2. <strong>Fitur Sosial</strong></p><ul><li><strong>Voice Chat dan Text Chat</strong>: Selama bermain game, pemain dapat berkomunikasi dengan lawan atau teman melalui fitur voice chat atau text chat. Ini memfasilitasi interaksi sosial, baik untuk strategi permainan atau sekadar bercakap-cakap.</li><li><strong>Live Streaming</strong>: Hago juga memiliki fitur live streaming di mana pengguna dapat menonton pemain lain bermain atau menyiarkan permainan mereka sendiri. Ini memungkinkan interaksi dengan audiens secara real-time.</li><li><strong>Komunitas dan Grup</strong>: Pengguna dapat bergabung dengan komunitas atau grup yang memiliki minat yang sama, seperti pecinta game tertentu atau pemain dari wilayah yang sama. Grup ini sering mengadakan turnamen atau event khusus untuk anggota.</li></ul><p>3. <strong>Interaksi Antar-Pengguna</strong></p><ul><li><strong>Matchmaking</strong>: Hago menggunakan sistem matchmaking untuk mencocokkan pemain dengan level atau minat yang sama. Ini membuat permainan lebih seimbang dan menyenangkan.</li><li><strong>Hadiah dan Poin</strong>: Pemain dapat mengirim hadiah virtual kepada teman atau lawan sebagai bentuk apresiasi. Selain itu, pemain juga bisa mengumpulkan poin yang dapat digunakan untuk meningkatkan profil mereka atau membeli item di dalam aplikasi.</li></ul><p>Hago telah menjadi populer karena kemampuannya menggabungkan permainan dan interaksi sosial dalam satu platform, memberikan pengalaman yang seru dan menyenangkan bagi penggunanya.</p><h2>Diamond Hago</h2><p>Diamond Hago adalah mata uang virtual yang digunakan di dalam aplikasi Hago. Diamond ini bisa digunakan untuk berbagai keperluan di dalam aplikasi, seperti:</p><ol><li><strong>Membeli Hadiah Virtual</strong>: Kamu bisa menggunakan Diamond untuk membeli hadiah virtual, seperti bunga, kue, atau barang-barang unik lainnya yang bisa kamu kirimkan kepada pengguna lain sebagai bentuk apresiasi atau hadiah.</li><li><strong>Mendukung Streamer</strong>: Saat menonton live streaming di Hago, kamu bisa memberikan hadiah virtual kepada streamer favoritmu sebagai bentuk dukungan. Hadiah ini dibeli menggunakan Diamond.</li><li><strong>Membeli Item dan Upgrade</strong>: Beberapa game di Hago memungkinkan kamu untuk membeli item khusus, upgrade, atau akses ke fitur premium menggunakan Diamond. Ini bisa memberikan keunggulan dalam permainan atau sekadar untuk menambah keseruan.</li><li><strong>Partisipasi dalam Event</strong>: Hago sering mengadakan event atau kompetisi di mana kamu bisa menggunakan Diamond untuk membeli tiket masuk atau item khusus yang dibutuhkan untuk berpartisipasi.</li><li><strong>Cara Mendapatkan Diamond Hago:</strong><br><strong>Pembelian</strong>: Diamond bisa dibeli dengan uang sungguhan melalui website atau aplikasi <a href="{{ route('home') }}"><strong>TopUpGim</strong></a>.<br><strong>Hadiah atau Event</strong>: Kadang-kadang, Hago memberikan Diamond sebagai hadiah dalam event tertentu atau melalui pencapaian dalam game.</li></ol><p>Diamond Hago merupakan salah satu cara Hago menghasilkan pendapatan sekaligus memberikan nilai tambah bagi pengguna yang ingin memaksimalkan pengalaman mereka di aplikasi ini.</p><p>Diamonds bisa diperoleh dengan membelinya menggunakan uang nyata melalui berbagai metode pembayaran yang tersedia di platform game, atau melalui event-event dalam game yang menawarkan diamonds sebagai hadiah. Cara termudah untuk melakukan <a href="{{ route('home') }}"><strong>top up Hago</strong></a> adalah melalui <strong>TopUpGim</strong>, platform yang menyediakan layanan top-up dengan cepat dan mudah.</p><h3>Cara Top Up Hago Termurah</h3><p>Berikut adalah langkah-langkah untuk top up Hago di Topupgim:</p><ol><li><strong>Buka Website Topupgim</strong>: Kunjungi situs resmi <strong>Topupgim</strong> melalui browser di perangkat kamu atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi</strong> <strong>Topupgim</strong></a>.</li><li><strong>Pilih Game Hago</strong>: Setelah masuk ke halaman utama, cari dan pilih "<a href="1528242362.html"><strong>Top Up Hago</strong></a>" dari daftar game yang tersedia.</li><li><strong>Masukkan ID Hago</strong>: Masukkan ID Hago kamu pada kolom yang tersedia. Pastikan ID yang kamu masukkan sudah benar agar Diamond bisa masuk ke akunmu.</li><li><strong>Pilih Jumlah Diamond</strong>: Pilih jumlah Diamond yang ingin kamu beli. Topupgim biasanya menawarkan beberapa pilihan paket dengan harga yang berbeda.</li><li><strong>Pilih Metode Pembayaran</strong>: Pilih metode pembayaran yang paling sesuai dengan kamu, seperti transfer bank, e-wallet, atau metode lain yang tersedia.</li><li><strong>Selesaikan Pembayaran</strong>: Ikuti instruksi untuk menyelesaikan pembayaran. Pastikan pembayaran dilakukan dengan benar agar transaksi berjalan lancar.</li><li><strong>Diamond Masuk ke Akun</strong>: Setelah pembayaran berhasil, Diamond akan otomatis masuk ke akun Hago kamu dalam beberapa menit. Kamu akan menerima notifikasi atau konfirmasi dari Topupgim mengenai suksesnya transaksi.</li><li><strong>Cek Akun Hago</strong>: Buka aplikasi Hago dan periksa apakah Diamond sudah bertambah di akun kamu. Jika ada masalah, kamu bisa menghubungi layanan pelanggan Topupgim untuk bantuan lebih lanjut.</li></ol><p>Dengan mengikuti langkah-langkah ini, kamu bisa <a href="1528242362.html"><strong>beli Diamond Hago</strong></a> dengan mudah dan cepat di Topupgim.</p><h3>Keuntungan Top Up Hago di TopUpGim</h3><p>Berikut adalah beberapa keuntungan <a href="1528242362.html"><strong>beli dm Hago</strong></a> di Topupgim:</p><ol><li><strong>Harga Termurah</strong><br>Topupgim menawarkan harga yang sangat kompetitif, sering kali lebih murah dibandingkan platform lainnya. Kamu bisa mendapatkan Diamond Hago dengan harga terbaik, sehingga lebih hemat untuk menikmati fitur premium dalam game.</li><li><strong>Proses Cepat dan Mudah</strong><br>Topupgim memiliki proses transaksi yang cepat dan sederhana. Kamu bisa top up Diamond hanya dalam beberapa langkah, dan Diamond akan masuk ke akun Hago kamu dalam waktu singkat.</li><li><strong>Pilihan Pembayaran Beragam</strong><br>Topupgim menyediakan berbagai metode pembayaran yang fleksibel, seperti transfer bank, e-wallet, kartu kredit, dan lainnya. Ini memudahkan kamu untuk memilih cara pembayaran yang paling sesuai dengan kebutuhanmu.</li><li><strong>Transaksi Aman</strong><br>Topupgim menjamin keamanan transaksi dengan sistem yang terpercaya dan enkripsi data yang kuat. Kamu bisa top up tanpa khawatir tentang keamanan informasi pribadi atau risiko penipuan.</li><li><strong>Customer Support Responsif</strong><br>Topupgim memiliki layanan pelanggan yang responsif dan siap membantu jika ada kendala dalam proses top up. Kamu bisa menghubungi mereka kapan saja untuk mendapatkan bantuan atau penjelasan lebih lanjut.&nbsp;</li></ol><p>Dengan berbagai keuntungan ini, Topupgim menjadi pilihan yang tepat bagi kamu yang ingin top up Diamond Hago dengan harga terjangkau, aman, dan mudah.</p><h4>Rekomendasi Top Up Game Lainnya</h4><p>Di Topupgim.com, selain Hago, Anda juga bisa melakukan top up untuk berbagai game populer lainnya. Beberapa game yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../mobile-legends/1528378309.html"><strong>Top Up Mobile Legends&nbsp;</strong></a></li><li><a href="../pubgm/1528036161.html"><strong>Top Up PUBG Mobile&nbsp;</strong></a></li><li><a href="../call-of-duty-mobile/1528919312.html"><strong>Top Up Call of Duty Mobile (CODM)&nbsp;</strong></a></li><li><a href="../honor-of-kings/1528385129.html"><strong>Top Up Honor of Kings&nbsp;</strong></a></li><li><a href="../zepeto/1528847900.html"><strong>Top Up Zepeto</strong></a></li><li><a href="../free-fire/1528555434.html"><strong>Top Up Free Fire</strong></a></li><li><a href="../dana/1528543830.html"><strong>Top Up Dana</strong></a></li><li><a href="../blood-strike/1528112021.html"><strong>Top Up Blood Strike&nbsp;</strong></a></li><li><a href="../honkai-star-rail/1528308068.html"><strong>Top Up Honkai: Star Rail</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="eSPs8Eo7-q5r0-3JBJz-PUXiv6HPeoqlG9sk">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_LH304P91" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_LH304P91" name="productDenomination" value="LH304P91" data-price-preview="3380" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_LH304P91">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/b379ba4b-de57-4e64-965f-3cf99f6ba069.png?w=75" alt="2000 Diamond">
                                                                <span id="productDenominationTitle_LH304P91" class="fs-sm fw-semibold">2000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp3.380</p>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp195</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_AD190SXC" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_AD190SXC" name="productDenomination" value="AD190SXC" data-price-preview="6760" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_AD190SXC">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/8814d042-18d8-4d76-9836-aae2e7d06b38.png?w=75" alt="4000 Diamond">
                                                                <span id="productDenominationTitle_AD190SXC" class="fs-sm fw-semibold">4000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp6.760</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp7.150</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp390</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_FD011L8A" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_FD011L8A" name="productDenomination" value="FD011L8A" data-price-preview="17220" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_FD011L8A">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/914a5bec-46c6-4148-871f-0ddbc16ee296.png?w=75" alt="10000 Diamond">
                                                                <span id="productDenominationTitle_FD011L8A" class="fs-sm fw-semibold">10000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp17.220</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp17.875</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp655</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_KM9654SU" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KM9654SU" name="productDenomination" value="KM9654SU" data-price-preview="43040" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KM9654SU">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/b60524cf-e410-4fe4-b88e-0fbf4ac24ca6.png?w=75" alt="25000 Diamond">
                                                                <span id="productDenominationTitle_KM9654SU" class="fs-sm fw-semibold">25000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp43.040</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp44.687</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp1.647</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_WY738ELO" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_WY738ELO" name="productDenomination" value="WY738ELO" data-price-preview="86080" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_WY738ELO">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/8e67f182-0d68-4571-8e43-80ad19291e74.png?w=75" alt="50000 Diamond">
                                                                <span id="productDenominationTitle_WY738ELO" class="fs-sm fw-semibold">50000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp86.080</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp89.375</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp3.295</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EJ5436QT" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EJ5436QT" name="productDenomination" value="EJ5436QT" data-price-preview="172170" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EJ5436QT">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d4b0ce86-3fbf-477d-ba8d-b2a5062cef4f.png?w=75" alt="100000 Diamond">
                                                                <span id="productDenominationTitle_EJ5436QT" class="fs-sm fw-semibold">100000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp172.170</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp178.750</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp6.580</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_ZH480L8T" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZH480L8T" name="productDenomination" value="ZH480L8T" data-price-preview="257850" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZH480L8T">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/81e0edf7-c4fa-4505-b564-3321253fd8d3.png?w=75" alt="150000 Diamond">
                                                                <span id="productDenominationTitle_ZH480L8T" class="fs-sm fw-semibold">150000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp257.850</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp268.125</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp10.275</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_AK8588V4" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_AK8588V4" name="productDenomination" value="AK8588V4" data-price-preview="343330" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_AK8588V4">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/0df9b5b5-4d51-4c7a-925f-67089d430f9a.png?w=75" alt="200000 Diamond">
                                                                <span id="productDenominationTitle_AK8588V4" class="fs-sm fw-semibold">200000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp343.330</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp357.500</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp14.170</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_BA698KCD" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_BA698KCD" name="productDenomination" value="BA698KCD" data-price-preview="856230" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_BA698KCD">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/ba8eaaf3-a83e-436d-a285-9d6c56ff46f6.png?w=75" alt="500000 Diamond">
                                                                <span id="productDenominationTitle_BA698KCD" class="fs-sm fw-semibold">500000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp856.230</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp893.750</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp37.520</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_DS33805Y" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_DS33805Y" name="productDenomination" value="DS33805Y" data-price-preview="1711040" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_DS33805Y">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/1cd366c4-6523-44e4-86f0-04606c07d14a.png?w=75" alt="1000000 Diamond">
                                                                <span id="productDenominationTitle_DS33805Y" class="fs-sm fw-semibold">1000000 Diamond</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp1.711.040</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.787.500</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp76.460</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_CW7079C7" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_CW7079C7" name="productDenomination" value="CW7079C7" data-price-preview="31280" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_CW7079C7">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/08b6ca24-18aa-40a6-a6dd-edb91f04fe96.png?w=75" alt="Bangsawan Knight Perpanjang">
                                                                <span id="productDenominationTitle_CW7079C7" class="fs-sm fw-semibold">Bangsawan Knight Perpanjang</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp31.280</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp35.750</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_ZO780B0P" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZO780B0P" name="productDenomination" value="ZO780B0P" data-price-preview="388310" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZO780B0P">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/154d77df-2fdf-4fb1-ad5f-6cdd54a1d3d1.png?w=75" alt="Bangsawan Viscount Perpanjang">
                                                                <span id="productDenominationTitle_ZO780B0P" class="fs-sm fw-semibold">Bangsawan Viscount Perpanjang</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp388.310</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp446.875</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp58.565</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EB836TWG" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EB836TWG" name="productDenomination" value="EB836TWG" data-price-preview="89880" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EB836TWG">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/abcf1f6a-e682-445c-9b56-b214ce35bcad.png?w=75" alt="Hago Bangsawan Knight Baru">
                                                                <span id="productDenominationTitle_EB836TWG" class="fs-sm fw-semibold">Hago Bangsawan Knight Baru</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp89.880</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp107.250</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp17.370</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_JQ730UFK" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JQ730UFK" name="productDenomination" value="JQ730UFK" data-price-preview="925670" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JQ730UFK">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/a24a8474-beae-4f97-8404-be5fbe2996ad.png?w=75" alt="Hago Bangsawan Viscount Baru">
                                                                <span id="productDenominationTitle_JQ730UFK" class="fs-sm fw-semibold">Hago Bangsawan Viscount Baru</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp925.670</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.072.500</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp146.830</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                        ...
                        <div id="parent-content-faq" class="mt-5 d-none" style="margin-left: 4rem;">
                            <div id="content-faq">
                                ...
                                <div id="accordion_faq" role="tablist" aria-multiselectable="true">
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q74297441" aria-expanded="true" aria-controls="accordion_faq_q74297441">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h74297441">
                                            <span class="fw-semibold">Tutorial Top Up HAGO di Topupgim?</span>
                                        </div>
                                        <div id="accordion_faq_q74297441" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h74297441">
                                            <div class="block-content static-page">
                                                <ol><li>Kunjungi halaman <a target="_blank" rel="noopener noreferrer" href="1528242362.html"><strong>Top Up HAGO</strong></a>.</li><li>Masukkan Informasi ID akun HAGO kamu, kemudian klik tombol periksa untuk memastikan akun kamu sudah benar.</li><li>Pilih jumlah Diamonds.</li><li>Pilih metode pembayaran.</li><li>Masukkan kode promo (jika ada).</li><li>Klik tombol “Beli Sekarang”.</li><li>Selesaikan pembayaran dan Diamonds akan dikirim dalam hitungan detik (instan).</li></ol><p><br>&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q53755681" aria-expanded="true" aria-controls="accordion_faq_q53755681">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h53755681">
                                            <span class="fw-semibold">Cara Mendapatkan Informasi ID Akun HAGO?</span>
                                        </div>
                                        <div id="accordion_faq_q53755681" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h53755681">
                                            <div class="block-content static-page">
                                                <p>Untuk menemukan User ID anda, ketuk pada gambar profile di kiri atas. ID dapat anda temukan tepat di bawah nickname. Silahkan masukkan ID lengkap disini. Contoh: "12345678"</p><figure class="image"><img src="../../https://cdn.topupgim.com/product-helpers/4d845299-b636-496d-84ac-6bbc0709bf1a.jpg"></figure>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q86870823" aria-expanded="true" aria-controls="accordion_faq_q86870823">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h86870823">
                                            <span class="fw-semibold">Cara Mendapatkan Diamonds HAGO Gratis?</span>
                                        </div>
                                        <div id="accordion_faq_q86870823" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h86870823">
                                            <div class="block-content static-page">
                                                <p>Ikuti event dan promo Topupgim melalui Instagram &amp; Facebook Topupgim untuk mendapatkan diskon hingga giveaway Diamonds HAGO gratis.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q94672132" aria-expanded="true" aria-controls="accordion_faq_q94672132">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h94672132">
                                            <span class="fw-semibold">Tutorial Top Up HAGO Murah?</span>
                                        </div>
                                        <div id="accordion_faq_q94672132" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h94672132">
                                            <div class="block-content static-page">
                                                <ol><li>Kunjungi Topupgim.</li><li>Buka halaman Top Up HAGO.</li><li>Masukkan informasi ID Akun.</li><li>Pilih jumlah Diamonds yang kamu inginkan.</li><li>Agar makin murah masukkan kode promo Topupgim, tinggal dipilih kode promo yang tersedia!</li><li>Selesaikan pembayaran dan Diamonds HAGO termurah langsung dikirim ke akun game kamu!</li></ol><p><br>&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q59777606" aria-expanded="true" aria-controls="accordion_faq_q59777606">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h59777606">
                                            <span class="fw-semibold">Apakah Topupgim Aman?</span>
                                        </div>
                                        <div id="accordion_faq_q59777606" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h59777606">
                                            <div class="block-content static-page">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhago%2F1528242362%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/hago/1528242362?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/4d845299-b636-496d-84ac-6bbc0709bf1a.jpg">
                                        <div class="static-page"><p>Untuk menemukan User ID anda, ketuk pada gambar profile di kiri atas. ID dapat anda temukan tepat di bawah nickname. Silahkan masukkan ID lengkap disini. Contoh: "12345678"</p></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                        ...
                        <div class="modal fade" id="modal-how-to-order" tabindex="-1" role="dialog" aria-labelledby="modal-how-to-order" aria-describedby="modal-how-to-order" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page" style="min-height: 380px;"><ol><li>Masukkan User ID.</li><li>Pilih produk Diamonds (DM) dan metode pembayaran.</li><li>Gunakan kode promo dan login untuk mendapatkan cashback agar <strong>lebih murah</strong>.</li><li>Selesaikan pembayaran dan Diamonds (DM) Hago akan dikirim hitungan detik.</li></ol></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/4c6e19a1-1aaa-4bb4-8f3d-c321a31a250eebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">HAGO</span>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions81ca.html?code=1528242362';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/panduan-lengkap-menggunakan-fitur-sosial-di-hago-chat-voice-call-live-streaming-banyak-lagi.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/d7f81265-01af-478e-bd7c-bfc8b2b54be5.png?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Panduan Lengkap Menggunakan Fitur Sosial di Hago: Chat, Voice Call, Live Streaming &amp; Banyak Lagi!
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Maximalkan pengalaman bermainmu di Hago dengan fitur sosial seru seperti chat, voice call, live streaming, dan teman sekitar. Bergabunglah dengan komunitas, bangun koneksi, dan rasakan keseruan lebih nyata dalam setiap permainan!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/cara-main-hago-dengan-mudah-di-perangkat-android.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/9b6c3103-920b-456a-aae3-0e0a03732e12.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Cara Main Hago dengan Mudah di Perangkat Android
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Seru-seruan bareng teman di Hago! Temukan lebih dari 80 game seru, chat, dan hadiah virtual yang bikin pengalaman bermain makin asyik. Unduh sekarang dan mulai petualanganmu! 🎮✨
                                </p>
                            </div>
                        </a>
                    </div>
