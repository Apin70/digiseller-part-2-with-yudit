...
@section('title', 'Top Up Lineage2M Murah | Diamonds Lineage2M | Topupgim - TopUpGim')
            ...
            <div class="row g-0 flex-md-grow-1 ps-xl-5 pe-xl-4 pb-4">
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <!-- Description Content -->
                        <h1 class="mb-2">Top Up Lineage2M</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p>Top Up Lineage2M resmi dengan <strong>harga termurah</strong> se-Indonesia di Topupgim.com</p><p><strong>Kenapa Top Up di Topupgim.com?</strong></p><div class="raw-html-embed">
        
    <ul class="list_alasan" style="list-style: none; padding-left: 0;">
                <li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Dijamin Hemat</strong>. Pasti ada promo setiap hari 🔥
            
    </li>
        <li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti transfer.
</li>
<li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Dijamin Resmi</strong>. Pasti dikirim dalam hitungan detik.
</li>
</ul>
<p style="font-size: 13px;">
Top Up Lineage2M murah dan aman di Topupgim, dijamin harga termurah dan pengiriman instan. 
</p>
</div></div>
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="QNm76oTA-XCsI4YRJYuSfAHwMUlMROTK5DFI">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <select data-property-type="options" id="property-zone_id" name="property-zone_id" class="form-select text-body-color" required>
                                                        <option value="14001">Bartz01</option>
                                                        <option value="14002">Bartz02</option>
                                                        <option value="14003">Bartz03</option>
                                                        <option value="14004">Bartz04</option>
                                                        <option value="14005">Bartz05</option>
                                                        <option value="14006">Bartz06</option>
                                                        <option value="14007">Bartz07</option>
                                                        <option value="14008">Bartz08</option>
                                                        <option value="14009">Bartz09</option>
                                                        <option value="14010">Bartz10</option>
                                                        <option value="14011">Kain01</option>
                                                        <option value="14012">Kain02</option>
                                                        <option value="14013">Kain03</option>
                                                        <option value="14014">Kain04</option>
                                                        <option value="14015">Kain05</option>
                                                        <option value="14016">Kain06</option>
                                                        <option value="14017">Kain07</option>
                                                        <option value="14018">Kain08</option>
                                                        <option value="14019">Kain09</option>
                                                        <option value="14020">Kain10</option>
                                                        <option value="14021">Teon01</option>
                                                        <option value="14022">Teon02</option>
                                                        <option value="14023">Teon03</option>
                                                        <option value="14024">Teon04</option>
                                                        <option value="14025">Teon05</option>
                                                        <option value="14026">Teon06</option>
                                                        <option value="14027">Teon07</option>
                                                        <option value="14028">Teon08</option>
                                                        <option value="14029">Teon09</option>
                                                        <option value="14030">Teon10</option>
                                                        <option value="14031">Leona01</option>
                                                        <option value="14032">Leona02</option>
                                                        <option value="14033">Leona03</option>
                                                        <option value="14034">Leona04</option>
                                                        <option value="14035">Leona05</option>
                                                        <option value="14036">Leona06</option>
                                                        <option value="14037">Leona07</option>
                                                        <option value="14038">Leona08</option>
                                                        <option value="14039">Leona09</option>
                                                        <option value="14040">Leona10</option>
                                                        <option value="14041">Erica01</option>
                                                        <option value="14042">Erica02</option>
                                                        <option value="14043">Erica03</option>
                                                        <option value="14044">Erica04</option>
                                                        <option value="14045">Erica05</option>
                                                        <option value="14046">Erica06</option>
                                                        <option value="14047">Erica07</option>
                                                        <option value="14048">Erica08</option>
                                                        <option value="14049">Erica09</option>
                                                        <option value="14050">Erica10</option>
                                                        <option value="14051">Aria01</option>
                                                        <option value="14052">Aria02</option>
                                                        <option value="14053">Aria03</option>
                                                        <option value="14054">Aria04</option>
                                                        <option value="14055">Aria05</option>
                                                        <option value="14056">Aria06</option>
                                                        <option value="14057">Aria07</option>
                                                        <option value="14058">Aria08</option>
                                                        <option value="14059">Aria09</option>
                                                        <option value="14060">Aria10</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_UL569CH6" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_UL569CH6" name="productDenomination" value="UL569CH6" data-price-preview="11320" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_UL569CH6">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_UL569CH6" class="fs-sm fw-semibold">40 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp11.320</p>
                                                ...
                                                <div id="pDRoot_ZY398PKI" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZY398PKI" name="productDenomination" value="ZY398PKI" data-price-preview="29240" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZY398PKI">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_ZY398PKI" class="fs-sm fw-semibold">100 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp29.240</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_KR593X25" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KR593X25" name="productDenomination" value="KR593X25" data-price-preview="34840" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KR593X25">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_KR593X25" class="fs-sm fw-semibold">120 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp34.840</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_WC453X4E" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_WC453X4E" name="productDenomination" value="WC453X4E" data-price-preview="56910" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_WC453X4E">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_WC453X4E" class="fs-sm fw-semibold">200 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp56.910</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_XO845XCH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XO845XCH" name="productDenomination" value="XO845XCH" data-price-preview="113600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XO845XCH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_XO845XCH" class="fs-sm fw-semibold">400 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp113.600</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_IW210FC3" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_IW210FC3" name="productDenomination" value="IW210FC3" data-price-preview="280130" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_IW210FC3">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_IW210FC3" class="fs-sm fw-semibold">1000 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp280.130</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_QI986KBC" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_QI986KBC" name="productDenomination" value="QI986KBC" data-price-preview="336540" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_QI986KBC">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_QI986KBC" class="fs-sm fw-semibold">1200 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp336.540</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_KO566HBQ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KO566HBQ" name="productDenomination" value="KO566HBQ" data-price-preview="558860" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KO566HBQ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_KO566HBQ" class="fs-sm fw-semibold">2000 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp558.860</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EM323JMA" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EM323JMA" name="productDenomination" value="EM323JMA" data-price-preview="1119620" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EM323JMA">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_EM323JMA" class="fs-sm fw-semibold">4000 Diamond</span>
                                                                <p class="fs-sm mt-1">Rp1.119.620</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_IX359JEG" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_IX359JEG" name="productDenomination" value="IX359JEG" data-price-preview="" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_IX359JEG">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_IX359JEG" class="fs-sm fw-semibold">Daily Package 1</span>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_DK1074TT" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_DK1074TT" name="productDenomination" value="DK1074TT" data-price-preview="" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_DK1074TT">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_DK1074TT" class="fs-sm fw-semibold">Daily Package 2</span>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_VH913P32" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_VH913P32" name="productDenomination" value="VH913P32" data-price-preview="" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_VH913P32">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_VH913P32" class="fs-sm fw-semibold">Daily Package 3</span>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_SK389ZXF" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_SK389ZXF" name="productDenomination" value="SK389ZXF" data-price-preview="" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_SK389ZXF">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_SK389ZXF" class="fs-sm fw-semibold">Ink of Mana</span>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EG049E8U" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EG049E8U" name="productDenomination" value="EG049E8U" data-price-preview="12800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EG049E8U">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_EG049E8U" class="fs-sm fw-semibold">New Adventurers Package</span>
                                                                <p class="fs-sm mt-1">Rp12.800</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_FQ6692C1" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_FQ6692C1" name="productDenomination" value="FQ6692C1" data-price-preview="12800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_FQ6692C1">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_FQ6692C1" class="fs-sm fw-semibold">Weekly Top-up Agathion Benefits 1</span>
                                                                <p class="fs-sm mt-1">Rp12.800</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                ...
                                                <div id="pDRoot_MQ434XO7" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MQ434XO7" name="productDenomination" value="MQ434XO7" data-price-preview="18970" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MQ434XO7">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_MQ434XO7" class="fs-sm fw-semibold">Weekly Top-up Agathion Benefits 2</span>
                                                                <p class="fs-sm mt-1">Rp18.970</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_MH420FK9" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MH420FK9" name="productDenomination" value="MH420FK9" data-price-preview="30880" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MH420FK9">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_MH420FK9" class="fs-sm fw-semibold">Weekly Top-up Agathion Benefits 3</span>
                                                                <p class="fs-sm mt-1">Rp30.880</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_AZ5127AN" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_AZ5127AN" name="productDenomination" value="AZ5127AN" data-price-preview="12800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_AZ5127AN">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_AZ5127AN" class="fs-sm fw-semibold">Weekly Top-up Class Benefits 1</span>
                                                                <p class="fs-sm mt-1">Rp12.800</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                ...
                                                <div id="pDRoot_OG239QNQ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_OG239QNQ" name="productDenomination" value="OG239QNQ" data-price-preview="30880" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_OG239QNQ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_OG239QNQ" class="fs-sm fw-semibold">Weekly Top-up Class Benefits 3</span>
                                                                <p class="fs-sm mt-1">Rp30.880</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                ...
                                                <div id="pDRoot_ZQ5201V5" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZQ5201V5" name="productDenomination" value="ZQ5201V5" data-price-preview="58840" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZQ5201V5">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_ZQ5201V5" class="fs-sm fw-semibold">Welcome Agathion Key</span>
                                                                <p class="fs-sm mt-1">Rp58.840</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YZ012OCX" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YZ012OCX" name="productDenomination" value="YZ012OCX" data-price-preview="12800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YZ012OCX">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <span id="productDenominationTitle_YZ012OCX" class="fs-sm fw-semibold">Welcome Class Key</span>
                                                                <p class="fs-sm mt-1">Rp12.800</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Flineage2m%2F1528323527%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/lineage2m/1528323527?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page"><p>Berikut cara menemukan User ID di <strong>Racing Master</strong>:</p><ol><li><strong>Masuk ke dalam game</strong> menggunakan akun Anda.</li><li><strong data-start="118" data-end="148">Ketuk ikon "My Characters"</strong> yang terletak di pojok kanan bawah layar utama.</li><li><strong data-start="202" data-end="244">Server Lineage2M Anda akan ditampilkan</strong> di sana.</li><li><strong data-start="259" data-end="296">Ketuk ikon "Pengaturan (Setting)"</strong> yang terletak di pojok kanan atas layar.</li><li><strong data-start="343" data-end="391">Character ID Lineage2M Anda akan ditampilkan</strong> di layar.</li></ol></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/7e2ac09b-e8b4-4e81-af1c-02f62dabdb66ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Lineage2M</span>
