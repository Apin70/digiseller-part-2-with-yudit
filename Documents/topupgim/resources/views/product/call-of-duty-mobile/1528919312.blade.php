...
@section('title', 'Beli CP Call of Duty Mobile | Top Up CODM Murah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/e1063726-b8b5-4033-8049-57e7a48511e7.jpg" alt="Top Up Call of Duty Mobile">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up Call of Duty Mobile (CODM)</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Call of Duty Mobile (CODM)</strong> lebih murah dengan kode promo, diskon hingga 39%. 63 CP Call of Duty Mobile<strong> hanya Rp9.400.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up CODM di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                <h3 class="mb-4">Sultan Call of Duty Mobile</h3>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        ...
                                        <span class="text-muted fs-sm">Rp. 14.268.100</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">nugie</span>
                                        <span class="text-muted fs-sm">Rp. 5.212.200</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Rifki Mulianda Saputra</span>
                                        <span class="text-muted fs-sm">Rp. 4.029.200</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Edward Farell</span>
                                        <span class="text-muted fs-sm">Rp. 3.981.200</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    <span class="fw-semibold me-3">5</span>
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/member-avatars/1047246a-44e2-40dd-95cf-44cbf3a19bc204c0.jpg?w=60">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Ahmad fairuz</span>
                                        <span class="text-muted fs-sm">Rp. 3.451.800</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                ...
                                <div class="static-page w-100"><p><strong>Call of Duty: Mobile</strong> adalah permainan video <i>first-person shooter</i> (FPS) yang dikembangkan oleh TiMi Studios, anak perusahaan Tencent Games, dan diterbitkan oleh Activision untuk perangkat seluler. Game ini diluncurkan pada 1 Oktober 2019 dan tersedia untuk perangkat Android dan iOS.</p><p><strong>Fitur utama dari Call of Duty: Mobile:</strong></p><ol><li><strong>Mode Permainan:</strong> Game ini memiliki berbagai mode permainan, termasuk <i>multiplayer</i> tradisional, mode <i>battle royale</i>, <i>zombies</i>, dan berbagai acara khusus. Mode <i>multiplayer</i> mencakup berbagai tipe permainan seperti <i>Team Deathmatch</i>, <i>Domination</i>, <i>Search and Destroy</i>, dan lainnya.</li><li><strong>Peta dan Karakter:</strong> Game ini menampilkan peta dan karakter yang populer dari seri Call of Duty di konsol dan PC, seperti Nuketown, Hijacked, dan Crash, serta karakter seperti Ghost, Soap, dan Captain Price.</li><li><strong>Kontrol dan Kustomisasi:</strong> Kontrol diadaptasi untuk layar sentuh dengan berbagai pilihan kustomisasi, termasuk pengaturan sensitivitas, tata letak tombol, dan opsi grafis.</li><li><strong>Sistem Progression:</strong> Pemain bisa naik level dan membuka senjata, keterampilan operator, dan peralatan. Game ini juga memiliki sistem <i>battle pass</i> dengan hadiah gratis dan berbayar.</li><li><strong>Komunitas dan Esports:</strong> Call of Duty: Mobile memiliki komunitas yang aktif dan sering menjadi tuan rumah turnamen esports dengan hadiah besar, yang menarik pemain dari seluruh dunia.</li></ol><p><strong>Popularitas:</strong> Game ini dengan cepat menjadi sangat populer setelah diluncurkan, dengan jutaan unduhan dalam waktu singkat. Popularitasnya didukung oleh kualitas grafis yang tinggi, gameplay yang responsif, dan nostalgia bagi penggemar Call of Duty di platform lain.</p><h2>CP Call of Duty Mobile (CODM)</h2><p><strong>CP (Call of Duty Points)</strong> adalah mata uang premium dalam game <strong>Call of Duty: Mobile</strong>. Pemain dapat menggunakan CP untuk membeli berbagai item dalam game, seperti:</p><ol><li><strong>Skin Senjata dan Karakter:</strong> Pemain dapat membeli skin khusus untuk senjata dan karakter yang tidak memengaruhi gameplay tetapi memberikan tampilan yang berbeda.</li><li><strong>Battle Pass:</strong> CP bisa digunakan untuk membeli Battle Pass, yang memberi pemain akses ke berbagai hadiah eksklusif saat mereka naik level selama musim berlangsung.</li><li><strong>Kotak dan Bundel:</strong> CP juga dapat digunakan untuk membuka kotak (<i>crate</i>) atau membeli bundel yang berisi item langka, seperti senjata dengan atribut khusus, emote, atau aksesoris lainnya.</li><li><strong>Event dan Tawaran Khusus:</strong> Ada kalanya game menawarkan event atau promosi khusus di mana pemain dapat menggunakan CP untuk mendapatkan hadiah eksklusif yang tidak tersedia secara normal.</li></ol><p>CP biasanya dibeli dengan uang sungguhan melalui toko dalam game, tetapi kadang-kadang juga bisa diperoleh sebagai hadiah dari event tertentu. Website <strong>Topupgim</strong> adalah pilihan utama bagi para pemain Call of Duty Mobile yang mencari <a href="1528919312.html"><strong>top-up CP</strong></a> dengan harga termurah. Platform ini dikenal karena menawarkan harga kompetitif dan berbagai metode pembayaran yang aman serta mudah digunakan. Dengan layanan yang cepat dan dukungan pelanggan yang responsif, Topupgim memastikan setiap transaksi berjalan lancar dan bebas dari kendala. Pemain dapat dengan mudah mengisi CP mereka untuk membeli item eksklusif dalam game, Battle Pass, dan banyak lagi, tanpa perlu mengeluarkan biaya yang tinggi.</p><h3>Cara Top Up CP Call of Duty Mobile (CODM) Termurah</h3><p>Berikut adalah langkah-langkah untuk top up Call of Duty Mobile di <strong>Topupgim</strong>:</p><ol><li><strong>Kunjungi Website:</strong>&nbsp;<br>Buka browser Anda dan kunjungi situs web resmi <a href="{{ route('home') }}"><strong>Topupgim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Pilih Game:</strong> Di halaman utama, cari dan klik pada ikon <a href="1528919312.html"><strong>Call of Duty Mobile</strong></a>.</li><li><strong>Masukkan ID Pemain:</strong> Anda akan diminta untuk memasukkan ID pemain Call of Duty Mobile Anda. Pastikan ID yang dimasukkan benar untuk menghindari kesalahan pengiriman CP.</li><li><strong>Pilih Nominal Top Up:</strong> Pilih jumlah CP yang ingin Anda beli. Topupgim biasanya menyediakan beberapa pilihan nominal, mulai dari yang kecil hingga yang besar.</li><li><strong>Pilih Metode Pembayaran:</strong> Setelah memilih nominal, pilih metode pembayaran yang Anda inginkan. Topupgim mendukung berbagai metode pembayaran, seperti transfer bank, e-wallet, dan kartu kredit.</li><li><strong>Konfirmasi Pembelian:</strong> Periksa kembali semua detail transaksi Anda, termasuk ID pemain dan nominal CP yang dipilih. Jika semuanya sudah benar, lanjutkan dengan mengklik tombol <strong>Beli Sekarang</strong> atau <strong>Bayar</strong>.</li><li><strong>Selesaikan Pembayaran:</strong> Ikuti instruksi untuk menyelesaikan pembayaran melalui metode yang Anda pilih.</li><li><strong>Terima CP:</strong> Setelah pembayaran berhasil, CP akan dikirim langsung ke akun Call of Duty Mobile Anda. Proses ini biasanya memakan waktu beberapa menit, tetapi dalam beberapa kasus bisa sedikit lebih lama tergantung pada metode pembayaran.</li><li><strong>Cek Akun:</strong> Setelah transaksi selesai, periksa akun Call of Duty Mobile Anda untuk memastikan CP telah masuk.</li></ol><p>Dengan mengikuti langkah-langkah ini, Anda bisa dengan mudah <a href="{{ route('home') }}"><strong>top up CODM</strong></a> di TopUpGim.</p><h3>Keuntungan Top Up CODM di Topupgim</h3><p>Berikut adalah beberapa keuntungan top up Call of Duty Mobile (CODM) di <strong>Topupgim</strong>:</p><ol><li><strong>Harga Kompetitif:</strong>&nbsp;<br>Topupgim dikenal sebagai salah satu platform yang menawarkan harga CP (Call of Duty Points) termurah, memungkinkan pemain mendapatkan lebih banyak CP dengan biaya lebih rendah.</li><li><strong>Proses Cepat dan Aman:</strong>&nbsp;<br>Topupgim menjamin transaksi yang cepat dan aman. CP biasanya dikirimkan ke akun pemain dalam hitungan menit setelah pembayaran selesai.</li><li><strong>Metode Pembayaran Beragam:</strong>&nbsp;<br>Topupgim menyediakan berbagai pilihan metode pembayaran yang fleksibel, termasuk transfer bank, e-wallet, dan kartu kredit, sehingga memudahkan pengguna untuk menyelesaikan transaksi.</li><li><strong>Promo dan Diskon:</strong>&nbsp;<br>Platform ini sering mengadakan promosi dan diskon khusus, sehingga pemain bisa mendapatkan lebih banyak nilai dari setiap top up.</li><li><strong>Layanan Pelanggan Responsif:</strong>&nbsp;<br>Jika terjadi masalah atau pertanyaan, Topupgim memiliki tim layanan pelanggan yang responsif dan siap membantu menyelesaikan masalah dengan cepat.</li><li><strong>Kredibilitas dan Kepercayaan:</strong>&nbsp;<br>Dengan reputasi yang baik di kalangan pemain game, Topupgim menjadi pilihan terpercaya untuk top up CP CODM, sehingga pemain bisa merasa tenang selama transaksi.</li></ol><p>Dengan berbagai keuntungan ini, Topupgim menjadi platform yang ideal bagi pemain Call of Duty Mobile untuk melakukan top up CP secara efisien dan hemat biaya.</p><h3>Metode Pembayaran</h3><p>Berikut adalah opsi metode pembayaran untuk top up CP Call of Duty Mobile di TopUpGim:</p><ol><li><strong>E-Wallet (Dompet Digital)</strong>:<br>Anda bisa menggunakan e-wallet populer seperti OVO, GoPay, DANA, dan ShopeePay. Ini memudahkan pembayaran langsung dari ponsel Anda dengan cepat dan praktis.</li><li><strong>Transfer Bank</strong>:<br>Tersedia pilihan transfer bank dari berbagai bank besar di Indonesia, seperti BCA, Mandiri, BNI, dan BRI. Prosesnya mudah dan dapat dilakukan melalui mobile banking, ATM, atau internet banking.</li><li><strong>Virtual Account</strong>:<br>Anda dapat membayar melalui virtual account yang disediakan oleh bank. Ini memungkinkan pembayaran instan tanpa perlu konfirmasi tambahan.</li><li><strong>Minimarket</strong>:<br>Untuk pembayaran tunai, Anda bisa menggunakan layanan di minimarket seperti Indomaret dan Alfamart. Ini cocok bagi Anda yang lebih nyaman membayar langsung di gerai.</li><li><strong>QRIS</strong>:<br>QRIS mempermudah pembayaran melalui kode QR, mendukung berbagai aplikasi pembayaran dalam satu standar.</li><li><strong>Unipin CODM, Codashop CODM, Kiosgamer CODM</strong></li></ol><p>Dengan beragam metode ini, Anda dapat memilih yang paling sesuai dengan preferensi dan kenyamanan Anda saat melakukan top-up Call of Duty Mobile di TopUpGim.</p><h4>Rekomendasi Top Up Game Lainnya</h4><p>Di Topupgim.com, selain Call of Duty Mobile (CODM), Anda juga bisa melakukan top up untuk berbagai game populer lainnya. Beberapa game yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../mobile-legends/1528378309.html"><strong>Top Up Mobile Legends&nbsp;</strong></a></li><li><a href="../pubgm/1528036161.html"><strong>Top Up PUBG Mobile&nbsp;</strong></a></li><li><a href="../free-fire/1528555434.html"><strong>Top Up Free Fire (FF)</strong></a></li><li><a href="../honor-of-kings/1528385129.html"><strong>Top Up Honor of Kings&nbsp;</strong></a></li><li><a href="../zepeto/1528847900.html"><strong>Top Up Zepeto</strong></a></li><li><a href="../hago/1528242362.html"><strong>Top Up Hago&nbsp;</strong></a></li><li><a href="../dana/1528543830.html"><strong>Top Up Dana</strong></a></li><li><a href="../blood-strike/1528112021.html"><strong>Top Up Blood Strike&nbsp;</strong></a></li><li><a href="../honkai-star-rail/1528308068.html"><strong>Top Up Honkai: Star Rail</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="cP50TvWH-dgvnMWP9Y0BAqbgpmRE5zXhwA38">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-user_id">Player ID <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity" id="property-user_id" name="property-user_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Player ID.." value="" required>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_RY874Z6O" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_RY874Z6O" name="productDenomination" value="RY874Z6O" data-price-preview="4900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_RY874Z6O">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/b290cf4e-f6ef-497c-88a1-afc8e9a8edfb.png?w=75" alt="31 CP">
                                                                <span id="productDenominationTitle_RY874Z6O" class="fs-sm fw-semibold">31 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp4.900</p>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp100</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_RO707V3Z" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_RO707V3Z" name="productDenomination" value="RO707V3Z" data-price-preview="9700" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_RO707V3Z">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/0e068b0b-a3d0-43b9-b629-2b16c70d325f.png?w=75" alt="63 CP">
                                                                <span id="productDenominationTitle_RO707V3Z" class="fs-sm fw-semibold">63 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp9.700</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp10.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp300</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_ZR776WD3" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZR776WD3" name="productDenomination" value="ZR776WD3" data-price-preview="19400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZR776WD3">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/2439fd62-ea38-4198-8b4b-e761f746830a.png?w=75" alt="128 CP">
                                                                <span id="productDenominationTitle_ZR776WD3" class="fs-sm fw-semibold">128 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp19.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp20.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp600</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_XU765U03" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XU765U03" name="productDenomination" value="XU765U03" data-price-preview="49000" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XU765U03">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/ae4db189-fbd2-4c52-b7ba-2faa614f4db7.png?w=75" alt="321 CP">
                                                                <span id="productDenominationTitle_XU765U03" class="fs-sm fw-semibold">321 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp49.000</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp50.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp1.000</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YX0632B4" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YX0632B4" name="productDenomination" value="YX0632B4" data-price-preview="97900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YX0632B4">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/99599cfd-dcd6-485a-9f21-2de922d90c45.png?w=75" alt="645 CP">
                                                                <span id="productDenominationTitle_YX0632B4" class="fs-sm fw-semibold">645 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp97.900</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp100.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp2.100</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_TP061DEL" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_TP061DEL" name="productDenomination" value="TP061DEL" data-price-preview="117400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_TP061DEL">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/b450d6de-0c12-41b3-b564-57a91a1a2129.png?w=75" alt="800 CP">
                                                                <span id="productDenominationTitle_TP061DEL" class="fs-sm fw-semibold">800 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp117.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp120.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp2.600</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_ZN465W5F" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZN465W5F" name="productDenomination" value="ZN465W5F" data-price-preview="195600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZN465W5F">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/879ef369-55da-48d9-bb4f-a0e83f34cc16.png?w=75" alt="1373 CP">
                                                                <span id="productDenominationTitle_ZN465W5F" class="fs-sm fw-semibold">1373 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp195.600</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp200.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp4.400</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_TD640GS2" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_TD640GS2" name="productDenomination" value="TD640GS2" data-price-preview="292800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_TD640GS2">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d85b6d60-1167-4303-b4bb-380b14441330.png?w=75" alt="2060 CP">
                                                                <span id="productDenominationTitle_TD640GS2" class="fs-sm fw-semibold">2060 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp292.800</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp300.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp7.200</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_NA919VNA" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_NA919VNA" name="productDenomination" value="NA919VNA" data-price-preview="487000" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_NA919VNA">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/83ee7225-54bc-4d43-958f-03dae759a12b.png?w=75" alt="3564 CP">
                                                                <span id="productDenominationTitle_NA919VNA" class="fs-sm fw-semibold">3564 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp487.000</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp500.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp13.000</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EJ5675ZW" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EJ5675ZW" name="productDenomination" value="EJ5675ZW" data-price-preview="710300" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EJ5675ZW">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d9d406c1-c9d4-442b-8d0b-cce226c6d018.png?w=75" alt="5618 CP">
                                                                <span id="productDenominationTitle_EJ5675ZW" class="fs-sm fw-semibold">5618 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp710.300</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp730.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_YB5782IE" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YB5782IE" name="productDenomination" value="YB5782IE" data-price-preview="972400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YB5782IE">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/7f462c59-b882-45c0-a4ca-a656bc5eab4b.png?w=75" alt="7656 CP">
                                                                <span id="productDenominationTitle_YB5782IE" class="fs-sm fw-semibold">7656 CP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp972.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.000.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp27.600</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                        ...
                        <div id="parent-content-faq" class="mt-5 d-none" style="margin-left: 4rem;">
                            <div id="content-faq">
                                ...
                                <div id="accordion_faq" role="tablist" aria-multiselectable="true">
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q69576125" aria-expanded="true" aria-controls="accordion_faq_q69576125">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h69576125">
                                            <span class="fw-semibold">Tutorial Top Up CODM (Call of Duty Mobile) di Topupgim?</span>
                                        </div>
                                        <div id="accordion_faq_q69576125" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h69576125">
                                            <div class="block-content static-page">
                                                <ol><li>Kunjungi halaman <a target="_blank" rel="noopener noreferrer" href="1528919312.html"><strong>Top Up Call of Duty Mobile</strong></a>.</li><li>Masukkan Informasi ID akun Call of Duty Mobile kamu, kemudian klik tombol periksa untuk memastikan akun kamu sudah benar.</li><li>Pilih jumlah CP.</li><li>Pilih metode pembayaran.</li><li>Masukkan kode promo (jika ada).</li><li>Klik tombol “Beli Sekarang”.</li><li>Selesaikan pembayaran dan CP akan dikirim dalam hitungan detik (instan).</li></ol>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q53777586" aria-expanded="true" aria-controls="accordion_faq_q53777586">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h53777586">
                                            <span class="fw-semibold">Cara Mendapatkan Informasi ID Akun CODM?</span>
                                        </div>
                                        <div id="accordion_faq_q53777586" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h53777586">
                                            <div class="block-content static-page">
                                                <p>Untuk menemukan ID Pemain Anda, klik ikon Pengaturan di sudut kanan atas layar dan buka tab 'Others'.&nbsp;</p><figure class="image"><img src="../../https://cdn.topupgim.com/product-helpers/562acabd-0f02-47fc-91e9-d94613c032d4.jpg"></figure>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q64653188" aria-expanded="true" aria-controls="accordion_faq_q64653188">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h64653188">
                                            <span class="fw-semibold">Cara Mendapatkan CP CODM Gratis?</span>
                                        </div>
                                        <div id="accordion_faq_q64653188" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h64653188">
                                            <div class="block-content static-page">
                                                <p>Ikuti event dan promo Topupgim melalui Instagram &amp; Facebook Topupgim untuk mendapatkan diskon hingga giveaway CP CODM gratis.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q95950581" aria-expanded="true" aria-controls="accordion_faq_q95950581">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h95950581">
                                            <span class="fw-semibold">Tutorial Top Up CODM (Call of Duty Mobile) Murah?</span>
                                        </div>
                                        <div id="accordion_faq_q95950581" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h95950581">
                                            <div class="block-content static-page">
                                                <ol><li>Kunjungi Topupgim.</li><li>Buka halaman Top Up Call of Duty Mobile.</li><li>Masukkan informasi ID Akun.</li><li>Pilih jumlah CP yang kamu inginkan.</li><li>Agar makin murah masukkan kode promo Topupgim, tinggal dipilih kode promo yang tersedia!</li><li>Selesaikan pembayaran dan CP CODM termurah langsung dikirim ke akun game kamu!</li></ol><p><br>&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-rounded block-link mb-1" data-bs-toggle="collapse" data-bs-parent="#accordion_faq" href="#accordion_faq_q93460013" aria-expanded="true" aria-controls="accordion_faq_q93460013">
                                        <div class="block-header block-header-default" role="tab" id="accordion_faq_h93460013">
                                            <span class="fw-semibold">Apakah Topupgim Aman?</span>
                                        </div>
                                        <div id="accordion_faq_q93460013" class="collapse" role="tabpanel" aria-labelledby="accordion_faq_h93460013">
                                            <div class="block-content static-page">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fcall-of-duty-mobile%2F1528919312%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/call-of-duty-mobile/1528919312?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/562acabd-0f02-47fc-91e9-d94613c032d4.jpg">
                                        <div class="static-page"><p>Untuk menemukan ID Pemain Anda, klik ikon Pengaturan di sudut kanan atas layar dan buka tab 'Others'.&nbsp;</p><div style="border-radius:12px;height:0;overflow:hidden;padding-bottom:56.25%;position:relative;"><iframe style="height:100%;left:0;position:absolute;top:0;width:100%;" src="https://www.youtube.com/embed/v82PnOWiWiQ" title="Tutorial Cek ID CODM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="">
      </iframe></div></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/234ebffe-a86e-49f2-a6d6-0227e68b8c94ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Call of Duty Mobile</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Player ID</p>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions7c59.html?code=1528919312';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/ram-7-mythic-codm-hadir-senjata-super-mewah-dengan-efek-visual-fantastis.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/7c8e71ae-3151-4393-9774-2e1953f43cb8.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    RAM-7 Mythic CODM Hadir, Senjata Super Mewah dengan Efek Visual Fantastis
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    RAM-7 Mythic CODM hadir dengan desain futuristik dan efek visual memukau, jadi pilihan utama para pemain yang cari senjata eksklusif dan powerful. Jangan lewatkan kesempatan dapatkan senjata legendaris ini!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/menguasai-map-coastal-call-of-duty-mobile-panduan-lengkap-strategi-spot-loot-dan-tips-bertempur-yang-wajib-kamu-kuasai.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/8f77db9e-e427-4259-bb7e-d8cbf767a6fc.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Menguasai Map Coastal Call of Duty Mobile: Panduan Lengkap Strategi, Spot Loot, dan Tips Bertempur yang Wajib Kamu Kuasai
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Pelajari strategi dan taktik terbaik di map Coastal Call of Duty Mobile. Dari spot loot, posisi sniper, hingga rotasi flank, kuasai semuanya dan jadilah penguasa medan tempur!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/mengenal-map-dome-call-of-duty-mobile-strategi-lengkap-spot-dominasi-dan-tips-menang.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/4f6037ad-fb00-4452-a460-167bbab6679c.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                ...
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Kuasai Map Dome Call of Duty Mobile! Pelajari strategi terbaik, spot dominasi, dan tips pro player untuk memenangkan setiap pertempuran di arena padat dan intens ini. Wajib baca buat kamu yang ingin push rank lebih cepat!
                                </p>
                            </div>
                        </a>
                    </div>
