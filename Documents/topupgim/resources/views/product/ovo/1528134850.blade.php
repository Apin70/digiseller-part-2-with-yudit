...
@section('title', 'Beli Saldo OVO | Top Up OVO Murah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/176fb60c-bea4-47fe-a5bd-abd7e48ac506.jpg" alt="Top Up OVO">
                            </div>
                        </div>
                        <!-- END Cover Content -->
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up OVO</strong> lebih murah dengan kode promo, Tanpa potongan admin. 10.000 Saldo OVO<strong> hanya Rp11.000.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up OVO di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            <span class="text-dark fs-sm fw-semibold mb-2 me-3">
                                <i class="fa fa-cart-shopping opacity-75 me-1"></i> Terjual: <span class="text-primary">9.4 rb</span>
                            </span>
                            ...
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://play.google.com/store/apps/details?id=ovo.id&amp;referrer=af_tranid%3DbC3PN4tmb2wnc520zl1I1A%26pid%3DOVO_Website%26c%3DWebsite_Install_Button_Adr" target="_blank">
                                <i class="fab fa-google-play opacity-75 me-1"></i> Play Store
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://apps.apple.com/ID/app/id1142114207?mt=8" target="_blank">
                                <i class="fab fa-app-store-ios opacity-75 me-1"></i> App Store
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://www.ovo.id/" target="_blank">
                                <i class="fa fa-globe opacity-75 me-1"></i> Website
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://www.facebook.com/OVOIDN/" target="_blank">
                                <i class="fa fa-comments opacity-75 me-1"></i> Komunitas
                            </a>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>OVO</h2>
                                <div class="static-page w-100"><p>OVO adalah layanan dompet digital (e-wallet) yang populer di Indonesia. OVO memungkinkan pengguna untuk melakukan berbagai transaksi keuangan secara digital dengan mudah dan cepat. Beberapa fitur utama OVO meliputi:</p><ol><li><strong>Pembayaran</strong>: OVO dapat digunakan untuk membayar berbagai jenis barang dan layanan, baik secara online di aplikasi e-commerce maupun di merchant offline yang bekerja sama.</li><li><strong>Top Up dan Transfer</strong>: Pengguna bisa mengisi saldo OVO melalui berbagai metode, seperti transfer bank atau menggunakan minimarket. OVO juga memungkinkan transfer dana ke sesama pengguna OVO atau ke rekening bank.</li><li><strong>Isi Pulsa dan Tagihan</strong>: OVO menyediakan fitur untuk mengisi pulsa ponsel, membayar tagihan listrik, air, dan berbagai tagihan lainnya.</li><li><strong>Promo dan Cashback</strong>: OVO sering menawarkan promo, diskon, dan cashback untuk transaksi yang dilakukan menggunakan e-wallet ini.</li><li><strong>Layanan Investasi</strong>: OVO juga menawarkan fitur investasi melalui OVO Invest, memungkinkan pengguna untuk berinvestasi dalam berbagai instrumen keuangan.</li><li><strong>Program Loyalty</strong>: OVO memiliki program loyalty yang memberikan poin atau rewards kepada pengguna yang sering bertransaksi, yang dapat ditukarkan dengan berbagai keuntungan atau diskon.</li></ol><p>OVO menawarkan kemudahan dalam bertransaksi, keamanan, serta berbagai manfaat tambahan, menjadikannya salah satu pilihan e-wallet utama di Indonesia.</p><h2>Saldo OVO</h2><p>Saldo OVO adalah jumlah uang yang tersimpan dalam akun OVO milik pengguna. Saldo ini dapat digunakan untuk berbagai transaksi digital, termasuk:</p><ol><li><strong>Pembayaran</strong>: Membayar barang dan jasa di aplikasi e-commerce, merchant offline yang bekerja sama, atau aplikasi yang mendukung OVO.</li><li><strong>Isi Pulsa dan Tagihan</strong>: Mengisi pulsa ponsel, membayar tagihan listrik, air, dan berbagai tagihan lainnya.</li><li><strong>Transfer Uang</strong>: Mengirim uang ke sesama pengguna OVO atau ke rekening bank.</li><li><strong>Investasi dan Rewards</strong>: Menggunakan saldo untuk berinvestasi melalui fitur OVO Invest atau memanfaatkan rewards dan poin dari program loyalty.</li></ol><p>Saldo OVO dapat diisi ulang melalui berbagai metode, seperti transfer bank, minimarket, atau menggunakan metode lain yang disediakan oleh OVO. Pengguna dapat memantau dan mengelola saldo mereka melalui aplikasi OVO, yang juga menawarkan fitur keamanan seperti PIN dan autentikasi dua faktor untuk melindungi transaksi. Website <a href="1528134850.html"><strong>top up OVO</strong></a> termurah adalah Topupgim. Platform ini terkenal karena menawarkan harga yang lebih kompetitif dibandingkan dengan layanan top-up lainnya, memungkinkan pengguna untuk mengisi saldo OVO mereka dengan biaya yang lebih rendah. Topupgim menyediakan proses top-up yang cepat dan mudah, didukung oleh berbagai metode pembayaran yang aman dan praktis. Dengan harga terjangkau dan kemudahan transaksi, Topupgim menjadi pilihan utama bagi banyak pengguna yang ingin menghemat biaya saat melakukan top-up saldo OVO.</p><h3>Cara Top Up Saldo OVO Termurah</h3><p>Berikut adalah langkah-langkah untuk top up OVO di Topupgim:</p><ol><li><strong>Buka Situs Topupgim</strong>:&nbsp;<br>Buka browser dan kunjungi situs <a href="{{ route('home') }}"><strong>web resmi TopUpGim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Cari OVO</strong>:&nbsp;<br>Di halaman utama, cari dan pilih menu <a href="1528134850.html"><strong>OVO</strong></a> atau opsi terkait untuk top-up saldo OVO.</li><li><strong>Pilih Nominal Top Up</strong>:&nbsp;<br>Pilih jumlah saldo OVO yang ingin Anda isi. Biasanya, ada berbagai pilihan nominal yang tersedia.</li><li><strong>Masukkan Nomor HP</strong>:&nbsp;<br>Masukkan nomor ponsel yang terdaftar di akun OVO Anda dengan benar.</li><li><strong>Pilih Metode Pembayaran</strong>:&nbsp;<br>Pilih metode pembayaran yang diinginkan, seperti transfer bank, e-wallet lain, atau metode pembayaran lain yang tersedia.</li><li><strong>Konfirmasi Pesanan</strong>:&nbsp;<br>Periksa kembali detail pesanan Anda, termasuk nomor HP dan jumlah top-up. Jika sudah benar, lanjutkan ke pembayaran.</li><li><strong>Selesaikan Pembayaran</strong>:&nbsp;<br>Ikuti instruksi yang diberikan untuk menyelesaikan pembayaran melalui metode yang Anda pilih.</li><li><strong>Proses Top Up</strong>:&nbsp;<br>Setelah pembayaran dikonfirmasi, saldo OVO Anda akan otomatis terisi. Proses ini biasanya cepat dan efisien.</li><li><strong>Cek Saldo</strong>:&nbsp;<br>Pastikan saldo OVO Anda sudah bertambah dengan memeriksa di aplikasi OVO atau melalui notifikasi yang mungkin dikirimkan.</li></ol><p>Dengan mengikuti langkah-langkah ini, Anda dapat dengan mudah mengisi saldo OVO melalui Topupgim.</p><h3>Keuntungan Top Up OVO di Topupgim</h3><p>Berikut adalah beberapa keuntungan top up OVO di Topupgim:</p><ol><li><strong>Harga Lebih Murah</strong>: Topupgim menawarkan harga top up OVO yang lebih kompetitif dibandingkan dengan layanan serupa lainnya, memungkinkan Anda untuk mengisi saldo dengan biaya lebih rendah.</li><li><strong>Proses Cepat dan Mudah</strong>: Transaksi top-up di Topupgim umumnya cepat dan sederhana, dengan antarmuka pengguna yang mudah digunakan.</li><li><strong>Pilihan Pembayaran Beragam</strong>: Topupgim menyediakan berbagai metode pembayaran, seperti transfer bank dan e-wallet lain, memudahkan Anda memilih opsi yang paling nyaman.</li><li><strong>Keamanan Terjamin</strong>: Topupgim memastikan keamanan transaksi dengan sistem perlindungan data dan pembayaran yang aman, memberikan rasa tenang saat melakukan top-up.</li><li><strong>Promo dan Diskon</strong>: Topupgim sering menawarkan promo, diskon, atau cashback yang dapat lebih menguntungkan saat melakukan top up saldo OVO.</li><li><strong>Layanan Pelanggan</strong>: Topupgim biasanya memiliki layanan pelanggan yang responsif dan siap membantu jika Anda mengalami masalah selama proses top-up.</li></ol><p>Dengan keuntungan-keuntungan ini, Topupgim menjadi pilihan yang menarik bagi banyak pengguna yang ingin mengisi saldo OVO dengan hemat dan aman.</p><h3>Metode Pembayaran</h3><p>Berikut adalah opsi metode pembayaran untuk <a href="1528134850.html"><strong>Beli Saldo OVO</strong></a> di TopUpGim:</p><ol><li><strong>E-Wallet (Dompet Digital)</strong>:<br>Anda bisa menggunakan e-wallet populer seperti OVO, GoPay, DANA, dan ShopeePay. Ini memudahkan pembayaran langsung dari ponsel Anda dengan cepat dan praktis.</li><li><strong>Transfer Bank</strong>:<br>Tersedia pilihan transfer bank dari berbagai bank besar di Indonesia, seperti BCA, Mandiri, BNI, dan BRI. Prosesnya mudah dan dapat dilakukan melalui mobile banking, ATM, atau internet banking.</li><li><strong>Virtual Account</strong>:<br>Anda dapat membayar melalui virtual account yang disediakan oleh bank. Ini memungkinkan pembayaran instan tanpa perlu konfirmasi tambahan.</li><li><strong>Minimarket</strong>:<br>Untuk pembayaran tunai, Anda bisa menggunakan layanan di minimarket seperti Indomaret dan Alfamart. Ini cocok bagi Anda yang lebih nyaman membayar langsung di gerai.</li><li><strong>QRIS</strong>:<br>QRIS mempermudah pembayaran melalui kode QR, mendukung berbagai aplikasi pembayaran dalam satu standar.</li></ol><p>Dengan beragam metode ini, Anda dapat memilih yang paling sesuai dengan preferensi dan kenyamanan Anda saat melakukan <a href="1528134850.html"><strong>isi saldo OVO</strong></a> di TopUpGim.</p><h4>Rekomendasi Top Up E-wallet Lainnya</h4><p>Di Topupgim.com, selain OVO, Anda juga bisa melakukan top up untuk berbagai e-wallet populer lainnya. Beberapa e-wallet yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../shopeepay/1528296085.html"><strong>Top Up Shopeepay</strong></a></li><li><a href="../gopay/1528812696.html"><strong>Top Up Gopay</strong></a></li><li><a href="1528134850.html"><strong>Top Up Dana</strong></a></li><li><a href="../linkaja/1528837508.html"><strong>Top Up Linkaja</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="VUrJNHbd-0fvlga1SV3YqSl_yyndV_zjzQe0">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-no_hp">Nomor OVO <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_RU963ZXP" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_RU963ZXP" name="productDenomination" value="RU963ZXP" data-price-preview="11100" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_RU963ZXP">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d1212e98-09f3-4b28-bafd-1100a145d48e.png?w=75" alt="OVO 10.000">
                                                                <span id="productDenominationTitle_RU963ZXP" class="fs-sm fw-semibold">OVO 10.000</span>
                                                                <span class="fs-xs">(Potongan admin Rp 0)</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp11.100</p>
                                                ...
                                                <div id="pDRoot_CQ063WMF" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_CQ063WMF" name="productDenomination" value="CQ063WMF" data-price-preview="16400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_CQ063WMF">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/68d1bacb-1837-4e60-9910-5d38c7b733eb.png?w=75" alt="OVO 15.000">
                                                                <span id="productDenominationTitle_CQ063WMF" class="fs-sm fw-semibold">OVO 15.000</span>
                                                                <span class="fs-xs">(Potongan admin Rp 0)</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp3.000</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_GS989ZHV" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_GS989ZHV" name="productDenomination" value="GS989ZHV" data-price-preview="27000" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_GS989ZHV">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/57296702-9bc1-4de5-868d-893a18f7baaf.png?w=75" alt="OVO 25.000">
                                                                <span id="productDenominationTitle_GS989ZHV" class="fs-sm fw-semibold">OVO 25.000</span>
                                                                <span class="fs-xs">(Potongan admin Rp 0)</span>
                                                ...
                                                <div id="pDRoot_BM846D9L" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_BM846D9L" name="productDenomination" value="BM846D9L" data-price-preview="53400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_BM846D9L">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d6ff26f7-cc7e-4309-9801-b6b20a07d1d6.png?w=75" alt="OVO 50.000">
                                                                <span id="productDenominationTitle_BM846D9L" class="fs-sm fw-semibold">OVO 50.000</span>
                                                                <span class="fs-xs">(Potongan admin Rp 0)</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp53.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp56.200</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp2.800</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_MS024ZCJ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MS024ZCJ" name="productDenomination" value="MS024ZCJ" data-price-preview="106300" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MS024ZCJ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/798963e4-4e07-459e-a736-0e21f6316da9.png?w=75" alt="OVO 100.000">
                                                                <span id="productDenominationTitle_MS024ZCJ" class="fs-sm fw-semibold">OVO 100.000</span>
                                                                <span class="fs-xs">(Potongan admin Rp 0)</span>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fovo%2F1528134850%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/ovo/1528134850?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/ef6fe73e-b8e8-4522-85a9-310e2cfef66d.jpg">
                                        <div class="static-page"><p>Masukkan nomor hp yg terdaftar pada akun ovo kamu</p></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/01cdd085-9486-4d5b-97b3-66993d346901ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">OVO</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Nomor OVO</p>
