...
@section('title', 'Beli Saldo Dana Instan | Top Up Dana Murah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/e21c3eaa-b31e-4877-9ed4-d35a3aeee30b.jpg" alt="Top Up Dana">
                            </div>
                        </div>
                        <!-- END Cover Content -->
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Dana</strong> lebih murah dengan kode promo, Tanpa potongan admin. 10.000 Saldo Dana<strong> hanya Rp10.900.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up Dana di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            ...
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://play.google.com/store/apps/details?id=id.dana&amp;hl=id&amp;gl=US&amp;pli=1" target="_blank">
                                <i class="fab fa-google-play opacity-75 me-1"></i> Play Store
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://apps.apple.com/id/app/dana-dompet-digital-indonesia/id1437123008" target="_blank">
                                <i class="fab fa-app-store-ios opacity-75 me-1"></i> App Store
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://www.dana.id/" target="_blank">
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                ...
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/member-avatars/4ddfa333-f3d5-47a7-b7e5-47b88780af9e04c0.jpg?w=60">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">mutualan</span>
                                        <span class="text-muted fs-sm">Rp. 313.674.000</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">asep</span>
                                        <span class="text-muted fs-sm">Rp. 112.040.500</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">6285236*****2</span>
                                        <span class="text-muted fs-sm">Rp. 54.756.500</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">6282261*****55</span>
                                        <span class="text-muted fs-sm">Rp. 46.265.100</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">yuliana Nengsih</span>
                                        <span class="text-muted fs-sm">Rp. 44.922.800</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>Dana</h2>
                                <div class="static-page w-100"><p>Dana e-wallet adalah dompet digital atau aplikasi pembayaran elektronik yang memungkinkan pengguna untuk melakukan berbagai transaksi keuangan secara digital melalui perangkat mobile. Dana e-wallet digunakan untuk menyimpan uang secara elektronik dan memudahkan transaksi seperti pembayaran di toko-toko fisik maupun online, pengisian pulsa, pembayaran tagihan, hingga transfer uang ke sesama pengguna Dana atau rekening bank.</p><p>Beberapa fitur utama dari Dana e-wallet meliputi:</p><ol><li><strong>Pembayaran</strong>: Dapat digunakan untuk membayar berbagai jenis tagihan seperti listrik, air, telepon, serta belanja di merchant yang bekerja sama dengan Dana.</li><li><strong>Transfer Uang</strong>: Pengguna dapat mengirim uang ke pengguna Dana lainnya atau ke rekening bank tanpa perlu menggunakan ATM atau bank fisik.</li><li><strong>Pengelolaan Keuangan</strong>: Dana juga menawarkan fitur untuk mengelola pengeluaran dan pemasukan secara lebih mudah dan terstruktur.</li><li><strong>Keamanan</strong>: Dana dilengkapi dengan berbagai lapisan keamanan untuk melindungi data dan uang pengguna, seperti verifikasi PIN dan sistem enkripsi.</li></ol><p>Dana e-wallet sangat populer di Indonesia sebagai salah satu solusi pembayaran digital yang cepat, aman, dan praktis dalam mendukung transaksi sehari-hari.</p><h2>Saldo Dana</h2><p>Saldo Dana adalah jumlah uang elektronik yang tersedia di dalam akun Dana e-wallet Anda. Saldo ini dapat digunakan untuk berbagai transaksi, seperti pembayaran belanja, pengisian pulsa, pembayaran tagihan, transfer uang, dan berbagai layanan lainnya yang disediakan oleh Dana.</p><p>Anda bisa menambah saldo Dana melalui berbagai cara, seperti:</p><ol><li><strong>Transfer Bank</strong>: Anda bisa mengisi saldo Dana dengan mentransfer uang dari rekening bank Anda ke akun Dana.</li><li><strong>Kartu Debit/Kredit</strong>: Saldo Dana juga bisa diisi menggunakan kartu debit atau kredit yang sudah terhubung dengan akun Dana Anda.</li><li><strong>Minimarket</strong>: Pengisian saldo Dana juga bisa dilakukan di minimarket yang bekerja sama dengan Dana, seperti Alfamart atau Indomaret.</li><li><strong>Promo atau Cashback</strong>: Anda juga bisa mendapatkan tambahan saldo melalui promo atau cashback dari berbagai transaksi yang dilakukan melalui Dana.</li></ol><p>Saldo Dana ini dapat digunakan sesuai kebutuhan Anda dan jumlahnya akan berkurang setiap kali Anda melakukan transaksi. <a href="{{ route('home') }}"><strong>TopUpGim</strong></a> dikenal sebagai salah satu situs yang menawarkan harga termurah untuk <a href="1528543830.html"><strong>topup saldo Dana</strong></a>. Jika kamu sering melakukan transaksi top-up, situs ini bisa menjadi pilihan yang tepat untuk mendapatkan harga yang lebih terjangkau. Selalu pastikan untuk memeriksa penawaran terbaru mereka untuk mendapatkan harga terbaik.</p><h3>Cara Top Up Saldo Dana Termurah</h3><p>Berikut adalah langkah-langkah umum untuk melakukan top-up saldo Dana melalui situs TopUpGim:</p><ol><li><strong>Kunjungi Situs TopUpGim</strong>:<br>Buka browser dan kunjungi situs <a href="{{ route('home') }}"><strong>web resmi TopUpGim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Pilih Menu Top-Up Dana</strong>:<br>Di halaman utama, cari dan pilih menu <a href="1528543830.html"><strong>Dana</strong></a> atau opsi terkait untuk top-up saldo Dana.</li><li><strong>Masukkan Nomor Dana</strong>:<br>Masukkan nomor telepon yang terdaftar di akun Dana Anda.</li><li><strong>Pilih Nominal Top-Up</strong>:<br>Pilih nominal top-up yang Anda inginkan. Biasanya, terdapat beberapa pilihan nominal seperti Rp10.000, Rp20.000, dan seterusnya.</li><li><strong>Pilih Metode Pembayaran</strong>:<br>Pilih metode pembayaran yang ingin Anda gunakan. TopUpGim biasanya menyediakan beberapa opsi pembayaran seperti transfer bank, e-wallet lain, atau metode pembayaran online lainnya.</li><li><strong>Lakukan Pembayaran</strong>:<br>Ikuti instruksi untuk melakukan pembayaran sesuai dengan metode yang Anda pilih. Pastikan Anda memasukkan detail yang benar sesuai instruksi.</li><li><strong>Konfirmasi Pembayaran</strong>:<br>Setelah melakukan pembayaran, konfirmasi melalui halaman yang disediakan oleh TopUpGim. Biasanya, Anda akan menerima notifikasi atau bukti pembayaran.</li><li><strong>Saldo Dana Terisi</strong>:<br>Setelah pembayaran dikonfirmasi, saldo Dana Anda akan otomatis bertambah sesuai dengan nominal yang Anda top-up.</li></ol><p>Dengan mengikuti langkah-langkah ini, Anda bisa dengan mudah <a href="1528543830.html"><strong>top up Dana</strong></a> di TopUpGim.</p><h3>Keuntungan Top Up Dana di Topupgim</h3><p>TopUpGim menawarkan beberapa keuntungan bagi pengguna yang ingin melakukan top-up saldo Dana melalui platform mereka. Berikut adalah beberapa keuntungan yang bisa Anda dapatkan:</p><ol><li><strong>Kemudahan dan Kecepatan Proses</strong>: TopUpGim menyediakan antarmuka yang sederhana dan mudah digunakan, sehingga proses top-up saldo Dana bisa dilakukan dengan cepat dan tanpa kerumitan.</li><li><strong>Beragam Metode Pembayaran</strong>: TopUpGim biasanya menyediakan berbagai metode pembayaran, mulai dari transfer bank, e-wallet lain, hingga pembayaran online, yang memudahkan pengguna untuk memilih opsi yang paling sesuai.</li><li><strong>Promo dan Diskon</strong>: Salah satu daya tarik utama TopUpGim adalah penawaran promo, diskon, atau cashback untuk top-up saldo Dana. Ini bisa memberikan nilai lebih bagi pengguna, terutama jika ada penawaran khusus yang sedang berlangsung.</li><li><strong>Keamanan Transaksi</strong>: TopUpGim umumnya memiliki sistem keamanan yang baik, sehingga transaksi yang dilakukan terjamin keamanannya. Pastikan Anda selalu menggunakan platform resmi dan melakukan pembayaran melalui saluran yang aman.</li><li><strong>Layanan Pelanggan</strong>: TopUpGim sering kali menyediakan dukungan pelanggan yang siap membantu jika Anda mengalami kendala selama proses top-up. Ini memberikan rasa aman dan kenyamanan tambahan saat bertransaksi.</li><li><strong>Aksesibilitas</strong>: Anda bisa melakukan top-up kapan saja dan di mana saja selama Anda memiliki akses internet, menjadikan TopUpGim sebagai solusi yang praktis untuk menambah saldo Dana.</li></ol><p>Dengan berbagai keuntungan ini, TopUpGim menjadi pilihan yang menarik bagi pengguna yang ingin melakukan top-up saldo Dana dengan cara yang cepat, mudah, dan aman.</p><h3>Metode Pembayaran</h3><p>Berikut adalah opsi metode pembayaran untuk <a href="1528543830.html"><strong>Beli Saldo Dana</strong></a> di TopUpGim:</p><ol><li><strong>E-Wallet (Dompet Digital)</strong>:<br>Anda bisa menggunakan e-wallet populer seperti OVO, GoPay, DANA, dan ShopeePay. Ini memudahkan pembayaran langsung dari ponsel Anda dengan cepat dan praktis.</li><li><strong>Transfer Bank</strong>:<br>Tersedia pilihan transfer bank dari berbagai bank besar di Indonesia, seperti BCA, Mandiri, BNI, dan BRI. Prosesnya mudah dan dapat dilakukan melalui mobile banking, ATM, atau internet banking.</li><li><strong>Virtual Account</strong>:<br>Anda dapat membayar melalui virtual account yang disediakan oleh bank. Ini memungkinkan pembayaran instan tanpa perlu konfirmasi tambahan.</li><li><strong>Minimarket</strong>:<br>Untuk pembayaran tunai, Anda bisa menggunakan layanan di minimarket seperti Indomaret dan Alfamart. Ini cocok bagi Anda yang lebih nyaman membayar langsung di gerai.</li><li><strong>QRIS</strong>:<br>QRIS mempermudah pembayaran melalui kode QR, mendukung berbagai aplikasi pembayaran dalam satu standar.</li></ol><p>Dengan beragam metode ini, Anda dapat memilih yang paling sesuai dengan preferensi dan kenyamanan Anda saat melakukan <a href="1528543830.html"><strong>isi saldo Dana</strong></a> di TopUpGim.</p><h4>Rekomendasi Top Up E-wallet Lainnya</h4><p>Di Topupgim.com, selain Dana, Anda juga bisa melakukan top up untuk berbagai e-wallet populer lainnya. Beberapa e-wallet yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../shopeepay/1528296085.html"><strong>Top Up Shopeepay</strong></a></li><li><a href="../gopay/1528812696.html"><strong>Top Up Gopay</strong></a></li><li><a href="../ovo/1528134850.html"><strong>Top Up OVO</strong></a></li><li><a href="../linkaja/1528837508.html"><strong>Top Up Linkaja</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="oYAVQ9FQ-H5qSkSyumtjn2eY76eKI9HFZ350">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-no_hp">Nomor Dana <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_IH654N1N" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_IH654N1N" name="productDenomination" value="IH654N1N" data-price-preview="10800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_IH654N1N">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/2851cd10-e276-458a-8f70-7325270d6592.png?w=75" alt="10.000">
                                                                <span id="productDenominationTitle_IH654N1N" class="fs-sm fw-semibold">10.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp10.800</p>
                                                ...
                                                <div id="pDRoot_ZR339G6X" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ZR339G6X" name="productDenomination" value="ZR339G6X" data-price-preview="15600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ZR339G6X">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/e6838c81-fd4b-4380-a906-8e0794b49eb8.png?w=75" alt="15.000">
                                                                <span id="productDenominationTitle_ZR339G6X" class="fs-sm fw-semibold">15.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp15.600</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp17.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_MO912T95" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MO912T95" name="productDenomination" value="MO912T95" data-price-preview="21400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MO912T95">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/58835baf-35be-4166-b789-98889ed16671.png?w=75" alt="20.000">
                                                                <span id="productDenominationTitle_MO912T95" class="fs-sm fw-semibold">20.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp21.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp22.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_KL2722A9" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KL2722A9" name="productDenomination" value="KL2722A9" data-price-preview="25900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KL2722A9">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/0c8f2086-f839-4130-a81d-54f055703550.png?w=75" alt="25.000">
                                                                <span id="productDenominationTitle_KL2722A9" class="fs-sm fw-semibold">25.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp25.900</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp27.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp1.100</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_NM971LWI" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_NM971LWI" name="productDenomination" value="NM971LWI" data-price-preview="51900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_NM971LWI">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/086e30fc-a200-4fc7-b884-90b6056593ce.png?w=75" alt="50.000">
                                                                <span id="productDenominationTitle_NM971LWI" class="fs-sm fw-semibold">50.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp51.900</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp53.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_WC100QSA" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_WC100QSA" name="productDenomination" value="WC100QSA" data-price-preview="103100" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_WC100QSA">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/7357fb31-eb27-4665-9bab-d0c1ac886063.png?w=75" alt="100.000">
                                                                <span id="productDenominationTitle_WC100QSA" class="fs-sm fw-semibold">100.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="fs-sm mt-1">Rp103.100</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YX709S7F" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YX709S7F" name="productDenomination" value="YX709S7F" data-price-preview="205600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YX709S7F">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d84b3d19-3938-411b-98e4-3089a5d12839.png?w=75" alt="200.000">
                                                                <span id="productDenominationTitle_YX709S7F" class="fs-sm fw-semibold">200.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="fs-sm mt-1">Rp205.600</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EG4025IQ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EG4025IQ" name="productDenomination" value="EG4025IQ" data-price-preview="506600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EG4025IQ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/5d7fdcad-f870-43da-b9cc-2797bbef49bb.png?w=75" alt="500.000">
                                                                <span id="productDenominationTitle_EG4025IQ" class="fs-sm fw-semibold">500.000</span>
                                                                <span class="fs-xs">Tanpa Potongan Admin</span>
                                                                <p class="fs-sm mt-1">Rp506.600</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <p class="text-muted fs-xs my-1">Nomor ini akan dihubungi apabila ada kendala.</p>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fdana%2F1528543830%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/dana/1528543830?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-how-to-order" tabindex="-1" role="dialog" aria-labelledby="modal-how-to-order" aria-describedby="modal-how-to-order" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="static-page" style="min-height: 380px;"><div style="border-radius:12px;height:0;overflow:hidden;padding-bottom:56.25%;position:relative;"><iframe style="height:100%;left:0;position:absolute;top:0;width:100%;" src="https://www.youtube.com/embed/7_g48wHaA-Y" title="Tutorial Pembelian Tanpa Login" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="">
        </iframe></div></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/28550b75-ee02-4189-aa69-2d03b2ca513febf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Dana</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Nomor Dana</p>
