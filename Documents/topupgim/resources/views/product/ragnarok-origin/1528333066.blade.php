...
@section('title', 'Top Up Ragnarok Origin Murah |  Nyan Berry Ragnarok Origin | Topupgim - TopUpGim')
        ...
        <main id="main-container">
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/74cf9621-ae99-4020-b0a6-a87a065e9026.jpg" alt="Top Up Ragnarok Origin">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1 class="mb-2">Top Up Ragnarok Origin</h1>
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="oJrbr1of-ilWktYXV3quDY4mnXY-C2a4xFlw">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-user_id">Secret Code <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity" id="property-user_id" name="property-user_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Secret Code.." value="" required>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <select data-property-type="options" id="property-zone_id" name="property-zone_id" class="form-select text-body-color" required>
                                                        <option value="1">Prontera-(1~3)</option>
                                                        <option value="4">Prontera-(4~6)</option>
                                                        <option value="7">Prontera-(7~9)</option>
                                                        <option value="10">Prontera-10/Izlude-(1~4)</option>
                                                        <option value="15">Izlude-(5~8)</option>
                                                        <option value="19">Izlude-9(-10)/Morroc-(1~4)</option>
                                                        <option value="25">Morroc-(5~10)</option>
                                                        <option value="31">Geffen-(1~10)/Payon-1</option>
                                                        <option value="42">Payon-(2~10)</option>
                                                        <option value="51">Poring Island-(1~10)/Orc Village-(1~3)</option>
                                                        <option value="64">Orc Village-(4~10)/Shipwreck-1(-2)</option>
                                                        <option value="73">Shipwreck-(3~9)/Memoria/Awakening/Ant Hell-(1~5)</option>
                                                        <option value="87">Ant Hell-(7~10)/Goblin Forest-1(-2)/Valentine/Goblin Forest-4</option>
                                                        <option value="95">Lasagna/1st-Anniversary/Goblin Forest-7</option>
                                                        <option value="98">For Honor</option>
                                                        <option value="99">Sakura Vows</option>
                                                        <option value="100">Goblin Forest-10</option>
                                                        <option value="101">Garden-1</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-nickname">Nickname <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity" id="property-nickname" name="property-nickname" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Nickname.." value="" required>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_QA543KMX" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_QA543KMX" name="productDenomination" value="QA543KMX" data-price-preview="14170" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_QA543KMX">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/f0e7780d-43d4-4c76-93af-0f9d6eb638dd.png?w=75" alt="40 Nyan Berry">
                                                                <span id="productDenominationTitle_QA543KMX" class="fs-sm fw-semibold">40 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp14.170</p>
                                                ...
                                                <div id="pDRoot_YD039N95" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YD039N95" name="productDenomination" value="YD039N95" data-price-preview="41230" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YD039N95">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/e071183b-d357-4226-8c85-06df16069396.png?w=75" alt="125 Nyan Berry">
                                                                <span id="productDenominationTitle_YD039N95" class="fs-sm fw-semibold">125 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp41.230</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_BY9996JU" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_BY9996JU" name="productDenomination" value="BY9996JU" data-price-preview="70440" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_BY9996JU">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/067648d7-f042-4ef9-aec7-854c7bfdbc80.png?w=75" alt="210 Nyan Berry">
                                                                <span id="productDenominationTitle_BY9996JU" class="fs-sm fw-semibold">210 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp70.440</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_EQ980TTH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EQ980TTH" name="productDenomination" value="EQ980TTH" data-price-preview="140230" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EQ980TTH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/02797893-4ef4-494a-9ea1-61755884c01b.png?w=75" alt="430 Nyan Berry">
                                                                <span id="productDenominationTitle_EQ980TTH" class="fs-sm fw-semibold">430 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp140.230</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_XP419PTH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XP419PTH" name="productDenomination" value="XP419PTH" data-price-preview="286620" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XP419PTH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/541ee024-9992-4e26-908b-e1221ce2c999.png?w=75" alt="900 Nyan Berry">
                                                                <span id="productDenominationTitle_XP419PTH" class="fs-sm fw-semibold">900 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp286.620</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_BJ609BYG" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_BJ609BYG" name="productDenomination" value="BJ609BYG" data-price-preview="693720" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_BJ609BYG">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/a2de1950-ed4c-4c47-a8f4-a177b065ca5d.png?w=75" alt="2300 Nyan Berry">
                                                                <span id="productDenominationTitle_BJ609BYG" class="fs-sm fw-semibold">2300 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp693.720</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_CG038EY1" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_CG038EY1" name="productDenomination" value="CG038EY1" data-price-preview="1416380" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_CG038EY1">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/ea56a5a2-4af2-4953-928b-54db654a2673.png?w=75" alt="4800 Nyan Berry">
                                                                <span id="productDenominationTitle_CG038EY1" class="fs-sm fw-semibold">4800 Nyan Berry</span>
                                                                <p class="fs-sm mt-1">Rp1.416.380</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fragnarok-origin%2F1528333066%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/ragnarok-origin/1528333066?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/5a6faa14-c320-413f-8170-260503a47d40.jpg">
                                        <div class="static-page"><p>Untuk menemukan ID Pengguna Anda, masuk ke akun Anda di dalam game dan ketuk Info. Klik pada Kode Rahasia, dan ketuk untuk menyalin Kode Rahasia Anda</p></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/e2e5f91e-cf1b-4ec1-9181-3144e8126c84ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Ragnarok Origin</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Secret Code</p>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Nickname</p>
                                                <p id="purchase-property-nickname-text" class="fs-sm fw-normal h6 mb-0"></p>
                                            </div>
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Metode Pembayaran</p>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions84b7.html?code=1528333066';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/patch-note-08-05-ragnarok-origin-konten-segar-dan-penyesuaian-gameplay-dirilis.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/1687e3e5-1329-490c-8528-2ad1d10582f0.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Patch Note 08/05 Ragnarok Origin: Konten Segar dan Penyesuaian Gameplay Dirilis!
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Jelajahi Knight’s Order Stronghold, nikmati kartu baru, dan siapkan build terbaikmu! Patch terbaru ini hadirkan tantangan dan strategi seru yang sayang untuk dilewatkan.
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/ragnarok-origin-menyelami-dunia-fantasi-midgard-yang-menawan.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/5d7ae46a-8677-4423-8e65-2b2da616a0d1.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Ragnarok Origin: Menyelami Dunia Fantasi Midgard yang Menawan
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Jelajahi dunia fantasi Midgard yang menawan di Ragnarok Origin! Rasakan petualangan seru dengan grafis 3D memukau, sistem kelas beragam, dan interaksi sosial yang mendalam. Siapkan strategimu, bergabunglah dengan guild, dan raih kemenangan!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/strategi-terbaik-menghadapi-mvp-boss-di-ragnarok-origin-panduan-lengkap-untuk-pemain-solo-dan-party.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/d5e0cc44-e213-49a2-9a4d-faa3fd92b42f.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Strategi Terbaik Menghadapi MVP Boss di Ragnarok Origin: Panduan Lengkap untuk Pemain Solo dan Party
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Siap jadi MVP Hunter? 🔥 Yuk, simak strategi jitu buat ngalahin MVP Boss di Ragnarok Origin, baik solo atau bareng party! Dapatkan tips build dan persiapan yang bakal bikin kamu menang mudah. 
                                </p>
                            </div>
                        </a>
                    </div>
