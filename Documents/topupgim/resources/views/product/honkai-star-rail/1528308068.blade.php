...
@section('title', 'Top Up Honkai Star Rail (HSR) Termurah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/a2984406-514f-4593-98b1-9b31e5c79fe4.jpg" alt="Top Up Honkai: Star Rail">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up Honkai Star Rail (HSR)</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Honkai: Star Rail (HSR)</strong> lebih murah dengan kode promo, diskon hingga 39%. Express Supply Pass Honkai: Star Rail<strong> hanya Rp59.200.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up HSR di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            <span class="text-dark fs-sm fw-semibold mb-2 me-3">
                                <i class="fa fa-cart-shopping opacity-75 me-1"></i> Terjual: <span class="text-primary">1.9 rb</span>
                            </span>
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                <h3 class="mb-4">Sultan Honkai: Star Rail</h3>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">M jarss</span>
                                        <span class="text-muted fs-sm">Rp. 188.300</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">6281329*****7</span>
                                        <span class="text-muted fs-sm">Rp. 14.600</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                ...
                                <div class="static-page w-100"><p><strong>Honkai: Star Rail</strong> adalah sebuah game RPG berbasis giliran (turn-based) yang dikembangkan oleh miHoYo, perusahaan yang sama di balik suksesnya game populer seperti Genshin Impact dan Honkai Impact 3rd. Game ini merupakan bagian dari seri Honkai dan menggabungkan elemen-elemen petualangan dengan gameplay RPG klasik yang difokuskan pada eksplorasi dunia, cerita yang mendalam, serta pertempuran strategis.</p><p>Fitur Utama:</p><ul><li><strong>Setting dan Dunia:</strong> Honkai: Star Rail membawa pemain ke dalam sebuah perjalanan melalui alam semesta yang luas, di mana pemain akan menjelajahi berbagai planet dan bertemu dengan berbagai karakter yang memiliki latar belakang dan cerita unik.</li><li><strong>Gameplay:</strong> Berbeda dengan Genshin Impact yang berfokus pada aksi waktu nyata, Honkai: Star Rail menggunakan sistem pertarungan berbasis giliran. Pemain harus memikirkan strategi dan menggunakan kemampuan karakter secara taktis untuk mengalahkan musuh.</li><li><strong>Karakter:</strong> Seperti game miHoYo lainnya, Honkai: Star Rail menampilkan berbagai karakter dengan keahlian, elemen, dan peran yang berbeda dalam tim. Karakter ini bisa diperoleh melalui sistem gacha, yang merupakan mekanisme umum di game-game miHoYo.</li><li><strong>Grafis dan Audio:</strong> Dengan grafis yang indah dan animasi yang halus, Honkai: Star Rail juga didukung oleh soundtrack berkualitas tinggi yang menambah suasana dalam game.</li></ul><p>Alur Cerita:</p><p>Pemain memulai sebagai "Trailblazer," seorang pahlawan yang melakukan perjalanan dengan Star Rail, sebuah kereta antarbintang yang misterius. Alur cerita game ini penuh dengan teka-teki dan konspirasi yang harus dipecahkan, dengan berbagai plot twist yang menarik.</p><p>Honkai: Star Rail mendapatkan perhatian besar sejak perilisannya karena perpaduan unik antara cerita mendalam, gameplay strategis, dan visual yang memukau, menjadikannya salah satu game RPG berbasis giliran yang paling dinantikan.</p><h2>Oneiric Shard Honkai: Star Rail (HSR)</h2><p><strong>Oneiric Shard</strong> adalah mata uang premium dalam game <strong>Honkai: Star Rail</strong> yang digunakan untuk melakukan berbagai transaksi dalam game, terutama yang berkaitan dengan gacha atau "Warps." Warps adalah sistem undian di mana pemain dapat memperoleh karakter atau senjata baru, mirip dengan sistem gacha di game lain seperti Genshin Impact.</p><p>Kegunaan Oneiric Shard:</p><ul><li><strong>Membeli Star Rail Pass atau Star Rail Special Pass:</strong> Ini adalah item yang digunakan untuk melakukan Warps, yaitu cara untuk mendapatkan karakter dan Light Cones (senjata) baru.</li><li><strong>Membeli Mata Uang Lain:</strong> Oneiric Shard dapat ditukar menjadi Stellar Jade, mata uang lain dalam game yang juga bisa digunakan untuk melakukan Warps dan membeli item lainnya.</li><li><strong>Membeli Item Khusus:</strong> Dalam beberapa kasus, Oneiric Shard dapat digunakan untuk membeli item atau paket khusus yang tersedia di toko dalam game.</li></ul><p>Cara Mendapatkan Oneiric Shard:</p><p>Oneiric Shard umumnya didapatkan melalui pembelian dengan uang sungguhan melalui toko dalam game. Karena ini adalah mata uang premium, pemain biasanya harus membayar dengan uang nyata untuk mendapatkannya, yang kemudian dapat digunakan untuk mempercepat kemajuan dalam game atau mendapatkan karakter dan senjata yang lebih kuat.</p><p>Oneiric Shard sering digunakan oleh pemain yang ingin mempercepat progress mereka atau yang ingin mencoba keberuntungan mereka dalam mendapatkan karakter atau senjata tertentu melalui sistem gacha. Website <a href="1528308068.html"><strong>top up Oneiric Shard Honkai: Star Rail</strong></a> termurah adalah Topupgim, platform yang dikenal menawarkan harga paling kompetitif untuk berbagai mata uang dalam game. Dengan Topupgim, pemain dapat memperoleh Oneiric Shard dengan biaya yang lebih rendah dibandingkan dengan situs lain, sehingga mereka bisa lebih banyak berhemat dan memaksimalkan pembelian dalam game mereka.</p><h3>Cara Top Up Oneiric Shard Honkai: Star Rail Termurah</h3><p>Berikut adalah langkah-langkah untuk top up Honkai: Star Rail di Topupgim:</p><ol><li><strong>Kunjungi Situs Topupgim:</strong>&nbsp;<br>Buka browser dan kunjungi situs <a href="{{ route('home') }}"><strong>web resmi TopUpGim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Cari Honkai: Star Rail:</strong>&nbsp;<br>Di halaman utama, cari dan pilih opsi untuk <a href="1528308068.html"><strong>top up Honkai: Star Rail</strong></a>.</li><li><strong>Pilih Paket Oneiric Shard:</strong>&nbsp;<br>Setelah menemukan Honkai: Star Rail, pilih paket Oneiric Shard yang ingin Anda beli. Biasanya ada beberapa pilihan dengan harga dan jumlah shard yang berbeda.</li><li><strong>Masukkan ID Akun:</strong>&nbsp;<br>Masukkan ID akun Honkai: Star Rail Anda atau informasi lain yang diminta untuk memastikan shard dikirim ke akun yang benar.</li><li><strong>Pilih Metode Pembayaran:</strong>&nbsp;<br>Pilih metode pembayaran yang diinginkan. Topupgim biasanya mendukung berbagai metode pembayaran seperti transfer bank, e-wallet, atau kartu kredit.</li><li><strong>Selesaikan Pembayaran:</strong>&nbsp;<br>Ikuti instruksi untuk menyelesaikan pembayaran. Pastikan semua detail sudah benar sebelum konfirmasi pembayaran.</li><li><strong>Tunggu Proses Top Up:</strong>&nbsp;<br>Setelah pembayaran berhasil, tunggu beberapa saat untuk proses top up selesai. Oneiric Shard akan langsung dikreditkan ke akun Honkai: Star Rail Anda.</li><li><strong>Konfirmasi:</strong>&nbsp;<br>Periksa akun game Anda untuk memastikan shard telah masuk. Jika ada masalah, Anda bisa menghubungi layanan pelanggan Topupgim.</li></ol><p>Dengan mengikuti langkah-langkah ini, Anda bisa dengan mudah <a href="1528308068.html"><strong>top up HSR</strong></a> di TopUpGim.</p><h3>Keuntungan Top Up HSR di Topupgim</h3><p>Top up Honkai: Star Rail (HSR) di Topupgim menawarkan beberapa keuntungan, di antaranya:</p><ol><li><strong>Harga Terjangkau:</strong> Topupgim dikenal dengan harga yang lebih murah dibandingkan dengan platform lain, memungkinkan Anda mendapatkan Oneiric Shard dengan biaya lebih rendah.</li><li><strong>Proses Cepat dan Mudah:</strong> Topupgim menyediakan proses transaksi yang cepat dan user-friendly, sehingga memudahkan pengguna dalam melakukan top up tanpa kerumitan.</li><li><strong>Berbagai Metode Pembayaran:</strong> Topupgim mendukung berbagai metode pembayaran, termasuk e-wallet, transfer bank, dan kartu kredit, memberikan fleksibilitas bagi pengguna.</li><li><strong>Layanan Pelanggan Responsif:</strong> Jika Anda menghadapi masalah, layanan pelanggan Topupgim siap membantu dengan respons cepat untuk memastikan pengalaman berbelanja yang baik.</li><li><strong>Keamanan Transaksi:</strong> Topupgim menjaga keamanan informasi dan transaksi Anda, memberikan rasa aman dalam setiap pembelian yang Anda lakukan.</li></ol><p>Dengan berbagai keuntungan ini, Topupgim menjadi pilihan yang menarik bagi pemain Honkai: Star Rail untuk melakukan top up secara efisien dan hemat.</p><h3>Metode Pembayaran</h3><p>Topupgim menyediakan berbagai metode pembayaran untuk top up Honkai: Star Rail (HSR), sehingga memudahkan pengguna untuk memilih metode yang paling nyaman bagi mereka. Beberapa metode pembayaran yang biasanya tersedia di Topupgim adalah:</p><ol><li><strong>Transfer Bank:</strong><br>Anda dapat melakukan pembayaran melalui transfer bank dari berbagai bank lokal. Instruksi transfer biasanya diberikan setelah Anda memilih metode ini.</li><li><strong>E-Wallet:</strong><br>Topupgim mendukung pembayaran melalui berbagai e-wallet populer seperti GoPay, OVO, dan Dana. Metode ini biasanya sangat cepat dan mudah digunakan.</li><li><strong>Kartu Kredit/Debit:</strong><br>Pembayaran dapat dilakukan dengan menggunakan kartu kredit atau debit Visa atau Mastercard, memberikan opsi pembayaran yang lebih luas.</li><li><strong>QRIS:</strong><br>Topupgim seringkali menyediakan opsi pembayaran melalui QRIS, yang memungkinkan pengguna untuk membayar dengan memindai kode QR menggunakan berbagai aplikasi pembayaran yang mendukung QRIS.</li><li><strong>Pulsa Seluler:</strong><br>Beberapa operator seluler mungkin juga didukung untuk pembayaran menggunakan pulsa, meskipun ini bisa lebih mahal dibandingkan metode lainnya.</li><li><strong>Virtual Account:</strong><br>Anda bisa membayar menggunakan virtual account dari berbagai bank, di mana nomor virtual account diberikan dan pembayaran dapat dilakukan secara instan.</li></ol><p>Dengan berbagai metode pembayaran ini, Topupgim memudahkan pengguna untuk memilih opsi yang paling sesuai dengan preferensi mereka saat melakukan top up Honkai: Star Rail.</p><h4>Rekomendasi Top Up Game Lainnya</h4><p>Di Topupgim.com, selain Honkai: Star Rail (HSR), Anda juga bisa melakukan top up untuk berbagai game populer lainnya. Beberapa game yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../mobile-legends/1528378309.html"><strong>Top Up Mobile Legends&nbsp;</strong></a></li><li><a href="../pubgm/1528036161.html"><strong>Top Up PUBG Mobile&nbsp;</strong></a></li><li><a href="../call-of-duty-mobile/1528919312.html"><strong>Top Up Call of Duty Mobile (CODM)&nbsp;</strong></a></li><li><a href="../honor-of-kings/1528385129.html"><strong>Top Up Honor of Kings&nbsp;</strong></a></li><li><a href="../zepeto/1528847900.html"><strong>Top Up Zepeto</strong></a></li><li><a href="../hago/1528242362.html"><strong>Top Up Hago&nbsp;</strong></a></li><li><a href="../dana/1528543830.html"><strong>Top Up Dana</strong></a></li><li><a href="../blood-strike/1528112021.html"><strong>Top Up Blood Strike&nbsp;</strong></a></li><li><a href="../genshin-impact/1528787297.html"><strong>Top Up Genshin Impact</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="BUi6xUqh-o2p_SShAWAqCcRlYnOp0_cKQmf4">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            ...
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-zone_id">Zone ID <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_YR2186OW" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YR2186OW" name="productDenomination" value="YR2186OW" data-price-preview="14600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YR2186OW">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/878d65c9-b22a-4fd1-a6f9-ae31cd06ae26.png?w=75" alt="60 Oneiric Shard">
                                                                <span id="productDenominationTitle_YR2186OW" class="fs-sm fw-semibold">60 Oneiric Shard</span>
                                                ...
                                                <div id="pDRoot_RA855Z8B" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_RA855Z8B" name="productDenomination" value="RA855Z8B" data-price-preview="62000" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_RA855Z8B">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/d9e1c2da-d160-4393-85eb-9845f734126b.png?w=75" alt="330 Oneiric Shard">
                                                                <span id="productDenominationTitle_RA855Z8B" class="fs-sm fw-semibold">330 Oneiric Shard</span>
                                                                <span class="fs-xs">300 + 30 Bonus</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp62.000</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp79.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp17.000</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YE463BJ4" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YE463BJ4" name="productDenomination" value="YE463BJ4" data-price-preview="186500" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YE463BJ4">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/3e1d74e9-a678-4fbd-8819-31b0da37a00c.png?w=75" alt="1090 Oneiric Shard">
                                                                <span id="productDenominationTitle_YE463BJ4" class="fs-sm fw-semibold">1090 Oneiric Shard</span>
                                                                <span class="fs-xs">980 + 110 Bonus</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp186.500</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp249.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp62.500</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_MW821NVP" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MW821NVP" name="productDenomination" value="MW821NVP" data-price-preview="402900" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MW821NVP">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/8c74aefb-d577-4659-8f24-712338e860c1.png?w=75" alt="2240 Oneiric Shard">
                                                                <span id="productDenominationTitle_MW821NVP" class="fs-sm fw-semibold">2240 Oneiric Shard</span>
                                                                <span class="fs-xs">1980 + 260 Bonus</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp402.900</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp479.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp76.100</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_BE390160" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_BE390160" name="productDenomination" value="BE390160" data-price-preview="634500" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_BE390160">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/5355b71b-2c12-4dcd-a48f-c426dda66227.png?w=75" alt="3380 Oneiric Shard">
                                                                <span id="productDenominationTitle_BE390160" class="fs-sm fw-semibold">3380 Oneiric Shard</span>
                                                                <span class="fs-xs">3280 + 600 Bonus</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp634.500</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp799.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp164.500</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fhonkai-star-rail%2F1528308068%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/honkai-star-rail/1528308068?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/ef2eb27b-ce7a-437f-85a2-185812fd4fa3.jpg">
                                        <div class="static-page"><p>Untuk menemukan UID Anda, masuk ke akun di aplikasi Anda. UID selalu berada di pojok kiri bawah layar. UID juga dapat ditemukan di Phone Menu.</p></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/75cd6755-3eae-43ce-986a-0aeee6e522c5ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Honkai: Star Rail</span>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotionse315.html?code=1528308068';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/build-tribbie-honkai-star-rail-sub-dps-super-kuat-dengan-peran-support.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/c7770dc5-9452-4790-99fa-4c195b94d033.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Build Tribbie Honkai: Star Rail – Sub-DPS Super Kuat dengan Peran Support
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Maksimalkan potensi Tribbie di Honkai: Star Rail! Temukan build sub-DPS terbaik sekaligus peran support yang solid untuk tim kamu. Strategi, senjata, relik, hingga kombinasi tim, semua dibahas lengkap di sini!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/yae-sakura-dikabarkan-muncul-di-anniversary-honkai-star-rail-tahun-depan-benarkah.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/4542ea19-9de5-4487-8225-ef02332697f5.jpeg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                ...
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Rumor Yae Sakura Hadir di Anniversary Honkai: Star Rail Tahun Depan! Siap-siap gacha karakter legendaris yang paling dinanti para pemain. Temukan info lengkap, bocoran, dan strategi di artikel terbaru kami.
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/honkai-star-rail-3-5-rilis-13-agustus-kisah-baru-sebelum-kematian-para-pahlawan-siap-menguras-emosi.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/a8a76d60-6d78-4e05-80c1-09bde08d8eeb.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Honkai: Star Rail 3.5 Rilis 13 Agustus – Kisah Baru “Sebelum Kematian Para Pahlawan” Siap Menguras Emosi
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Jelajahi kisah emosional “Sebelum Kematian Para Pahlawan”, karakter baru Verina &amp; Xueyi, hingga fitur-fitur gameplay yang lebih seru dan imersif. Yuk, siapin tim terbaikmu sekarang juga!
                                </p>
                            </div>
                        </a>
                    </div>
