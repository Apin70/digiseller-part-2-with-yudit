...
@section('title', 'Top Up PUBGM Termurah | Beli UC PUBG Mobile | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/dd52673c-cead-4da1-aa9d-c01dd993f0f4.jpg" alt="Top Up PUBGM Global">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up PUBGM (Global)</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up PUBG Mobile</strong> lebih murah dengan kode promo, diskon hingga 39%. Beli 80 UC PUBGM hanya Rp13.800 di <strong>TopUpGim.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up PUBGM di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                <h3 class="mb-4">Sultan PUBGM Global</h3>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        ...
                                        <span class="text-muted fs-sm">Rp. 71.351.200</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">ansy surawan</span>
                                        <span class="text-muted fs-sm">Rp. 25.893.030</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">6289909*****</span>
                                        <span class="text-muted fs-sm">Rp. 7.751.970</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Julhandri Lubis</span>
                                        <span class="text-muted fs-sm">Rp. 6.207.200</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Irza</span>
                                        <span class="text-muted fs-sm">Rp. 5.880.510</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>Top Up PUBGM Global Termurah Agustus 2024 di Topupgim</h2>
                                <div class="static-page w-100"><div class="raw-html-embed"><h3 style=" margin-bottom: 5px;"><span style="font-size:14px;">Top Up PUBGM Global Murah di Topupgim</span></h3>
<p style="text-align:justify;line-height: 16px;font-size: 13px;">Kamu pernah merasa membeli <a href="1528036161.html">UC PUBGM Globals</a> langsung di dalam game kemahalan? Jangan khawatir, karena solusi top up PUBGM Globals termurah bisa kamu beli di Topupgim. Harga lebih murah dan jumlah PUBGM Global UC yang kamu dapatkan lebih banyak. Makin lebih hemat dan irit tanpa harus keluar uang banyak. Melalui Topupgim, kamu bisa membeli UC PUBGM Globals dengan mudah hanya dengan beberapa kali klik di layar ponselmu. Tidak perlu ribet mendaftarkan akun dan login, cukup masukkan ID Game dan nomor Whatsapp dan bayar melalui online dengan berbagai metode pembayaran yang mudah. <a href="1528036161.html">Top Up UC PUBGM Global</a> dengan berbagai pilihan jumlah PUBGM Global UC yang kamu mau, mulai dari 10 UC hingga 2000 UC. Selain itu, jangan lewatkan juga promo dan potongan harga hingga 61.200 dan diskon spesial hingga 30%!</p>
<h2 style=" margin-bottom: 5px;"><span style="font-size:18px;">PUBGM Global</span></h2>
<h3 style=" margin-bottom: 0;"><span style="font-size:14px;">Apa itu PUBGM Global?</span></h3>
<p style="text-align:justify;line-height: 16px;font-size: 13px;">PUBGM Global merujuk pada versi global dari permainan mobile populer, PlayerUnknown's Battlegrounds Mobile (PUBG Mobile). Ini adalah versi dari permainan PUBG yang dirancang untuk dimainkan di perangkat seluler. PUBG Mobile Global mencakup pemain dari berbagai belahan dunia dan memungkinkan mereka untuk berkompetisi dalam pertempuran royale yang intens di berbagai peta dan mode permainan.</p>
<h3 style=" margin-bottom: 0;"><span style="font-size:14px;">Apa itu UC di PUBGM Global?</span></h3>
<p style="text-align:justify;line-height: 16px;font-size: 13px;"><span style="">UC (Unknown Cash) adalah mata uang virtual di PUBG Mobile Global. UC digunakan sebagai alat pembayaran di dalam permainan untuk membeli berbagai item kosmetik, senjata, dan peningkatan lainnya. Untuk mendapatkan UC PUBGM Global dengan harga termurah, kamu dapat membelinya di </span><a href="1528036161.html"><strong>Topupgim</strong></a><span style="">. Pemain dapat memperoleh UC dengan melakukan pembelian menggunakan uang sungguhan atau melalui hadiah dan misi di dalam permainan. UC memungkinkan pemain untuk meningkatkan pengalaman dan penampilan avatar mereka dalam PUBG Mobile Global.</span></p><h3 style=" margin-bottom: 0;"><span style="font-size:14px;">Cara Top Up UC PUBGM Global Murah di Topupgim</span>
</h3><p style="text-align:justify;line-height: 16px;font-size: 13px;">Top Up PUBGM Global Murah di Topupgim harga lebih hemat karena ada kode promo dan diskon yang bisa kamu dapatkan. Kode promo bisa kamu gunakan untuk top up PUBGM Globals di Topupgim. Segera beli UC PUBGM Globals sekarang dan tampil lebih keren dengan barang virtual favorit kamu! Caranya cukup sederhana: masukkan ID akun Anda dan pilih PUBGM Global UC yang Anda butuhkan. Setelah pembayaran diterima, UC akan segera masuk ke perangkat Anda dalam waktu singkat secara otomatis. <a href="1528036161.html"><span style="font-size:12px;">Top Up PUBGM Globals</span></a> di Topupgim dapat dilakukan kapan saja dan di mana saja melalui berbagai perangkat, termasuk ponsel, smartphone, tablet, PC, atau laptop, baik di kantor maupun di rumah. Anda dapat mengakses layanan ini melalui website resmi Topupgim.com atau melalui aplikasi yang tersedia di Google Play Store untuk perangkat Android dan Apple App Store untuk perangkat iOS. Dengan kemudahan ini, Anda dapat mengisi ulang UC PUBGM Global dengan cepat dan praktis sesuai kebutuhan Anda.</p><h3 style=" margin-bottom: 0;"><span style="font-size:14px;">Metode Pembayaran</span></h3>
<p style="text-align:justify;line-height: 16px;"><span style="font-size: 13px;">Untuk dapat membeli UC PUBGM Globals di Topupgim, Anda bisa membayarkan dengan e-wallet &amp; bank dibawah:</span></p><ol style=" font-size: 13px;"><li style="text-align:justify;">Top Up PUBGM Global murah dengan <strong>Dana</strong>.</li><li style="text-align:justify;">Top Up PUBGM Globals termurah dengan <strong>Gopay</strong>.</li><li style="text-align:justify;">Beli UC PUBGM Globals dengan <strong>OVO</strong>.</li><li style="text-align:justify;">Codashop PUBGM Global bayar dengan <strong>pulsa</strong>.</li><li style="text-align:justify;">Unipin PUBGM Global bayar dengan <strong>Unpin Credit</strong>.</li></ol><p style="text-align:justify;line-height: 16px;font-size: 13px;">Selain menjual UC PUBGM Globals dengan harga termurah, Topupgim juga melayani <a href="../free-fire/1528555434.html">Top Up Free Fire (FF)</a>, <a href="../higgs-domino/1528535869.html">Top Up Higgs Domino (Koin Resmi)</a>, <a href="../genshin-impact/1528787297.html">Top Up Genshin Impact</a>, <a href="../honkai-star-rail/1528308068.html">Top Up Honkai: Star Rail</a>,  <a href="../genshin-impact/1528787297.html">Top Up Genshin Impact</a>, <a href="../honkai-star-rail/1528308068.html">Top Up Honkai: Star Rail</a>, <a href="../hago/1528242362.html">Top Up Hago</a>, <a href="../valorant/1528917260.html">Top Up Valorant</a>, <a href="1528036161.html">Top Up PUBGM</a> dan ratusan game lainnya. Ditambah dengan aneka voucher online seperti <a href="../steam-wallet-voucher/1528569704.html">Voucher Steam Wallet</a>, <a href="../google-play-voucher/1528865191.html">Voucher Google Play</a>, <a href="../garena-shell-voucher/1528870395.html">Voucher Garena Shell</a>, <a href="../playstation-voucher/1528471870.html">Voucher Playstation</a>, <a href="../roblox-voucher/1528697287.html">Voucher Roblox</a>, dan <a href="../unipin-voucher/1528210846.html">Voucher Unipin</a>.</p><p style="text-align:justify;line-height: 16px;font-size: 13px;">Sekarang, top up UC PUBGM Globals tidak perlu mahal lagi. Dengan <a href="1528036161.html">Topupgim PUBGM Globals</a>, Anda dapat membeli UC PUBGM Global dengan cepat, mudah, dan praktis. Jadi, Anda tidak perlu lagi repot-repot mencari harga termurah karena Topupgim adalah tempatnya. Semua kemudahan ini ada di genggaman Anda. Jadi, segera mulai top up UC PUBGM Globals dengan santai dan praktis secara online melalui Topupgim!</p></div></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="uJs9WoQA-30DioyJXfdkjrTQrn5PFGjPNgIs">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity_alphanumeric" id="property-user_id" name="property-user_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan User ID.." value="" data-rule-isAlphanumeric="true" required>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_XV9302O2" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XV9302O2" name="productDenomination" value="XV9302O2" data-price-preview="406970" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XV9302O2">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/bf81edea-2689-4ebb-8649-4bf839ca724a.png?w=75" alt="1800 UC">
                                                                <span id="productDenominationTitle_XV9302O2" class="fs-sm fw-semibold">1800 UC</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp406.970</p>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp43.030</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_ST400W1V" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_ST400W1V" name="productDenomination" value="ST400W1V" data-price-preview="812500" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_ST400W1V">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/bd463828-adaa-4c2b-984d-5a17a9bd7f1e.png?w=75" alt="3850 UC">
                                                                <span id="productDenominationTitle_ST400W1V" class="fs-sm fw-semibold">3850 UC</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp812.500</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp950.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp137.500</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_YE179ZOJ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_YE179ZOJ" name="productDenomination" value="YE179ZOJ" data-price-preview="1623760" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_YE179ZOJ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/0710d972-cb58-4ceb-a03d-b0882b81948e.png?w=75" alt="8100 UC">
                                                                <span id="productDenominationTitle_YE179ZOJ" class="fs-sm fw-semibold">8100 UC</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp1.623.760</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.700.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp76.240</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpubgm%2F1528036161%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/pubgm/1528036161?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/9aa3e427-7931-418c-88db-bb197ba5c6d7.jpg">
                                        <div class="static-page"><p>Bagaimana cara menemukan ID Pemain PUBG Mobile?</p><ol><li>Gunakan akun anda untuk masuk ke dalam game.</li><li>Buka profil pemain anda.</li><li>ID Pemain PUBG Mobile anda akan ditampilkan.</li></ol></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/7c8630ec-8447-45f0-85b6-5ae6a860460debf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">PUBGM Global</span>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions69f4.html?code=1528036161';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/pubg-mobile-gandeng-sonic-set-karakter-kendaraan-kolaborasi-kini-tersedia.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/a82dbbed-bd44-4fff-aea2-8a797f2798da.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    PUBG MOBILE Gandeng Sonic! Set Karakter &amp; Kendaraan Kolaborasi Kini Tersedia
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Kolaborasi terbaru PUBG MOBILE x Sonic the Hedgehog resmi hadir! Nikmati set karakter, kendaraan, dan skin eksklusif bertema Sonic yang cuma tersedia dalam waktu terbatas. Jangan sampai ketinggalan keseruannya sekarang juga!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/pubg-mobile-versi-4-0-rilis-event-horor-tricks-treats-dan-terror-siap-uji-nyali.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/1879d1bc-8f06-4710-96c7-0de4fddea6b4.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    PUBG MOBILE Versi 4.0 Rilis! Event Horor Tricks, Treats, dan Terror Siap Uji Nyali
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    PUBG MOBILE 4.0 hadir dengan nuansa horor intens! Rasakan pengalaman baru lewat mode Ghosts and Ghouls, skin eksklusif menyeramkan, dan map penuh misteri. Cek fitur lengkapnya &amp; ikuti event berhadiah spesial sekarang juga!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/pubg-x-kaiju-no-8-kolaborasi-serius-atau-sekedar-rumor-simak-faktanya.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/5ae56149-342e-44e5-8282-c0d479d110b3.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    PUBG x Kaiju No. 8: Kolaborasi Serius atau Sekedar Rumor? Simak Faktanya!
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Rumor kolaborasi PUBG Mobile x Kaiju No. 8 bikin heboh komunitas gamer dan penggemar anime! Apakah ini sekedar spekulasi atau akan jadi kenyataan? Simak semua faktanya dan persiapkan diri kamu untuk event kolaborasi paling epik tahun ini!
                                </p>
                            </div>
                        </a>
                    </div>
