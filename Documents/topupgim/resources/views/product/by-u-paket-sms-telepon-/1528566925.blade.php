...
@section('title', 'Paket SMS &amp; Telepon by.U Murah - Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/8671d707-71e6-4a5e-97d8-fbee29dbbe5f.jpg" alt="Top Up by.U (Paket SMS &amp; Telepon)">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>by.U (SMS &amp; Telepon)</h1>
                        <div class="static-page-product-desc mb-4"><p>Isi paket SMS &amp; Telepon by.U caranya mudah:</p><p>1. Masukkan nomor by.U kamu.<br>2. Pilih paket yang kamu mau.<br>3. Pilih metode pembayaran.<br>4. Masukkan nomor Whatsapp kamu, nantinya kami akan mengirim invoice ke Whatsapp.<br>5. Klik tombol Beli Sekarang.</p></div>
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="Q0ha1g09-X9whUSJ8-p3kDLi3jqtDPCup45M">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1">
                                                ...
                                                <div class="col-4 col-md-3 px-2 mb-3">
                                                    <div class="position-relative h-100">
                                                        <div class="form-check form-block highlight h-100">
                                                            <input type="radio" class="form-check-input" data-first-open="false" id="cDenom_53" name="cDenom" value="cDenom_53">
                                                            <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="cDenom_53">
                                                                <div class="d-flex flex-column text-center justify-content-center align-items-center h-100">
                                                                    <span id="cDenom_53" class="fs-xs fw-semibold">Umum</span>
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_JU8199K6" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JU8199K6" name="productDenomination" value="JU8199K6" data-price-preview="8600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JU8199K6">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/1ce5837e-e207-475b-af52-00f4da53fcc9.png?w=75" alt="Telepon Semua Operator 50 Menit 1 Hari">
                                                                <span id="productDenominationTitle_JU8199K6" class="fs-sm fw-semibold">Telepon Semua Operator 50 Menit 1 Hari</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp8.600</p>
                                                ...
                                                <div id="pDRoot_AB215JB2" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_AB215JB2" name="productDenomination" value="AB215JB2" data-price-preview="10800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_AB215JB2">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/3892779c-601d-4ef4-9017-42e100e7bd4a.png?w=75" alt="Telepon Semua Operator 100 Menit 3 Hari">
                                                                <span id="productDenominationTitle_AB215JB2" class="fs-sm fw-semibold">Telepon Semua Operator 100 Menit 3 Hari</span>
                                                ...
                                                <div id="pDRoot_EE064TGT" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_EE064TGT" name="productDenomination" value="EE064TGT" data-price-preview="13100" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_EE064TGT">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/7d8f0c7a-f2cf-4ec4-b98f-e11362167b64.png?w=75" alt="Telepon Semua Operator 150 Menit 7 Hari">
                                                                <span id="productDenominationTitle_EE064TGT" class="fs-sm fw-semibold">Telepon Semua Operator 150 Menit 7 Hari</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp13.100</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp16.200</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_XW416EJX" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XW416EJX" name="productDenomination" value="XW416EJX" data-price-preview="53200" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XW416EJX">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/71931e6a-3009-4b64-a812-578530580397.png?w=75" alt="Telepon Semua Operator 300 Menit 30 Hari">
                                                                <span id="productDenominationTitle_XW416EJX" class="fs-sm fw-semibold">Telepon Semua Operator 300 Menit 30 Hari</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp53.200</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp55.900</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fby-u-paket-sms-telepon-%2F1528566925%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/by-u-paket-sms-telepon-/1528566925?aff=Internal_Share</p>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/e014aaa4-697e-4946-98da-97557692fdc2ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">by.U (Paket SMS &amp; Telepon)</span>
