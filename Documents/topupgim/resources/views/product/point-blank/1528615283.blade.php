...
@section('title', 'Beli Cash Point Blank | Top Up PB Murah | Topupgim - TopUpGim')
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/9a161134-44ae-43f9-a4fd-a7821d3bfcaf.jpg" alt="Top Up Point Blank">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1>Top Up Point Blank (PB)</h1>
                        ...
                        <div class="static-page-product-desc mb-4"><p><strong>Top Up Point Blank (PB)</strong> lebih murah dengan kode promo, diskon hingga 39%. 1200 Cash Point Blank<strong> hanya Rp10.100.&nbsp;</strong></p><div class="raw-html-embed"><h2 style="font-size: 16px;">Top Up PB di Topupgim</h2>
<ul class="list_alasan" style="list-style: none; padding-left: 0;font-size:13px"><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px; box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Lebih Murah</strong>. Hemat hingga 39% &amp; tanpa biaya admin 🔥</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px;border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Mudah &amp; Otomatis.</strong> Tidak perlu kirim bukti pembayaran.</li><li style="background: #fff;padding: 5px 8px;margin-bottom: 5px; border-radius: 5px;box-shadow: 0 1px 3px rgba(214,221,237,.5), 0 1px 2px rgba(214,221,237,.5);"><strong>Tanpa Delay</strong>. Pengiriman hanya hitungan detik.</li></ul></div></div>
                        <div class="d-flex flex-row flex-wrap align-items-center gy-1">
                            <span class="text-dark fs-sm fw-semibold mb-2 me-3">
                                <i class="fa fa-cart-shopping opacity-75 me-1"></i> Terjual: <span class="text-primary">6 rb</span>
                            </span>
                            ...
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://www.pointblank.id/" target="_blank">
                                <i class="fa fa-globe opacity-75 me-1"></i> Website
                            </a>
                            <a class="text-muted fs-sm fw-semibold mb-2 me-3" href="https://www.facebook.com/PBIndonesiaZepetto/" target="_blank">
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                <h3 class="mb-4">Sultan Point Blank</h3>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        ...
                                        <span class="text-muted fs-sm">Rp. 8.447.300</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Roby Ika Mustafa</span>
                                        <span class="text-muted fs-sm">Rp. 1.082.300</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">aldo marcellino</span>
                                        <span class="text-muted fs-sm">Rp. 506.500</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    <span class="fw-semibold me-3">4</span>
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="https://lh3.googleusercontent.com/a/ACg8ocKsEYUSAkAmWy_tHAxtn1pqDLYfCHDNSeFM9TDLrTgK8oY36A=s96-c">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">risap aja08</span>
                                        <span class="text-muted fs-sm">Rp. 456.400</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    <span class="fw-semibold me-3">5</span>
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/member-avatars/1485e7f8-fb1e-4037-afbd-5f05a2a9856304c0.jpg?w=60">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Alfitra ramadani arifin</span>
                                        <span class="text-muted fs-sm">Rp. 343.600</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>Point Blank</h2>
                                <div class="static-page w-100"><p>Game <strong>Point Blank</strong> adalah sebuah permainan video <strong>first-person shooter (FPS)</strong> yang dikembangkan oleh <strong>Zepetto</strong>, sebuah perusahaan asal Korea Selatan. Game ini pertama kali dirilis pada tahun 2008 dan telah menjadi salah satu game FPS populer di beberapa negara, termasuk Indonesia.</p><p><strong>Point Blank</strong> dimainkan secara daring (online) dan memiliki beberapa mode permainan, seperti:</p><ol><li><strong>Deathmatch</strong>: Mode di mana pemain saling bertarung untuk mencapai jumlah pembunuhan tertentu atau untuk menjadi tim dengan skor tertinggi dalam waktu yang ditentukan.</li><li><strong>Bomb Mission</strong>: Dalam mode ini, satu tim bertugas untuk menanam bom di lokasi tertentu sementara tim lainnya harus mencegah atau menjinakkan bom tersebut.</li><li><strong>Destroy Mission</strong>: Pemain diharuskan untuk menghancurkan objek tertentu di peta, dengan satu tim bertugas menyerang dan tim lainnya bertahan.</li><li><strong>AI Mission</strong>: Mode di mana pemain melawan karakter yang dikendalikan oleh komputer (AI).</li><li><strong>Clan War</strong>: Mode di mana tim atau klan bertarung satu sama lain dalam pertempuran antar tim.</li></ol><p>Game ini memiliki berbagai jenis senjata dan perlengkapan yang bisa dipilih dan dikustomisasi oleh pemain, termasuk senapan, pistol, granat, dan peralatan lainnya. Pemain dapat meningkatkan peringkat mereka berdasarkan performa dalam permainan, dan banyak yang bergabung dalam klan untuk bermain secara tim.</p><p>Point Blank juga dikenal dengan komunitasnya yang besar, turnamen yang diadakan secara rutin, dan berbagai fitur lainnya yang membuatnya tetap populer selama bertahun-tahun.</p><h2>Cash Point Blank (PB)</h2><p><strong>Cash Point Blank (Cash PB)</strong> adalah mata uang premium yang digunakan dalam game <strong>Point Blank</strong>. Cash PB digunakan oleh pemain untuk membeli berbagai item eksklusif, seperti senjata khusus, perlengkapan, kostum, karakter, dan aksesoris lainnya yang tidak dapat dibeli menggunakan mata uang biasa dalam game (Points atau GP).</p><p>Berikut adalah beberapa hal yang bisa dibeli dengan Cash PB:</p><ol><li><strong>Senjata Premium</strong>: Senjata dengan statistik yang lebih baik atau dengan desain khusus yang hanya bisa didapatkan dengan menggunakan Cash PB.</li><li><strong>Kostum dan Aksesoris</strong>: Item kosmetik yang mengubah penampilan karakter pemain, sering kali juga memberikan bonus tambahan.</li><li><strong>Karakter Khusus</strong>: Beberapa karakter dalam game yang memiliki kemampuan unik atau penampilan berbeda yang hanya bisa dibeli dengan Cash PB.</li><li><strong>Item Perlengkapan</strong>: Seperti pelindung tubuh, helm, dan item lainnya yang memberikan keuntungan tambahan selama permainan.</li></ol><p>Pemain biasanya dapat memperoleh Cash PB melalui pembelian menggunakan uang asli, yang bisa dilakukan melalui berbagai metode pembayaran seperti kartu kredit, transfer bank, atau melalui voucher game yang tersedia di toko-toko. Penggunaan Cash PB sering kali memberikan keunggulan kompetitif dalam game, meskipun banyak item yang bisa dibeli dengan GP (mata uang gratis dalam game), item yang dibeli dengan Cash PB biasanya menawarkan lebih banyak fitur atau keunggulan. Website <a href="1528615283.html"><strong>top up cash Point Blank</strong></a> termurah adalah <a href="{{ route('home') }}"><strong>Topupgim</strong></a>. Situs ini dikenal sebagai salah satu tempat terbaik untuk membeli Cash Point Blank dengan harga yang kompetitif dan sering kali menawarkan promo atau diskon khusus bagi para pemain. Topupgim menyediakan berbagai metode pembayaran yang memudahkan pengguna dalam melakukan transaksi, dan reputasinya yang baik di kalangan pemain Point Blank menjadikannya pilihan populer bagi mereka yang ingin menambah saldo Cash PB dengan cepat dan aman.</p><h3>Cara Top Up Cash Point Blank Termurah</h3><p>Untuk melakukan top up Cash Point Blank di Topupgim, ikuti langkah-langkah berikut:</p><ol><li><strong>Buka Situs Topupgim</strong>:&nbsp;<br>Buka browser dan kunjungi situs <a href="{{ route('home') }}"><strong>web resmi TopUpGim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Pilih Game Point Blank</strong>:&nbsp;<br>Di halaman utama, cari dan pilih opsi untuk <a href="1528615283.html"><strong>top up Point Blank (PB)</strong></a>.</li><li><strong>Pilih Nominal Top Up</strong>:&nbsp;<br>Setelah memilih Point Blank, Anda akan melihat berbagai pilihan nominal Cash PB yang dapat dibeli. Pilih jumlah Cash yang ingin Anda top up.</li><li><strong>Masukkan ID atau Nickname</strong>:&nbsp;<br>Masukkan ID akun atau nickname Point Blank Anda dengan benar. Pastikan informasi ini akurat untuk menghindari kesalahan pengiriman.</li><li><strong>Pilih Metode Pembayaran</strong>:&nbsp;<br>Topupgim menyediakan berbagai metode pembayaran seperti transfer bank, e-wallet, atau pembayaran melalui pulsa. Pilih metode yang paling sesuai dengan kebutuhan Anda.</li><li><strong>Konfirmasi dan Lakukan Pembayaran</strong>:&nbsp;<br>Setelah memilih metode pembayaran, ikuti instruksi yang diberikan untuk menyelesaikan pembayaran. Pastikan Anda mengikuti setiap langkah dengan benar.</li><li><strong>Tunggu Proses Verifikasi</strong>:&nbsp;<br>Setelah pembayaran berhasil dilakukan, tunggu beberapa saat hingga sistem memproses top up Anda. Cash PB akan otomatis masuk ke akun Point Blank Anda.</li><li><strong>Cek Saldo Cash PB</strong>:&nbsp;<br>Setelah proses selesai, periksa akun Point Blank Anda untuk memastikan Cash PB sudah masuk sesuai dengan nominal yang dibeli.</li></ol><p>Dengan langkah-langkah ini, Anda dapat dengan mudah melakukan <a href="1528615283.html"><strong>top up Cash PB</strong></a> melalui Topupgim.</p><h3>Keuntungan Top Up PB di Topupgim</h3><p>Top up Cash Point Blank di Topupgim menawarkan beberapa keuntungan yang menarik bagi para pemain:</p><ol><li><strong>Harga Terjangkau</strong>: Topupgim dikenal sebagai salah satu platform dengan harga cash Point Blank yang kompetitif dan sering kali lebih murah dibandingkan dengan situs lainnya, memungkinkan pemain untuk mendapatkan lebih banyak Cash dengan budget yang sama.</li><li><strong>Promo dan Diskon Rutin</strong>: Situs ini sering menawarkan promo dan diskon spesial untuk pembelian Cash PB, sehingga pemain dapat menghemat lebih banyak uang atau mendapatkan bonus tambahan saat melakukan top up.</li><li><strong>Metode Pembayaran yang Beragam</strong>: Topupgim menyediakan berbagai metode pembayaran yang fleksibel dan mudah digunakan, seperti transfer bank, e-wallet, dan pembayaran pulsa, sehingga memudahkan pemain dalam bertransaksi.</li><li><strong>Proses Cepat dan Aman</strong>: Transaksi di Topupgim diproses dengan cepat dan aman, sehingga pemain tidak perlu menunggu lama untuk mendapatkan Cash PB yang mereka beli.</li><li><strong>Layanan Pelanggan yang Responsif</strong>: Topupgim juga menawarkan layanan pelanggan yang siap membantu jika terjadi masalah atau kendala selama proses top up, memastikan pengalaman yang nyaman dan bebas masalah bagi pengguna.</li></ol><p>Dengan berbagai keuntungan ini, Topupgim menjadi pilihan yang populer bagi banyak pemain Point Blank yang ingin melakukan top up dengan cara yang mudah, cepat, dan ekonomis.</p><h3>Metode Pembayaran</h3><p>Berikut adalah opsi metode pembayaran untuk top up Cash Point Blank di TopUpGim:</p><ol><li><strong>E-Wallet (Dompet Digital)</strong>:<br>Anda bisa menggunakan e-wallet populer seperti OVO, GoPay, DANA, dan ShopeePay. Ini memudahkan pembayaran langsung dari ponsel Anda dengan cepat dan praktis.</li><li><strong>Transfer Bank</strong>:<br>Tersedia pilihan transfer bank dari berbagai bank besar di Indonesia, seperti BCA, Mandiri, BNI, dan BRI. Prosesnya mudah dan dapat dilakukan melalui mobile banking, ATM, atau internet banking.</li><li><strong>Virtual Account</strong>:<br>Anda dapat membayar melalui virtual account yang disediakan oleh bank. Ini memungkinkan pembayaran instan tanpa perlu konfirmasi tambahan.</li><li><strong>Minimarket</strong>:<br>Untuk pembayaran tunai, Anda bisa menggunakan layanan di minimarket seperti Indomaret dan Alfamart. Ini cocok bagi Anda yang lebih nyaman membayar langsung di gerai.</li><li><strong>QRIS</strong>:<br>QRIS mempermudah pembayaran melalui kode QR, mendukung berbagai aplikasi pembayaran dalam satu standar.</li><li><strong>Unipin PB &amp; Codashop PB</strong></li></ol><p>Dengan beragam metode ini, Anda dapat memilih yang paling sesuai dengan preferensi dan kenyamanan Anda saat melakukan top-up Point Blank di TopUpGim.</p><h4>Rekomendasi Top Up Game Lainnya</h4><p>Di Topupgim.com, selain Point Blank (PB), Anda juga bisa melakukan top up untuk berbagai game populer lainnya. Beberapa game yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../mobile-legends/1528378309.html"><strong>Top Up Mobile Legends&nbsp;</strong></a></li><li><a href="../pubgm/1528036161.html"><strong>Top Up PUBG Mobile&nbsp;</strong></a></li><li><a href="../call-of-duty-mobile/1528919312.html"><strong>Top Up Call of Duty Mobile (CODM)&nbsp;</strong></a></li><li><a href="../honor-of-kings/1528385129.html"><strong>Top Up Honor of Kings&nbsp;</strong></a></li><li><a href="../zepeto/1528847900.html"><strong>Top Up Zepeto</strong></a></li><li><a href="../hago/1528242362.html"><strong>Top Up Hago&nbsp;</strong></a></li><li><a href="../dana/1528543830.html"><strong>Top Up Dana</strong></a></li><li><a href="../blood-strike/1528112021.html"><strong>Top Up Blood Strike&nbsp;</strong></a></li><li><a href="../honkai-star-rail/1528308068.html"><strong>Top Up Honkai: Star Rail</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="8smT7JQs-DqSS2fzkAkjbCpnW_RyrV98gxcs">
                                ...
                                <li id="content-property" class="timeline-event " style="scroll-margin-top: 75px;">
                                    ...
                                    <div id="product-account-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content block-content-full">
                                            <div class="row mb-4">
                                                <label class="col-sm-4 col-form-label" for="property-user_id">Username Login <span class="text-info">*</span></label>
                                                <div class="col-sm-8">
                                                    <input data-property-type="identity" id="property-user_id" name="property-user_id" type="text" minlength="" class="form-control form-control-lg form-control-alt" placeholder="Masukkan Username Login.." value="" required>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_WT611XKZ" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_WT611XKZ" name="productDenomination" value="WT611XKZ" data-price-preview="9800" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_WT611XKZ">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/ab1c8561-01d8-4761-a221-cc80b2e24219.png?w=75" alt="1200 Cash">
                                                                <span id="productDenominationTitle_WT611XKZ" class="fs-sm fw-semibold">1200 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp9.800</p>
                                                ...
                                                <div id="pDRoot_JG135PAK" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JG135PAK" name="productDenomination" value="JG135PAK" data-price-preview="19400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JG135PAK">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/2424f383-6cf1-47be-b889-1c5411c6fc38.png?w=75" alt="2400 Cash">
                                                                <span id="productDenominationTitle_JG135PAK" class="fs-sm fw-semibold">2400 Cash</span>
                                                ...
                                                <div id="pDRoot_CO932SHR" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_CO932SHR" name="productDenomination" value="CO932SHR" data-price-preview="47600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_CO932SHR">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/c87d64b0-1cff-44f8-8b1a-deb71d83cb02.png?w=75" alt="6000 Cash">
                                                                <span id="productDenominationTitle_CO932SHR" class="fs-sm fw-semibold">6000 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp47.600</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp55.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp7.400</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_FU657Q3B" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_FU657Q3B" name="productDenomination" value="FU657Q3B" data-price-preview="100400" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_FU657Q3B">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/85af4ee9-f202-4c5b-86f2-988df6868838.png?w=75" alt="12000 Cash">
                                                                <span id="productDenominationTitle_FU657Q3B" class="fs-sm fw-semibold">12000 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp100.400</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp102.800</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                ...
                                                <div id="pDRoot_QM399Z3P" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_QM399Z3P" name="productDenomination" value="QM399Z3P" data-price-preview="202600" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_QM399Z3P">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/9b52db3c-6f7d-4e9a-b50c-f350f5718594.png?w=75" alt="24000 Cash">
                                                                <span id="productDenominationTitle_QM399Z3P" class="fs-sm fw-semibold">24000 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp202.600</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp220.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp17.400</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_XM466VBS" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_XM466VBS" name="productDenomination" value="XM466VBS" data-price-preview="303200" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_XM466VBS">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/ffc822ec-4ce0-407e-b1e1-1425ca38ab9a.png?w=75" alt="36000 Cash">
                                                                <span id="productDenominationTitle_XM466VBS" class="fs-sm fw-semibold">36000 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp303.200</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp330.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp26.800</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_JG724N7X" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_JG724N7X" name="productDenomination" value="JG724N7X" data-price-preview="504300" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_JG724N7X">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/61c974f6-c2cd-4191-aa75-1f4c2b4dcdbc.png?w=75" alt="60000 Cash">
                                                                <span id="productDenominationTitle_JG724N7X" class="fs-sm fw-semibold">60000 Cash</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp504.300</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp550.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp45.700</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Fpoint-blank%2F1528615283%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/point-blank/1528615283?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/3bf009c1-7928-4a34-b528-085b1d5ca073.jpg">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/7dc8cd98-7cc4-4b73-ad96-e9bd2d585372ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Point Blank</span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <p class="fs-sm mb-0">Username Login</p>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions3a47.html?code=1528615283';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/point-blank-hadirkan-map-bomb-mission-villa-senjata-noveske-n4-gold-siap-tempur-.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/52e0a817-f5c4-4a5b-9138-d3b722c28586.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Point Blank Hadirkan Map Bomb Mission Villa &amp; Senjata Noveske N4 Gold! Siap Tempur?
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Rasakan serunya pertempuran baru di map Villa dan dominasi medan tempur dengan Noveske N4 Gold! Update Point Blank kali ini siap bawa pengalaman bermain yang lebih taktis dan seru bareng tim kamu.
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/point-blank-rilis-update-terbaru-hadirkan-map-bank-hall-yang-bikin-deg-degan.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/9092b4c4-c9a4-4d1d-800b-10a53b9c9de6.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Point Blank Rilis Update Terbaru! Hadirkan Map Bank Hall yang Bikin Deg-degan
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Map terbaru Bank Hall hadir di Point Blank! Rasakan pertarungan intens dalam gedung bank penuh strategi, sudut sempit, dan aksi cepat. Yuk, kuasai map ini dan dominasi medan perang sekarang juga!
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/mk-13-mod-7-gold-di-point-blank-sniper-emas-yang-bikin-lawan-gemeter.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/dc963136-79f2-449f-94e3-8f520ba759ad.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Mk.13 Mod.7 Gold di Point Blank: Sniper Emas yang Bikin Lawan Gemeter!
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Mk.13 Mod.7 Gold, sniper emas terbaru di Point Blank dengan akurasi dan damage tinggi. Tampil mewah, tembak mematikan. Wajib punya buat para sniper sejati!
                                </p>
                            </div>
                        </a>
                    </div>
