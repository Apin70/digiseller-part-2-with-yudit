...
@section('title', 'Top Up FMP Football Master 2 Murah | Topupgim - TopUpGim')
        ...
        <main id="main-container">
                ...
                <div class="col-lg-5 py-4 py-lg-5">
                    <div class="ps-md-5 pe-md-5 pe-lg-0 px-3">
                        ...
                        <div class="ratio mb-4" style="--bs-aspect-ratio: 50%;">
                            <div>
                                <img class="img-fluid rounded img-slider w-100" src="../../https://cdn.topupgim.com/product-rectangles/8081c81c-4035-4a04-98d1-b979561e2501.jpg" alt="Top Up Football Master 2">
                            </div>
                        </div>
                        <!-- END Cover Content -->

                        <!-- Description Content -->
                        <h1 class="mb-2">Top Up Football Master 2</h1>
                        ...
                        <div id="parent-content-ranking" class="d-none">
                            <div id="content-ranking" class="mt-5">
                                <h3 class="mb-4">Sultan Football Master 2</h3>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">muhamad albert barun mubarok</span>
                                        <span class="text-muted fs-sm">Rp. 7.795.530</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">Victor</span>
                                        <span class="text-muted fs-sm">Rp. 1.355.600</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">faiz</span>
                                        <span class="text-muted fs-sm">Rp. 226.150</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <div class="d-flex flex-column ms-3">
                                        ...
                                        <span class="text-muted fs-sm">Rp. 29.640</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center border rounded p-3 mb-3 block block-rounded overflow-hidden">
                                    ...
                                    <img class="img-avatar border" style="width: 40px; height: 40px" src="../../https://cdn.topupgim.com/circle-logo.jpg">
                                    <div class="d-flex flex-column ms-3">
                                        <span class="fs-sm fw-semibold">NASRUDDIN</span>
                                        <span class="text-muted fs-sm">Rp. 18.510</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="parent-content-article" class="d-none">
                            <div id="content-article" class="pt-5">
                                <h2>Football Master 2</h2>
                                <div class="static-page w-100"><p><strong>Football Master 2</strong> adalah game mobile yang dikembangkan oleh <strong>Red Dot Games</strong>, menawarkan pengalaman manajer sepak bola yang mendalam dan interaktif. Berikut adalah beberapa fitur utama dari game ini:</p><p>Fitur Utama:</p><ol><li><strong>Manajemen Tim Sepak Bola:</strong> Pemain dapat mengelola tim sepak bola mereka sendiri, mulai dari merekrut pemain, mengatur formasi, hingga merancang strategi pertandingan.</li><li><strong>Pemain dan Klub Nyata:</strong> Football Master 2 menyertakan pemain dan klub sepak bola nyata dari berbagai liga dan negara, memberikan pengalaman yang lebih autentik bagi penggemar sepak bola.</li><li><strong>Pertandingan Real-Time:</strong> Game ini menawarkan pertandingan yang dimainkan secara real-time dengan grafis dan animasi yang dinamis, memungkinkan pemain untuk merasakan intensitas pertandingan sepak bola.</li><li><strong>Pengembangan dan Upgrade:</strong> Pemain dapat mengembangkan dan meningkatkan tim mereka dengan meningkatkan keterampilan pemain, memperbarui stadion, dan melakukan transfer pemain.</li><li><strong>Event dan Turnamen:</strong> Football Master 2 sering mengadakan event dan turnamen, baik secara dalam game maupun dengan partisipasi komunitas, menawarkan hadiah dan tantangan tambahan.</li><li><strong>Kustomisasi Tim:</strong> Pemain dapat mengkustomisasi tim mereka dengan berbagai pilihan seragam, logo, dan desain lainnya.</li><li><strong>Strategi dan Taktik:</strong> Selain manajemen tim, game ini juga melibatkan aspek strategi dan taktik, di mana pemain harus membuat keputusan penting tentang formasi dan strategi pertandingan.</li></ol><p>Football Master 2 menggabungkan elemen manajemen sepak bola yang mendalam dengan gameplay yang interaktif, menawarkan pengalaman yang menyenangkan dan menantang bagi penggemar sepak bola dan game manajemen olahraga.</p><h3>FMP (Football Master Points) Football Master 2</h3><p><strong>FMP</strong> atau <strong>Football Master Points</strong> dalam konteks <strong>Football Master 2</strong> adalah mata uang virtual yang digunakan dalam game untuk berbagai tujuan. Berikut adalah beberapa kegunaan FMP dalam Football Master 2:</p><p>Kegunaan FMP (Football Master Points):</p><p><strong>Membeli Pemain dan Kartu:</strong> FMP dapat digunakan untuk membeli pemain, kartu, atau paket spesial yang berisi item atau pemain dalam game.</p><ol><li><strong>Upgrade dan Pengembangan:</strong> Pemain dapat menggunakan FMP untuk meningkatkan keterampilan atau level pemain yang sudah ada, memperbaiki tim, atau meningkatkan fasilitas dalam game.</li><li><strong>Event dan Promosi:</strong> FMP sering kali digunakan dalam event-event khusus atau promosi di dalam game untuk mendapatkan hadiah atau akses ke konten eksklusif.</li><li><strong>Transfer dan Negosiasi:</strong> Mata uang ini bisa digunakan dalam proses transfer pemain, termasuk negosiasi dengan klub lain atau membeli pemain baru dari pasar transfer.</li><li><strong>Item dan Fitur Premium:</strong> FMP juga dapat digunakan untuk membeli item premium atau fitur tambahan yang memberikan keuntungan dalam permainan, seperti pelatihan khusus atau item kosmetik.</li></ol><p>FMP biasanya diperoleh melalui berbagai cara dalam game, seperti menyelesaikan misi, memenangkan pertandingan, atau dengan pembelian menggunakan uang sungguhan. Penggunaannya memudahkan pemain dalam mengelola dan mengembangkan tim sepak bola mereka dalam Football Master 2.</p><h3>Cara Top Up FMP Football Master 2 Termurah</h3><p>Untuk top up Football Master 2 di Topupgim, ikuti langkah-langkah berikut:</p><ol><li><strong>Kunjungi Situs Topupgim:</strong><br>Buka browser dan kunjungi situs <a href="{{ route('home') }}"><strong>web resmi TopUpGim</strong></a> atau unduh <a href="https://play.google.com/store/apps/details?id=com.topupgim.app"><strong>aplikasi Topupgim</strong></a> di Playstore.</li><li><strong>Cari Football Master 2:</strong><br>Di halaman utama, cari dan pilih opsi untuk <strong>top up Football Master 2</strong>.</li><li><strong>Pilih Paket FMP (Football Master Points):</strong><br>Setelah menemukan Football Master 2, pilih paket FMP yang sesuai dengan kebutuhan Anda. Ada berbagai pilihan paket dengan jumlah dan harga yang berbeda.</li><li><strong>Masukkan ID Akun:</strong><br>Jika diperlukan, masukkan ID akun Football Master 2 Anda atau detail lain yang diminta untuk memastikan FMP dikreditkan ke akun yang benar.</li><li><strong>Pilih Metode Pembayaran:</strong><br>Pilih metode pembayaran yang Anda inginkan. Topupgim mendukung berbagai metode pembayaran seperti transfer bank, e-wallet (GoPay, OVO, Dana), kartu kredit, dan QRIS.</li><li><strong>Selesaikan Pembayaran:</strong><br>Ikuti instruksi untuk menyelesaikan pembayaran. Pastikan semua detail yang dimasukkan benar sebelum mengonfirmasi pembayaran.</li><li><strong>Tunggu Proses Top Up:</strong><br>Setelah pembayaran berhasil, FMP akan diproses dan dikreditkan ke akun Football Master 2 Anda. Proses ini biasanya cepat, tetapi mungkin memerlukan waktu beberapa menit.</li><li><strong>Konfirmasi:</strong><br>Periksa akun game Anda untuk memastikan FMP telah masuk. Jika terjadi masalah, Anda dapat menghubungi layanan pelanggan Topupgim untuk bantuan.</li></ol><p>Dengan mengikuti langkah-langkah ini, Anda dapat dengan mudah melakukan <a href="1528875201.html"><strong>top up FMP Football Master 2</strong></a> melalui Topupgim.</p><h3>Metode Pembayaran</h3><p>Topupgim menyediakan berbagai metode pembayaran untuk top up Football Master 2, termasuk:</p><ol><li><strong>Transfer Bank:</strong><br>Pembayaran dapat dilakukan melalui transfer bank dari berbagai bank lokal. Anda akan menerima instruksi transfer setelah memilih metode ini.</li><li><strong>E-Wallet:</strong><br>Topupgim mendukung pembayaran menggunakan e-wallet populer seperti GoPay, OVO, Dana, dan lainnya, memudahkan transaksi secara cepat dan mudah.</li><li><strong>Kartu Kredit/Debit:</strong><br>Anda bisa menggunakan kartu kredit atau debit, seperti Visa atau Mastercard, untuk melakukan pembayaran secara praktis dan langsung.</li><li><strong>QRIS:</strong><br>Pembayaran menggunakan QRIS memungkinkan Anda membayar dengan memindai kode QR melalui aplikasi pembayaran yang mendukung QRIS.</li><li><strong>Pulsa Seluler:</strong><br>Beberapa operator seluler mungkin juga memungkinkan pembayaran menggunakan pulsa, meskipun ini sering kali lebih mahal dibandingkan metode lainnya.</li><li><strong>Virtual Account:</strong><br>Anda dapat menggunakan virtual account dari berbagai bank untuk melakukan pembayaran, dengan nomor virtual account yang disediakan oleh Topupgim.</li></ol><p>Metode pembayaran ini memberikan fleksibilitas kepada pengguna untuk memilih cara yang paling sesuai dengan kebutuhan mereka saat melakukan top up FMP untuk Football Master 2 di Topupgim.</p><h4>Rekomendasi Top Up Game Lainnya</h4><p>Di Topupgim.com, selain Football Master 2, Anda juga bisa melakukan top up untuk berbagai game populer lainnya. Beberapa game yang tersedia untuk top up di Topupgim.com antara lain:&nbsp;</p><ol><li><a href="../mobile-legends/1528378309.html"><strong>Top Up Mobile Legends&nbsp;</strong></a></li><li><a href="../pubgm/1528036161.html"><strong>Top Up PUBG Mobile&nbsp;</strong></a></li><li><a href="../call-of-duty-mobile/1528919312.html"><strong>Top Up Call of Duty Mobile (CODM)&nbsp;</strong></a></li><li><a href="../honor-of-kings/1528385129.html"><strong>Top Up Honor of Kings&nbsp;</strong></a></li><li><a href="../zepeto/1528847900.html"><strong>Top Up Zepeto</strong></a></li><li><a href="../hago/1528242362.html"><strong>Top Up Hago&nbsp;</strong></a></li><li><a href="../dana/1528543830.html"><strong>Top Up Dana</strong></a></li><li><a href="../blood-strike/1528112021.html"><strong>Top Up Blood Strike&nbsp;</strong></a></li><li><a href="../honkai-star-rail/1528308068.html"><strong>Top Up Honkai: Star Rail</strong></a></li></ol></div>
                            </div>
                        </div>
                        <!-- END Article Content -->
                ...
                <div class="col-lg-7">
                    <div id="content-topup" class="content" style="scroll-margin-top: 50px;">
                        ...
                        <form class="js-validation-product-start-transaction" method="POST" novalidate="novalidate">
                            <input type="hidden" name="_csrf" value="rKUBeL3v-yb7S-p5NPEe8Gu1He7yccugXB24">
                                    ...
                                    <div id="product-denom-block" class="product-block timeline-event-block-no-sm block block-rounded block-mode-loading-circle block-themed">
                                        ...
                                        <div class="block-content pb-2 animated fadeIn">
                                            ...
                                            <div class="row px-md-1 animated fadeIn" style="min-height: 7rem;">
                                                <div id="pDRoot_AR738C6O" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_AR738C6O" name="productDenomination" value="AR738C6O" data-price-preview="3490" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_AR738C6O">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/449dbc4d-e7a3-471c-82ba-f2a0b3a2a797.png?w=75" alt="18 FMP">
                                                                <span id="productDenominationTitle_AR738C6O" class="fs-sm fw-semibold">18 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp3.490</p>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp110</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_NM265EE4" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_NM265EE4" name="productDenomination" value="NM265EE4" data-price-preview="18330" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_NM265EE4">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/4afcd1ea-58e3-40a4-b8d8-74585755b128.png?w=75" alt="95 FMP">
                                                                <span id="productDenominationTitle_NM265EE4" class="fs-sm fw-semibold">95 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp18.330</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp19.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp670</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_HD004BW4" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_HD004BW4" name="productDenomination" value="HD004BW4" data-price-preview="36180" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_HD004BW4">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/c8a93a5f-53e4-439c-bde5-df174a730525.png?w=75" alt="191 FMP">
                                                                <span id="productDenominationTitle_HD004BW4" class="fs-sm fw-semibold">191 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp36.180</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp38.200</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp2.020</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_GZ602RBH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_GZ602RBH" name="productDenomination" value="GZ602RBH" data-price-preview="74910" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_GZ602RBH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/586b1288-0181-4601-925d-c17e83eef4a5.png?w=75" alt="382 FMP">
                                                                <span id="productDenominationTitle_GZ602RBH" class="fs-sm fw-semibold">382 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp74.910</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp76.400</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp1.490</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_KN131D1O" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KN131D1O" name="productDenomination" value="KN131D1O" data-price-preview="182970" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KN131D1O">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/26855b80-22e7-4900-a73a-06a66d52072e.png?w=75" alt="972 FMP">
                                                                <span id="productDenominationTitle_KN131D1O" class="fs-sm fw-semibold">972 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp182.970</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp194.400</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp11.430</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_KA1734SH" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_KA1734SH" name="productDenomination" value="KA1734SH" data-price-preview="362970" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_KA1734SH">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/0dce6a96-fd3a-420d-85e2-ba5644cd8078.png?w=75" alt="1944 FMP">
                                                                <span id="productDenominationTitle_KA1734SH" class="fs-sm fw-semibold">1944 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp362.970</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp388.800</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp25.830</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_GA929JJC" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_GA929JJC" name="productDenomination" value="GA929JJC" data-price-preview="833020" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_GA929JJC">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/73eb7e38-2bc8-4ba1-8bd9-63dcf068dba6.png?w=75" alt="3888 FMP">
                                                                <span id="productDenominationTitle_GA929JJC" class="fs-sm fw-semibold">3888 FMP</span>
                                                                <p class="fs-sm mt-1">Rp833.020</p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="pDRoot_MO234JMC" class="pDRoot col-6 col-md-4 px-2 mb-3" data-is-region-id="true" data-region-list="" data-sku-mobapay="">
                                                    <div class="form-check form-block highlight h-100">
                                                        <input type="radio" class="form-check-input" id="productDenomination_MO234JMC" name="productDenomination" value="MO234JMC" data-price-preview="1808130" data-is-empty="" required >
                                                        <label class="form-check-label-rounded-lg h-100 py-3 bg-body" for="productDenomination_MO234JMC">
                                                            <div class="d-flex flex-column text-center justify-content-center align-items-center h-100 ">
                                                                <img class="lazy mb-1 " style="width: 50px; height: 50px; object-fit: cover;" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/denomination-items/b4c1baeb-1868-48fb-bb0d-bce1ae58b92c.png?w=75" alt="9900 FMP">
                                                                <span id="productDenominationTitle_MO234JMC" class="fs-sm fw-semibold">9900 FMP</span>
                                                                <p class="text-xplay fw-semibold mt-1 mb-0" style="font-family: trebuchet ms,Helvetica,sans-serif;">Rp1.808.130</p>
                                                                <p class="fs-xs mb-0 fw-light mb-3">
                                                                    <del>Rp1.980.000</del>
                                                                </p>
                                                                <span class="sku-limited-label position-absolute fs-xs fw-semibold text-white bg-primary-dark-op text-center bg-transparent top-50 start-50 translate-middle py-1 py-lg-2 w-100 d-none">Pembelian Mencapai Batas</span>
                                                            ...
                                                            <div class="text-center border border-2 bg-info-light form-check-description position-absolute bottom-0 end-0 w-100" style="border-radius: 0 0 10px 10px; line-height: 1.4rem; z-index: 2;">
                                                                <span class="text-info fw-normal mx-2" style="font-size: 0.70rem !important;">
                                                                    <span class="fs-xs text-nowrap" style="font-weight: 450;">Hemat Rp171.870</span>
                                                                </span>
                                                            </div>
                                                        </label>
                                                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <div class="d-flex flex-row flex-wrap justify-content-center">
                                            <a class="fw-semibold m-3" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-facebook opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://twitter.com/share?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-twitter opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://api.whatsapp.com/send?text=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-whatsapp opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-pinterest opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://t.me/share/url?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-telegram opacity-75"></i>
                                            </a>
                                            <a class="fw-semibold m-3" href="https://linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftopupgim.com%2Fproduct%2Ffootball-master-2%2F1528875201%3Faff%3DInternal_Share" target="_blank">
                                                <i class="fab fa-2x fa-linkedin opacity-75"></i>
                                            </a>
                                        </div>
                                        <p class="fs-sm fw-light text-center mb-4 mt-1 text-dark" style="word-break:break-all; word-wrap: break-word;">https://topupgim.com/product/football-master-2/1528875201?aff=Internal_Share</p>
                        ...
                        <div class="modal fade" id="modal-product-helper" tabindex="-1" role="dialog" aria-labelledby="modal-product-helper" aria-describedby="modal-product-helper" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-fadein modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body min-scrollbar">
                                        <img class="img-fluid w-100 h-auto rounded mb-4" src="../../https://cdn.topupgim.com/product-helpers/178735d1-b15e-4f7a-88ab-5c762c5d14a6.jpg">
                                        <div class="static-page"><p>Untuk menemukan User ID Anda, login ke akun pada aplikasi game. Klik tombol pengaturan yang terletak di sebelah kiri layar. Anda akan menemukan User ID pada menu “Pengaturan”</p></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Tutup</button>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-center pb-3 mb-3 border-bottom border-2">
                                                <div class="ratio ratio-1x1" style="width: 50px;">
                                                    <img class="img-fluid product-tile" style="background-image: url('../../https://cdn.topupgim.com/product-tiles/7e343e09-2814-41b6-a5d1-670e93b572b6ebf4.jpg?w=200');">
                                                </div>
                                                <div class="d-flex justify-content-end flex-column align-items-end">
                                                    <span class="h6 fs-normal fw-semibold mb-2">Football Master 2</span>
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-sm btn-alt-secondary" onclick="location.href='../../featured/news-and-promotions31b9.html?code=1528875201';">
                        <i class="fa fa-fw fa-arrow-right text-muted"></i>
                    </button>
                </div>
                <div class="row items-push mb-4">
                    <div class="col-sm-6 col-lg-4">
                        <a class="block block-rounded block-link-pop overflow-hidden h-100 mb-0" href="../../news/football-master-2-tips-rekrut-pemain-terbaik-dan-bangun-tim-impianmu.html">
                            <div class="ratio mb-1" style="--bs-aspect-ratio: 55%;">
                                <div>
                                    <img class="lazy img-fluid img-round-top img-slider w-100" src="../../https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/pages/9a4dda50-5745-40bc-9064-89e5c16ab6f3.jpg?w=500" alt="Gambar Artikel">
                                </div>
                            </div>
                            <div class="block-content block-content-full h-100">
                                <p class="fw-bold mb-1 text-truncate">
                                    Football Master 2: Tips Rekrut Pemain Terbaik dan Bangun Tim Impianmu
                                </p>
                                <p class="fs-sm fw-medium text-muted text-line-2 mb-0">
                                    Mau jadi manajer handal di Football Master 2? Temukan tips rekrut pemain terbaik, bangun tim impian, dan menangkan liga global. Jangan lewatkan panduan lengkapnya di sini!
                                </p>
                            </div>
                        </a>
                    </div>
