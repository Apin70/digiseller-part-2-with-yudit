<?php $__env->startSection('title', 'Apa itu Gimkoin? - Topupgim - TopUpGim'); ?>
    ...
    <div class="gimkoin-page">
        ...
        <section class="gk-hero">
            ...
            <p class="gk-hero-subtitle">
                                            ...
                                            <a href="<?php echo e(route('home')); ?>" class="gk-cta-btn">
                                                Mulai Belanja
        ...
        <section class="gk-cta-section">
            ...
            <div class="gk-cta-box">
                ...
                <p>
                                                            ...
                                                            <a href="<?php echo e(route('home')); ?>" class="gk-cta-btn-white">
                                                                Belanja Sekarang
                                                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                                                </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ydth/Documents/topupgim/resources/views/page/apa-itu-gimkoin.blade.php ENDPATH**/ ?>