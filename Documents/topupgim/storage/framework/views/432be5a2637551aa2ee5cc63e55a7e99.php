<?php $__env->startSection('title', 'TopUpGim - Top Up Game Murah dan Instan'); ?>
                    ...
                    <div class="content mb-5 mb-md-0 pb-5 pb-md-7 pt-2 pt-md-4 mt-0 mt-md-2">
                        ...
                        <div class="res-slider px-2 px-lg-3 mb-lg-3">
                            <div id="main-slider" class="slick-nav-animate slick-dotted-inner slick-dotted-white overflow-hidden visibility gone" style="border-radius: 0.45em;" data-dots="true" data-arrows="true" data-slides-to-show="1" center-padding="10%" adaptive-height="true" data-center-mode="true" data-autoplay="true" data-autoplay-speed="3000">
                                ...
                                <a class="mx-md-3 res-slider border rounded" href=\"<?php echo e(route('product.show', ['roblox-voucher', '1528697287'])); ?>\">
                                ...
                                <a class="mx-md-3 res-slider border rounded" href=\"<?php echo e(route('product.show', ['free-fire', '1528555434'])); ?>\">
                                ...
                                <a class="mx-md-3 res-slider border rounded" href=\"<?php echo e(route('product.show', ['mobile-legends', '1528378309'])); ?>\">
                    ...
                    <div class="block block-rounded animated fadeIn mb-2">
                        <div class="block-content block-content-full" style="padding: 0.75rem 0.75rem; 1px !important;">
                            <div class="row py-3 px-4 gy-3 border-bottom mb-3">
                                ...
                                <a class="col-4 col-md-3 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('auth.sign-in')); ?>">
                            ...
                            <div class="d-flex justify-content-around py-2 px-4 gy-3">
                                <a class="h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'E-Wallet')); ?>">
                                ...
                                <a class="h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('order.pulsa')); ?>">
                                ...
                                <a class="h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'Game')); ?>">
                                ...
                                <a class="h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'Aplikasi')); ?>">
                    ...
                    <div class="block block-rounded animated fadeIn mb-2">
                        <div class="block-content block-content-full" style="padding: 0.75rem 0.75rem; 1px !important;">
                            <div class="row gy-4 border-bottom pt-2 pb-3 mb-3">
                                ...
                                <a class="col-4 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('auth.sign-in')); ?>">
                                    <span class="text-dark"><i class="far fa-sign-in fa-lg mb-2"></i></span>
                                    <span class="text-dark fs-xs fw-light mt-1 text-center">Masuk</span>
                                </a>
                            </div>
                            <div class="row gy-4">
                                <a class="col-3 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'E-Wallet')); ?>">
                                    <img class="lazy" style="width: 30px; height: 30px;" src="https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/category-icons/30328403-1815-403e-879a-712333048a48.png" alt="E-Wallet">
                                    <span class="text-dark fs-xs fw-light mt-1 text-center">E-Wallet</span>
                                </a>
                                <a class="col-3 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('order.pulsa')); ?>">
                                    <img class="lazy" style="width: 30px; height: 30px;" src="https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/category-icons/562478a4-afba-4a6a-acd9-02954df15bed.png" alt="Pulsa">
                                    <span class="text-dark fs-xs fw-light mt-1 text-center">Pulsa</span>
                                </a>
                                <a class="col-3 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'Game')); ?>">
                                    <img class="lazy" style="width: 30px; height: 30px;" src="https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/category-icons/f7121621-7f87-4a0d-acf6-4f7498a750ed.png" alt="Game">
                                    <span class="text-dark fs-xs fw-light mt-1 text-center">Game</span>
                                </a>
                                <a class="col-3 h-100 d-flex flex-column align-items-center justify-content-center" href="<?php echo e(route('category.show', 'Aplikasi')); ?>">
                                    <img class="lazy" style="width: 30px; height: 30px;" src="https://cdn.topupgim.com/no-image2575.jpg?w=100" data-src="https://cdn.topupgim.com/category-icons/4ae59eca-f4f2-4e44-b5f1-8c73bebba0c4.png" alt="Aplikasi">
                                    <span class="text-dark fs-xs fw-light mt-1 text-center">Aplikasi</span>
                                </a>
                            </div>
            ...
            <div class="mt-5">
                ...
                <div id="category_54664e6747776535417572633954416e65795a716a673d3d" class="d-flex flex-column mb-5" style="scroll-margin-top: 100px;">
                    <div class="content py-0 my-0">
                        ...
                        <div class="mx-2 mx-lg-4">
                            <div class="row gy-4 row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 row-cols-xl-6 pt-4 pb-2 gx-lg-3">
                                <a data-id="1528378309" href=\"<?php echo e(route('product.show', ['mobile-legends', '1528378309'])); ?>\" title="Topup Mobile Legends">
                                ...
                                <a data-id="1528273402" href=\"<?php echo e(route('product.show', ['magic-chess-go-go', '1528273402'])); ?>\" title="Topup Magic Chess Go Go">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528555434" href=\"<?php echo e(route('product.show', ['free-fire', '1528555434'])); ?>\" title="Topup Free Fire">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528242362" href=\"<?php echo e(route('product.show', ['hago', '1528242362'])); ?>\" title="Topup HAGO">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528036161" href=\"<?php echo e(route('product.show', ['pubgm', '1528036161'])); ?>\" title="Topup PUBGM Global">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528787297" href=\"<?php echo e(route('product.show', ['genshin-impact', '1528787297'])); ?>\" title="Topup Genshin Impact">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                    ...
                    <div class="content my-0 py-0">
                        ...
                        <div class="mx-2 mx-lg-4">
                            <div class="row gy-4 row-cols-3 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 row-cols-xl-6 pt-4 pb-2 gx-lg-3">
                                <a data-id="1528543830" href=\"<?php echo e(route('product.show', ['dana', '1528543830'])); ?>\" title="Topup Dana">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528847900" href=\"<?php echo e(route('product.show', ['zepeto', '1528847900'])); ?>\" title="Topup Zepeto">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528112021" href=\"<?php echo e(route('product.show', ['blood-strike', '1528112021'])); ?>\" title="Topup Blood Strike">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528615283" href=\"<?php echo e(route('product.show', ['point-blank', '1528615283'])); ?>\" title="Topup Point Blank">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528919312" href=\"<?php echo e(route('product.show', ['call-of-duty-mobile', '1528919312'])); ?>\" title="Topup Call of Duty Mobile">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528768154" href=\"<?php echo e(route('product.show', ['telkomsel', '1528768154'])); ?>\" title="Topup Telkomsel">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528742300" href=\"<?php echo e(route('product.show', ['eggy-party', '1528742300'])); ?>\" title="Topup Eggy Party">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528917260" href=\"<?php echo e(route('product.show', ['valorant', '1528917260'])); ?>\" title="Topup Valorant">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528433756" href=\"<?php echo e(route('product.show', ['garena-undawn', '1528433756'])); ?>\" title="Topup Garena Undawn">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528483107" href=\"<?php echo e(route('product.show', ['super-sus', '1528483107'])); ?>\" title="Topup Super Sus">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528569704" href=\"<?php echo e(route('product.show', ['steam-wallet-voucher', '1528569704'])); ?>\" title="Topup Steam Wallet Voucher">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528308068" href=\"<?php echo e(route('product.show', ['honkai-star-rail', '1528308068'])); ?>\" title="Topup Honkai: Star Rail">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528904988" href=\"<?php echo e(route('product.show', ['arena-breakout', '1528904988'])); ?>\" title="Topup Arena Breakout">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528138896" href=\"<?php echo e(route('product.show', ['voucher-bstation', '1528138896'])); ?>\" title="Topup Bstation Voucher">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528875201" href=\"<?php echo e(route('product.show', ['football-master-2', '1528875201'])); ?>\" title="Topup Football Master 2">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528385129" href=\"<?php echo e(route('product.show', ['honor-of-kings', '1528385129'])); ?>\" title="Topup Honor of Kings">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528693523" href=\"<?php echo e(route('product.show', ['mobile-legends-malaysia', '1528693523'])); ?>\" title="Topup Mobile Legends Malaysia">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                    ...
                    <div class="content my-0 py-0">
                        ...
                        <div class="mx-2 mx-lg-4">
                            <div class="row gy-4 row-cols-3 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 row-cols-xl-6 pt-4 pb-2 gx-lg-3">
                                <a data-id="1528543830" href="<?php echo e(route('category.show', 'E-Wallet')); ?>" title="Topup E-Wallet">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <a data-id="1528659351" href=\"<?php echo e(route('product.show', ['token-listrik-pln', '1528659351'])); ?>\" title="Topup Token Listrik PLN">
                                    <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                        <div class="px-lg-3 mb-2">
                                ...
                                <div class="horizon-scroll-control overflow-auto disable-scrollbars" data-sign="4534352b564e445256654d677a7a72467743656963413d3d">
                                    <div class="pt-4">
                                        <div class="row flex-nowrap row-cols-3 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 row-cols-xl-6 gx-lg-3">
                                            <a data-id="1528296085" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['shopeepay', '1528296085'])); ?>\" title="Topup ShopeePay" title="Topup ShopeePay">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528543830" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['dana', '1528543830'])); ?>\" title="Topup Dana" title="Topup Dana">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                                        <div class="lazy product-tile-idea cover-product position-relative" data-bg="https://cdn.topupgim.com/product-tiles/28550b75-ee02-4189-aa69-2d03b2ca513f.png?w=200" style="background-image: url('https://cdn.topupgim.com/no-image2575.jpg?w=100');">
                                                        </div>
                                            ...
                                            <a data-id="1528812696" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['gopay', '1528812696'])); ?>\" title="Topup GoPay" title="Topup GoPay">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528134850" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['ovo', '1528134850'])); ?>\" title="Topup OVO" title="Topup OVO">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528549889" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['maxim-driver', '1528549889'])); ?>\" title="Topup Maxim Driver" title="Topup Maxim Driver">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528050491" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['gopay-Driver-', '1528050491'])); ?>\" title="Topup Gopay Driver" title="Topup Gopay Driver">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528837508" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['linkaja', '1528837508'])); ?>\" title="Topup Linkaja" title="Topup Linkaja">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528681626" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['grab-driver-', '1528681626'])); ?>\" title="Topup Grab Driver Voucher" title="Topup Grab Driver Voucher">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                        ...
                        <div class="content py-0 my-0">
                            <div class="mx-2 mx-lg-4">
                                <div class="horizon-scroll-control overflow-auto disable-scrollbars" data-sign="73756d7679785a5a364a514e4b6a46724e6d735271673d3d">
                                    <div class="pt-4">
                                        <div class="row flex-nowrap row-cols-3 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 row-cols-xl-6 gx-lg-3">
                                            <a data-id="1528768154" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['telkomsel', '1528768154'])); ?>\" title="Topup Telkomsel" title="Topup Telkomsel">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                                        <div class="lazy product-tile-idea cover-product position-relative" data-bg="https://cdn.topupgim.com/product-tiles/7b91b6b1-b983-4b74-b93f-75acce75f3fc.png?w=200" style="background-image: url('https://cdn.topupgim.com/no-image2575.jpg?w=100');">
                                                        </div>
                                            ...
                                            <a data-id="1528542016" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['indosat-im3', '1528542016'])); ?>\" title="Topup Indosat IM3" title="Topup Indosat IM3">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528761408" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['xl-pulsa', '1528761408'])); ?>\" title="Topup XL Pulsa" title="Topup XL Pulsa">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528027223" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['axis', '1528027223'])); ?>\" title="Topup AXIS" title="Topup AXIS">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528658729" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['tri', '1528658729'])); ?>\" title="Topup Tri" title="Topup Tri">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                            ...
                                            <a data-id="1528707010" class="horizon-scroll-item mb-4" href=\"<?php echo e(route('product.show', ['smartfren', '1528707010'])); ?>\" title="Topup SMARTFREN" title="Topup SMARTFREN">
                                                <div class="d-flex flex-column product-tile-idea-card bg-body-extra-light h-100 pt-lg-3 overflow-hidden">
                                                    <div class="px-lg-3 mb-2">
                                ...
                                <div class="horizon-scroll-control overflow-auto disable-scrollbars" data-sign="6a696654526d47614936755976747971366a523830513d3d">
                                    <div class="d-flex pt-4">
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528919312" href=\"<?php echo e(route('product.show', ['call-of-duty-mobile', '1528919312'])); ?>\" title="Topup Call of Duty Mobile" title="Topup Call of Duty Mobile" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528555434" href=\"<?php echo e(route('product.show', ['free-fire', '1528555434'])); ?>\" title="Topup Free Fire" title="Topup Free Fire" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528787297" href=\"<?php echo e(route('product.show', ['genshin-impact', '1528787297'])); ?>\" title="Topup Genshin Impact" title="Topup Genshin Impact" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528242362" href=\"<?php echo e(route('product.show', ['hago', '1528242362'])); ?>\" title="Topup HAGO" title="Topup HAGO" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528743885" href=\"<?php echo e(route('product.show', ['honkai-impact-3', '1528743885'])); ?>\" title="Topup Honkai Impact 3" title="Topup Honkai Impact 3" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528175611" href=\"<?php echo e(route('product.show', ['league-of-legends-wild-rift', '1528175611'])); ?>\" title="Topup League of Legends: Wild Rift" title="Topup League of Legends: Wild Rift" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528051138" href=\"<?php echo e(route('product.show', ['lifeafter', '1528051138'])); ?>\" title="Topup LifeAfter" title="Topup LifeAfter" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528378309" href=\"<?php echo e(route('product.show', ['mobile-legends', '1528378309'])); ?>\" title="Topup Mobile Legends" title="Topup Mobile Legends" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528582047" href=\"<?php echo e(route('product.show', ['mu-origin-2', '1528582047'])); ?>\" title="Topup MU Origin 2" title="Topup MU Origin 2" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528072602" href=\"<?php echo e(route('product.show', ['mu-origin-3', '1528072602'])); ?>\" title="Topup MU ORIGIN 3" title="Topup MU ORIGIN 3" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528036161" href=\"<?php echo e(route('product.show', ['pubgm', '1528036161'])); ?>\" title="Topup PUBGM Global" title="Topup PUBGM Global" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528615283" href=\"<?php echo e(route('product.show', ['point-blank', '1528615283'])); ?>\" title="Topup Point Blank" title="Topup Point Blank" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528471870" href=\"<?php echo e(route('product.show', ['playstation-voucher', '1528471870'])); ?>\" title="Topup Playstation Voucher" title="Topup Playstation Voucher" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528418009" href=\"<?php echo e(route('product.show', ['revelation-infinite-journey', '1528418009'])); ?>\" title="Topup Revelation: Infinite Journey" title="Topup Revelation: Infinite Journey" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528697287" href=\"<?php echo e(route('product.show', ['roblox-voucher', '1528697287'])); ?>\" title="Topup Roblox Voucher" title="Topup Roblox Voucher" style="border-radius: 12px; min-width: 280px;">
                        ...
                        <div class="content py-0 my-0">
                            <div class="mx-2 mx-lg-4">
                                <div class="horizon-scroll-control overflow-auto disable-scrollbars" data-sign="465876485877756263774e7a2b35565169526c4f39513d3d">
                                    <div class="d-flex pt-4">
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528138896" href=\"<?php echo e(route('product.show', ['voucher-bstation', '1528138896'])); ?>\" title="Topup Bstation Voucher" title="Topup Bstation Voucher" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528472026" href=\"<?php echo e(route('product.show', ['koin-tiktok-gift-card', '1528472026'])); ?>\" title="Topup Koin TikTok Gift Card" title="Topup Koin TikTok Gift Card" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528999288" href=\"<?php echo e(route('product.show', ['likee', '1528999288'])); ?>\" title="Topup Likee" title="Topup Likee" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528384729" href=\"<?php echo e(route('product.show', ['lita', '1528384729'])); ?>\" title="Topup Lita" title="Topup Lita" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528123409" href=\"<?php echo e(route('product.show', ['mangatoon', '1528123409'])); ?>\" title="Topup Mangatoon" title="Topup Mangatoon" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528569704" href=\"<?php echo e(route('product.show', ['steam-wallet-voucher', '1528569704'])); ?>\" title="Topup Steam Wallet Voucher" title="Topup Steam Wallet Voucher" style="border-radius: 12px; min-width: 280px;">
                                        ...
                                        <div class="list-group d-flex flex-column gap-3 me-3">
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528322790" href=\"<?php echo e(route('product.show', ['vidio-voucher', '1528322790'])); ?>\" title="Topup Vidio Voucher" title="Topup Vidio Voucher" style="border-radius: 12px; min-width: 280px;">
                                            ...
                                            <a class="horizon-scroll-item list-group-item list-group-item-action d-flex align-items-center p-3 border" data-id="1528540373" href=\"<?php echo e(route('product.show', ['wesing', '1528540373'])); ?>\" title="Topup WeSing" title="Topup WeSing" style="border-radius: 12px; min-width: 280px;">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row justify-content-sm-between align-items-center p-3">
                                ...
                                <div class="col-sm-6 text-sm-end">
                                    <a class="btn btn-hero btn-primary px-4 py-2" href="<?php echo e(route('auth.register')); ?>">
                                        Buat Akun Baru
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ydth/Documents/topupgim/resources/views/home.blade.php ENDPATH**/ ?>